"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = resolveGlobalDedupeCache;exports.t = createDedupeCache;var _globalSingletonCOlWgaGc = require("./global-singleton-COlWgaGc.js");
var _mapSizeC5iOsYCO = require("./map-size-C5iOsYCO.js");
...
function createDedupeCache(options) {
  ...
  const prune = (now) => {
    ...
    (0, _mapSizeC5iOsYCO.t)(cache, maxSize);
  };
...
function resolveGlobalDedupeCache(key, options) {
  return (0, _globalSingletonCOlWgaGc.n)(key, () => createDedupeCache(options));
}
//#endregion /* v9-ea8c357952ebea84 */
