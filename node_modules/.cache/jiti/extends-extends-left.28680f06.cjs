...
var _asyncIterator = require("./async-iterator.mjs");
...
var _templateLiteral = require("./template-literal.mjs");
...
var _asyncIterator2 = require("../types/async-iterator.mjs");
...
var _templateLiteral2 = require("../types/template-literal.mjs");
...
// Types
// ----------------------------------------------------------------------------
function ExtendsLeft(inferred, left, right) {return (0, _any2.IsAny)(left) ? (0, _any.ExtendsAny)(inferred, left, right) : (0, _array2.IsArray)(left) ? (0, _array.ExtendsArray)(inferred, left, left.items, right) : (0, _asyncIterator2.IsAsyncIterator)(left) ? (0, _asyncIterator.ExtendsAsyncIterator)(inferred, left.iteratorItems, right) :
  ...
  (0, _templateLiteral2.IsTemplateLiteral)(left) ? (0, _templateLiteral.ExtendsTemplateLiteral)(inferred, left.pattern, right) :
