...
var _mimeBMCOgU = require("./mime-BMCOgU51.js");
var _toolImagesCN073Zpw = require("./tool-images-CN073Zpw.js");
...
async function imageResult(params) {
  ...
  return await (0, _toolImagesCN073Zpw.r)({
    content,
    details: {
      path: params.path,
      ...params.details,
...
async function imageResultFromFile(params) {
  ...
  const mimeType = (await (0, _mimeBMCOgU.n)({ buffer: buf.slice(0, 256) })) ?? "image/png";
