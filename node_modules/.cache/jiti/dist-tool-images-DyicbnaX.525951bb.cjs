"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.i = resolveImageSanitizationLimits;exports.n = sanitizeImageBlocks;exports.r = sanitizeToolResultImages;exports.t = sanitizeContentBlocksImages;var _subsystemP_0xjnPe = require("./subsystem-P_0xjnPe.js");
var _base64BFSEyv5d = require("./base64-BFSEyv5d.js");
var _imageOpsCjEUc4vK = require("./image-ops-CjEUc4vK.js");
...
const log = (0, _subsystemP_0xjnPe.t)("agents/tool-images");
...
async function resizeImageBase64IfNeeded(params) {
  ...
  const meta = await (0, _imageOpsCjEUc4vK.a)(buf);
  ...
  const sideGrid = (0, _imageOpsCjEUc4vK.r)(params.maxDimensionPx, sideStart);
  let smallest = null;
  for (const side of sideGrid) for (const quality of _imageOpsCjEUc4vK.t) {
    const out = await (0, _imageOpsCjEUc4vK.l)({
      buffer: buf,
      maxSide: side,
      quality,
...
async function sanitizeContentBlocksImages(blocks, label, opts = {}) {
  ...
  for (const block of blocks) {
    ...
    const canonicalData = (0, _base64BFSEyv5d.t)(data);
    if (!canonicalData) {
      out.push({
        type: "text",
