"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = formatUncaughtError;exports.c = readErrorName;exports.i = formatErrorMessage;exports.n = detectErrorKind;exports.o = hasErrnoCode;exports.r = extractErrorCode;exports.s = isErrno;exports.t = collectErrorGraphCandidates;var _redactVz8FmIJK = require("./redact-vz8FmIJK.js");
...
function formatErrorMessage(err) {
  ...
  return (0, _redactVz8FmIJK.r)(formatted);
}
function formatUncaughtError(err) {
  if (extractErrorCode(err) === "INVALID_CONFIG") return formatErrorMessage(err);
  if (err instanceof Error) return (0, _redactVz8FmIJK.r)(err.stack ?? err.message ?? err.name);
