...
function normalizeRouteBindingChannelId(raw) {
  const normalized = (0, _idsNy_qj_av.r)(raw);
...
function resolveNormalizedRouteBindingMatch(binding) {
  ...
  return {
    agentId: (0, _sessionKeyBd0xquXF.c)(binding.agentId),
    accountId: (0, _accountIdVYgQddVH.n)(accountId),
    channelId
  };
}
