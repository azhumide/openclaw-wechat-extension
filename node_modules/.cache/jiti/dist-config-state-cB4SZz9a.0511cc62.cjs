...
var _configNormalizationSharedCJLdU1H = require("./config-normalization-shared-CJLdU1H-.js");
var _slotsTjp1BFoh = require("./slots-tjp1BFoh.js");
...
function getBundledPluginAliasLookup() {
  ...
  for (const plugin of (0, _bundledPluginMetadataVxOxTVqO.n)({ includeChannelConfigs: false })) {
...
const normalizePluginsConfig = (config) => {
  return (0, _configNormalizationSharedCJLdU1H.i)(config, normalizePluginId);
...
const hasExplicitMemoryEntry = (plugins) => Boolean(plugins?.entries && Object.prototype.hasOwnProperty.call(plugins.entries, (0, _slotsTjp1BFoh.n)("memory")));
const hasExplicitPluginConfig = (plugins) => (0, _configNormalizationSharedCJLdU1H.t)(plugins);exports.r = hasExplicitPluginConfig;
...
function resolvePluginActivationState(params) {
  return (0, _configNormalizationSharedCJLdU1H.l)((0, _configNormalizationSharedCJLdU1H.c)({
    ...params,
...
const resolveEnableState = exports.l = (0, _configNormalizationSharedCJLdU1H.o)(resolvePluginActivationState);
const isBundledChannelEnabledByChannelConfig = _configNormalizationSharedCJLdU1H.r;
const resolveEffectiveEnableState = exports.s = (0, _configNormalizationSharedCJLdU1H.a)(resolveEffectivePluginActivationState);
function resolveEffectivePluginActivationState(params) {
  return resolvePluginActivationState(params);
}
function resolveMemorySlotDecision(params) {
  return (0, _configNormalizationSharedCJLdU1H.s)(params);
}
//#endregion /* v9-42fa808e76365cf1 */
