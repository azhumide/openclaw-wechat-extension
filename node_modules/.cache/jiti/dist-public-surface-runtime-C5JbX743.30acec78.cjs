"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.i = resolveBundledPluginSourcePublicSurfacePath;exports.n = normalizeBundledPluginArtifactSubpath;exports.r = resolveBundledPluginPublicSurfacePath;exports.t = void 0;var _bundledDirU738ay4K = require("./bundled-dir-U738ay4K.js");
...
function resolveBundledPluginPublicSurfacePath(params) {
  ...
  const explicitBundledPluginsDir = params.bundledPluginsDir ?? (0, _bundledDirU738ay4K.t)(params.env ?? process.env);
