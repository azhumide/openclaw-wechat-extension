...
var _bootstrapRegistryC72_7eMo = require("./bootstrap-registry-C72_7eMo.js");
...
function listActionTargetAliasSpecs(action, params, channel) {
  ...
  const channelSpec = (0, _bootstrapRegistryC72_7eMo.t)(normalizedChannel)?.actions?.messageActionTargetAliases?.[action];
