"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = emptyChannelConfigSchema;exports.i = buildNestedDmConfigSchema;exports.n = buildCatchallMultiAccountChannelSchema;exports.r = buildChannelConfigSchema;exports.t = void 0;var _zodSchemaCoreBR1v7ukx = require("./zod-schema.core-BR1v7ukx.js");
...
function buildNestedDmConfigSchema(extraShape) {
  const baseShape = {
    ...
    policy: _zodSchemaCoreBR1v7ukx.o.optional(),
