...
var _channelCatalogRegistryB_VToMa = require("./channel-catalog-registry-B_VToMa2.js");
...
function listBundledChannelPluginIdsForRoot(packageRoot, env = process.env) {
  ...
  const loaded = (0, _channelCatalogRegistryB_VToMa.t)({
    origin: "bundled",
    env
...
function listBundledChannelPluginIds() {
  return listBundledChannelPluginIdsForRoot((0, _bundledDm0mRqox.g)().cacheKey);
}
//#endregion
...
function getBootstrapPlugins(cacheKey = (0, _bundledDm0mRqox.g)().cacheKey, env = process.env) {
...
function resolveActiveBootstrapPlugins() {
  return getBootstrapPlugins((0, _bundledDm0mRqox.g)().cacheKey);
}
...
function getBootstrapChannelPlugin(id) {
  ...
  let setupPlugin;
  try {
    runtimePlugin = (0, _bundledDm0mRqox.n)(resolvedId);
    setupPlugin = (0, _bundledDm0mRqox.i)(resolvedId);
  } catch {
...
function getBootstrapChannelSecrets(id) {
  ...
  try {
    const merged = mergePluginSection((0, _bundledDm0mRqox.r)(resolvedId), (0, _bundledDm0mRqox.a)(resolvedId));
