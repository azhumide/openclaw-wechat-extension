...
var _instantiate = require("../engine/readonly-object/instantiate.mjs"); // deno-fmt-ignore-file
 ...
 * @deprecated
*/
const ReadonlyType = exports.ReadonlyType = ReadonlyObject; /* v9-8b45ddccdcfe1828 */
