"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = listTokenSourcedAccounts;exports.i = createUnionActionGate;exports.n = createMessageToolCardSchema;exports.r = resolveReactionMessageId;exports.t = createMessageToolButtonsSchema;var _commonCfyIgNqB = require("./common-CfyIgNqB.js");
require("./sandbox-paths-DDXc8qVW.js");
var _typeboxCgcfAWWB = require("./typebox-CgcfAWWB.js");
...
function resolveReactionMessageId(params) {
  return (0, _commonCfyIgNqB.h)(params.args, "messageId") ?? params.toolContext?.currentMessageId;
}
//#endregion
...
function createMessageToolButtonsSchema() {
  return _typebox.Type.Optional(_typebox.Type.Array(_typebox.Type.Array(_typebox.Type.Object({
    ...
    style: _typebox.Type.Optional((0, _typeboxCgcfAWWB.i)([
    "danger",
    "success",
    "primary"]
    ))
