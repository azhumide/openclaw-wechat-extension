"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = resolveBinaryVersion;exports.c = resolveUsableRuntimeVersion;exports.i = readVersionFromPackageJsonForModuleUrl;exports.l = resolveVersionFromModuleUrl;exports.n = void 0;exports.o = resolveCompatibilityHostVersion;exports.r = readVersionFromBuildInfoForModuleUrl;exports.s = resolveRuntimeServiceVersion;exports.t = void 0;var _stringCoerceCjxCKZ6B = require("./string-coerce-CjxCKZ6B.js");
...
function readVersionFromJsonCandidates(moduleUrl, candidates, opts = {}) {
  try {
    ...
    for (const candidate of candidates) try {
      ...
      const version = (0, _stringCoerceCjxCKZ6B.c)(parsed.version);
      if (!version) continue;
...
function resolveUsableRuntimeVersion(version) {
  const trimmed = (0, _stringCoerceCjxCKZ6B.c)(version);
