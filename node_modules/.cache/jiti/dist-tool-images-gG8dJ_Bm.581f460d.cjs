"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.i = resolveImageSanitizationLimits;exports.n = sanitizeImageBlocks;exports.r = sanitizeToolResultImages;exports.t = sanitizeContentBlocksImages;var _subsystemRHhUC6qs = require("./subsystem-rHhUC6qs.js");
var _base64Jn7E7URN = require("./base64-jn7E7URN.js");
var _imageOpsB5o_jjbN = require("./image-ops-B5o_jjbN.js");
...
const log = (0, _subsystemRHhUC6qs.t)("agents/tool-images");
...
async function resizeImageBase64IfNeeded(params) {
  ...
  const meta = await (0, _imageOpsB5o_jjbN.a)(buf);
  ...
  const sideGrid = (0, _imageOpsB5o_jjbN.r)(params.maxDimensionPx, sideStart);
  let smallest = null;
  for (const side of sideGrid) for (const quality of _imageOpsB5o_jjbN.t) {
    const out = await (0, _imageOpsB5o_jjbN.l)({
      buffer: buf,
      maxSide: side,
      quality,
