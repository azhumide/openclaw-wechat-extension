"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.i = validateArchiveEntryPath;exports.n = resolveArchiveOutputPath;exports.r = stripArchivePath;exports.t = isWindowsDrivePath;var _pathSafetyBbVpsGQx = require("./path-safety-BbVpsGQx.js");
...
function resolveArchiveOutputPath(params) {
  const safeBase = (0, _pathSafetyBbVpsGQx.n)(params.rootDir);
