...
var _idsBSRTG6a = require("./ids-B-sRTG6a.js");
...
function normalizeRouteBindingChannelId(raw) {
  const normalized = (0, _idsBSRTG6a.r)(raw);
...
function resolveNormalizedRouteBindingMatch(binding) {
  ...
  return {
    agentId: (0, _sessionKeyC6FNnIG.c)(binding.agentId),
    accountId: (0, _accountIdCRE2SEcy.n)(accountId),
    channelId
  };
}
