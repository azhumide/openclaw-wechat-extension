"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.i = resolveImageSanitizationLimits;exports.n = sanitizeImageBlocks;exports.r = sanitizeToolResultImages;exports.t = sanitizeContentBlocksImages;var _subsystemDwIxKdWw = require("./subsystem-DwIxKdWw.js");
var _base64DUzs4VMO = require("./base64-DUzs4VMO.js");
var _imageOpsDC0Gk9y = require("./image-ops-DC0Gk-9y.js");
...
const log = (0, _subsystemDwIxKdWw.t)("agents/tool-images");
...
async function resizeImageBase64IfNeeded(params) {
  ...
  const meta = await (0, _imageOpsDC0Gk9y.a)(buf);
  ...
  const sideGrid = (0, _imageOpsDC0Gk9y.r)(params.maxDimensionPx, sideStart);
  let smallest = null;
  for (const side of sideGrid) for (const quality of _imageOpsDC0Gk9y.t) {
    const out = await (0, _imageOpsDC0Gk9y.l)({
      buffer: buf,
      maxSide: side,
      quality,
...
async function sanitizeContentBlocksImages(blocks, label, opts = {}) {
  ...
  for (const block of blocks) {
    ...
    const canonicalData = (0, _base64DUzs4VMO.t)(data);
    if (!canonicalData) {
      out.push({
        type: "text",
