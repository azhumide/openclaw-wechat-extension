...
var _pluginRegistryDiJTylvG = require("./plugin-registry-DiJTylvG.js");
var _subsystemBhqMcUP = require("./subsystem-Bhq-McUP.js");
var _moduleExportD6usozYb = require("./module-export-D6usozYb.js");
...
const nodeRequire = (0, _nodeModule.createRequire)("file:///home/rs/openclaw/dist/bundled-Di2LIL8m.js");
...
function loadModuleWithJiti(modulePath) {
  return (0, _pluginModuleLoaderCacheAdUe8Mp.n)({
    cache: jitiLoaders,
    modulePath,
    importerUrl: "file:///home/rs/openclaw/dist/bundled-Di2LIL8m.js",
    loaderFilename: "file:///home/rs/openclaw/dist/bundled-Di2LIL8m.js",
    tryNative: false,
    cacheScopeKey: "channel-plugin-module-loader"
  })(modulePath);
}
function loadModule(modulePath) {
  if (!(0, _pluginModuleLoaderCacheAdUe8Mp.i)(modulePath) && !hasNativeSourceRequireHook(modulePath)) {
...
const OPENCLAW_PACKAGE_ROOT = (0, _openclawRootCRSCIPqz.n)({
  ...
  cwd: process.cwd(),
  moduleUrl: "file:///home/rs/openclaw/dist/bundled-Di2LIL8m.js".startsWith("file:") ? "file:///home/rs/openclaw/dist/bundled-Di2LIL8m.js" : void 0
}) ?? ("file:///home/rs/openclaw/dist/bundled-Di2LIL8m.js".startsWith("file:") ? _nodePath.default.resolve((0, _nodeUrl.fileURLToPath)(new URL("../../..", "file:///home/rs/openclaw/dist/bundled-Di2LIL8m.js"))) : process.cwd());
...
function listBundledChannelPluginMetadata(params) {
  ...
  return (0, _pluginRegistryDiJTylvG.n)({
...
function resolveBundledChannelGeneratedPath(rootDir, entry, pluginDirName, scanDir) {
  return (0, _moduleExportD6usozYb.n)(rootDir, entry, pluginDirName, scanDir);
}
//#endregion
...
const log = (0, _subsystemBhqMcUP.t)("channels");
...
function resolveChannelPluginModuleEntry(moduleExport) {
  const resolved = (0, _moduleExportD6usozYb.t)(moduleExport);
...
function shouldIncludeBundledChannelSetupFeatureForConfig(params) {
  ...
  if (!passesManifestOwnerBasePolicy({
    plugin: { id: pluginId },
    normalizedConfig: (0, _configState6n1ivR.o)(params.config.plugins),
