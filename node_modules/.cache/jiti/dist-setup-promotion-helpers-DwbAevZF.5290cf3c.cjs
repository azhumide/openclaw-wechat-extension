"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = resolveSingleAccountPromotionTarget;exports.t = resolveSingleAccountKeysToMove;var _stringCoerceC1IzJjqi = require("./string-coerce-C1IzJjqi.js");
...
function getLoadedChannelSetupPromotionSurface(channelKey) {
  return asPromotionSurface((0, _registryB2TRwbJD.n)(channelKey)?.setup);
}
function getBundledChannelSetupPromotionSurface(channelKey) {
  if (!(0, _bundledBd4FvHUg.o)(channelKey, "configPromotion")) return null;
  return asPromotionSurface((0, _bundledBd4FvHUg.n)(channelKey)?.setup);
}
...
function resolveSingleAccountPromotionTarget(params) {
  ...
  const resolveExistingAccountId = (targetAccountId) => {
    const normalizedTargetAccountId = (0, _accountIdC3j_3_su.n)(targetAccountId);
    return Object.keys(accounts).find((accountId) => (0, _accountIdC3j_3_su.n)(accountId) === normalizedTargetAccountId) ?? normalizedTargetAccountId;
  };
  ...
  const normalizedResolved = (0, _stringCoerceC1IzJjqi.c)(resolved);
  if (normalizedResolved) return resolveExistingAccountId(normalizedResolved);
  return resolveExistingAccountId(_accountIdC3j_3_su.t);
}
//#endregion /* v9-b55e96ace6c86727 */
