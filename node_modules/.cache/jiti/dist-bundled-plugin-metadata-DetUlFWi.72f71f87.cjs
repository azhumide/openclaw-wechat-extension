"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = collectBundledChannelConfigs;exports.i = resolveBundledPluginRepoEntryPath;exports.n = listBundledPluginMetadata;exports.o = normalizeBundledPluginStringList;exports.r = resolveBundledPluginGeneratedPath;exports.s = resolveBundledPluginScanDir;exports.t = findBundledPluginMetadataById;var _stringCoerceCjxCKZ6B = require("./string-coerce-CjxCKZ6B.js");
...
var _configSchema8E_CZC = require("./config-schema-8E_-cZ-c.js");
var _publicSurfaceRuntimeC5JbX = require("./public-surface-runtime-C5JbX743.js");
var _sdkAliasDij9SbK = require("./sdk-alias-Dij9SbK3.js");
...
function normalizeBundledPluginStringList(value) {
  return (0, _stringNormalization5F0OqbT.l)(value);
}
...
function isTopLevelPublicSurfaceSource(name) {
  if (!_publicSurfaceRuntimeC5JbX.t.includes(_nodePath.default.extname(name))) return false;
...
function deriveBundledPluginIdHint(params) {
  ...
  const packageName = (0, _stringCoerceCjxCKZ6B.c)(params.packageName);
...
function collectBundledPluginPublicSurfaceArtifacts(params) {
  const excluded = new Set((0, _stringNormalization5F0OqbT.l)([params.sourceEntry, params.setupEntry]).map((entry) => _nodePath.default.basename(entry)));
...
function resolveConfigSchemaExport(imported) {
  ...
  for (const [name, value] of Object.entries(imported)) {
    ...
    if (value && typeof value === "object") return (0, _configSchema8E_CZC.r)(value);
  }
...
function getJiti(modulePath) {
  return (0, _jitiLoaderCacheBat69wam.t)({
    cache: jitiLoaders,
    modulePath,
    importerUrl: "file:///home/rs/openclaw/dist/bundled-plugin-metadata-DetUlFWi.js",
    preferBuiltDist: true,
    jitiFilename: "file:///home/rs/openclaw/dist/bundled-plugin-metadata-DetUlFWi.js"
  });
}
function resolveChannelConfigSchemaModulePath(pluginDir) {
  ...
  for (const basename of PUBLIC_CONFIG_SURFACE_BASENAMES) for (const extension of _publicSurfaceRuntimeC5JbX.t) {
...
function collectBundledChannelConfigs(params) {
  ...
  for (const channelId of channelIds) {
    ...
    existingChannelConfigs[channelId] = {
      ...
      ...((0, _stringCoerceCjxCKZ6B.c)(existing?.label) ?? (0, _stringCoerceCjxCKZ6B.c)(channelMeta?.label) ? { label: (0, _stringCoerceCjxCKZ6B.c)(existing?.label) ?? (0, _stringCoerceCjxCKZ6B.c)(channelMeta?.label) } : {}),
      ...((0, _stringCoerceCjxCKZ6B.c)(existing?.description) ?? (0, _stringCoerceCjxCKZ6B.c)(channelMeta?.blurb) ? { description: (0, _stringCoerceCjxCKZ6B.c)(existing?.description) ?? (0, _stringCoerceCjxCKZ6B.c)(channelMeta?.blurb) } : {}),
...
const OPENCLAW_PACKAGE_ROOT = (0, _sdkAliasDij9SbK.l)({
  modulePath: (0, _nodeUrl.fileURLToPath)("file:///home/rs/openclaw/dist/bundled-plugin-metadata-DetUlFWi.js"),
  moduleUrl: "file:///home/rs/openclaw/dist/bundled-plugin-metadata-DetUlFWi.js"
}) ?? (0, _nodeUrl.fileURLToPath)(new URL("../..", "file:///home/rs/openclaw/dist/bundled-plugin-metadata-DetUlFWi.js"));
const CURRENT_MODULE_PATH = (0, _nodeUrl.fileURLToPath)("file:///home/rs/openclaw/dist/bundled-plugin-metadata-DetUlFWi.js");
  ...
  for (const dirName of _nodeFs.default.readdirSync(resolvedScanDir, { withFileTypes: true }).filter((entry) => entry.isDirectory()).map((entry) => entry.name).toSorted((left, right) => left.localeCompare(right))) {
    ...
    entries.push({
      ...
      idHint: deriveBundledPluginIdHint({
        ...
        packageName: (0, _stringCoerceCjxCKZ6B.c)(packageJson?.name),
      ...
      ...((0, _stringCoerceCjxCKZ6B.c)(packageJson?.name) ? { packageName: (0, _stringCoerceCjxCKZ6B.c)(packageJson?.name) } : {}),
      ...((0, _stringCoerceCjxCKZ6B.c)(packageJson?.version) ? { packageVersion: (0, _stringCoerceCjxCKZ6B.c)(packageJson?.version) } : {}),
      ...((0, _stringCoerceCjxCKZ6B.c)(packageJson?.description) ? { packageDescription: (0, _stringCoerceCjxCKZ6B.c)(packageJson?.description) } : {}),
