...
var _zodParseBmWf26eL = require("./zod-parse-BmWf26eL.js");
...
function parsePossiblyNoisyStatus(raw) {
  ...
  return (0, _zodParseBmWf26eL.t)(TailscaleStatusSchema, raw.slice(start, end + 1));
}
