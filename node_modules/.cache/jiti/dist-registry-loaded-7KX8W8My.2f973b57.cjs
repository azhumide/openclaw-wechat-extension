"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = listLoadedChannelPlugins;exports.t = getLoadedChannelPluginById;var _stringCoerceBje8XVt = require("./string-coerce-Bje8XVt9.js");
var _idsC5uBFLeA = require("./ids-C5uBFLeA.js");
var _runtimeChannelStateL9dosyQh = require("./runtime-channel-state-l9dosyQh.js");
require("./registry-GHcDenJ3.js");
...
function resolveCachedChannelPlugins() {
  const registry = (0, _runtimeChannelStateL9dosyQh.t)();
  const registryVersion = (0, _runtimeChannelStateL9dosyQh.n)();
  ...
  const sorted = dedupeChannels(channelPlugins).toSorted((a, b) => {
    const indexA = _idsC5uBFLeA.n.indexOf(a.id);
    const indexB = _idsC5uBFLeA.n.indexOf(b.id);
