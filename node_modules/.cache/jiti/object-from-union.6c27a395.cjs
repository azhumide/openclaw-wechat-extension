...
var _fromType = require("./from-type.mjs"); // deno-fmt-ignore-file
...
function ReduceVariants(types, result) {
  return _index.Guard.TakeLeft(types, (left, right) => ReduceVariants(right, CollapseUnionProperties(result, (0, _fromType.FromType)(left))), () => result);
}
function FromUnion(types) {
  return _index.Guard.TakeLeft(types, (left, right) => ReduceVariants(right, (0, _fromType.FromType)(left)), () => (0, _index2.Unreachable)());
}
// deno-coverage-ignore-stop /* v9-40020d2bd9276505 */
