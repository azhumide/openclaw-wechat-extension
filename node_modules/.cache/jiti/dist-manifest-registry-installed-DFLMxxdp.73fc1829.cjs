"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = resolveInstalledManifestRegistryIndexFingerprint;exports.t = loadPluginManifestRegistryForInstalledIndex;var _installedPluginIndexStoreWXOsBZRd = require("./installed-plugin-index-store-WXOsBZRd.js");
...
function resolveInstalledManifestRegistryIndexFingerprint(index) {
  return (0, _installedPluginIndexStoreWXOsBZRd.v)(buildInstalledManifestRegistryIndexKey(index));
}
...
function resolveInstalledPackageMetadata(record) {
  ...
  try {
    ...
    const dependencies = (0, _discoveryB19Xdk1_.r)({
...
function loadPluginManifestRegistryForInstalledIndex(params) {
  return (0, _discoveryB19Xdk1_.o)("manifest registry", () => {
    ...
    return (0, _manifestRegistryC9Iavh.t)({
      config: params.config,
      workspaceDir: params.workspaceDir,
      env,
      candidates,
      diagnostics: [...diagnostics],
      installRecords: (0, _installedPluginIndexStoreWXOsBZRd.h)(params.index),
