...
var _bootstrapRegistryD_IcJY_k = require("./bootstrap-registry-D_IcJY_k.js");
...
function listActionTargetAliasSpecs(action, params, channel) {
  ...
  const channelSpec = (0, _bootstrapRegistryD_IcJY_k.t)(normalizedChannel)?.actions?.messageActionTargetAliases?.[action];
