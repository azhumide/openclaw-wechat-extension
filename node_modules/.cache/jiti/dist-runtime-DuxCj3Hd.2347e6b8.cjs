...
const state = (() => {
  ...
  let registryState = globalState[_runtimeStateUGPHsBCx.t];
  if (!registryState) {
    registryState = {
      activeRegistry: null,
      activeVersion: 0,
    ...
    globalState[_runtimeStateUGPHsBCx.t] = registryState;
  }
