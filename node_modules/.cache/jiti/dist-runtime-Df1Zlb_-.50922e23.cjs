...
const state = (() => {
  ...
  let registryState = globalState[_runtimeStateDibqiYLk.t];
  if (!registryState) {
    registryState = {
      activeRegistry: null,
      activeVersion: 0,
    ...
    globalState[_runtimeStateDibqiYLk.t] = registryState;
  }
