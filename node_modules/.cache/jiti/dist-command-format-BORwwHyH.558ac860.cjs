...
var _cliNameM4Egpgjx = require("./cli-name-m4Egpgjx.js");
...
function formatCliCommand(command, env = process.env) {
  const normalizedCommand = (0, _cliNameM4Egpgjx.t)(command, (0, _cliNameM4Egpgjx.n)());
