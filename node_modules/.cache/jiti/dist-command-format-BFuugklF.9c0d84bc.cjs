"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.t = formatCliCommand;var _profileUtilsTo1CCPIt = require("./profile-utils-To1CCPIt.js");
var _cliNameCga4Kejh = require("./cli-name-Cga4Kejh.js");
...
function formatCliCommand(command, env = process.env) {
  const normalizedCommand = (0, _cliNameCga4Kejh.t)(command, (0, _cliNameCga4Kejh.n)());
  ...
  const profile = (0, _profileUtilsTo1CCPIt.n)(env.OPENCLAW_PROFILE);
