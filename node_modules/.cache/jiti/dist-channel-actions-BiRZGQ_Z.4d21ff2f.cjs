"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = listTokenSourcedAccounts;exports.i = createUnionActionGate;exports.n = createMessageToolCardSchema;exports.r = resolveReactionMessageId;exports.t = createMessageToolButtonsSchema;var _commonWwJcpwdP = require("./common-WwJcpwdP.js");
require("./sandbox-paths-Cj6n8_FZ.js");
var _typeboxCX1CigOB = require("./typebox-CX1CigOB.js");
...
function resolveReactionMessageId(params) {
  return (0, _commonWwJcpwdP.h)(params.args, "messageId") ?? params.toolContext?.currentMessageId;
}
//#endregion
...
function createMessageToolButtonsSchema() {
  return _typebox.Type.Optional(_typebox.Type.Array(_typebox.Type.Array(_typebox.Type.Object({
    ...
    style: _typebox.Type.Optional((0, _typeboxCX1CigOB.i)([
    "danger",
    "success",
    "primary"]
    ))
