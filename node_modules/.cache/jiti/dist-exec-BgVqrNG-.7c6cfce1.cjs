...
var _windowsCommandV_YcQz6i = require("./windows-command-V_YcQz6i.js");
...
function resolveCommand(command) {
  return (0, _windowsCommandV_YcQz6i.t)({
    command,
    cmdCommands: [
    "corepack",
    "pnpm",
...
async function runExec(command, args, opts = 1e4) {
  ...
  try {
    ...
    const windowsEncoding = (0, _windowsCommandV_YcQz6i.o)();
    const decodedStdout = (0, _windowsCommandV_YcQz6i.a)({
      buffer: stdout,
      windowsEncoding
    });
    const decodedStderr = (0, _windowsCommandV_YcQz6i.a)({
      buffer: stderr,
      windowsEncoding
    });
    if ((0, _globalsDAPTRKx.a)()) {
      if (decodedStdout.trim()) (0, _loggerC44RY.t)(decodedStdout.trim());
      if (decodedStderr.trim()) (0, _loggerC44RY.n)(decodedStderr.trim());
    }
    return {
    ...
    if (err && typeof err === "object") {
      ...
      if (Buffer.isBuffer(errorWithOutput.stdout)) errorWithOutput.stdout = (0, _windowsCommandV_YcQz6i.a)({
        buffer: errorWithOutput.stdout,
        windowsEncoding
      });
      if (Buffer.isBuffer(errorWithOutput.stderr)) errorWithOutput.stderr = (0, _windowsCommandV_YcQz6i.a)({
        buffer: errorWithOutput.stderr,
        windowsEncoding
      });
    }
    if ((0, _globalsDAPTRKx.a)()) (0, _loggerC44RY.n)((0, _globalsDAPTRKx.t)(`Command failed: ${command} ${args.join(" ")}`));
    throw err;
  }
}
...
async function runCommandWithTimeout(argv, optionsOrTimeout) {
  ...
  const stdio = (0, _windowsCommandV_YcQz6i.n)({
    hasInput,
    preferInherit: true
  });
  ...
  return await new Promise((resolve, reject) => {
    ...
    const resolveFromClose = (code, signal) => {
      ...
      resolve({
        ...
        stdout: (0, _windowsCommandV_YcQz6i.a)({
          buffer: Buffer.concat(stdoutChunks),
          windowsEncoding
        }),
        stderr: (0, _windowsCommandV_YcQz6i.a)({
