"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.FileTypeParser = void 0;exports.fileTypeFromBlob = fileTypeFromBlob;exports.fileTypeFromBuffer = fileTypeFromBuffer;exports.fileTypeFromFile = fileTypeFromFile;exports.fileTypeFromStream = fileTypeFromStream;exports.fileTypeFromTokenizer = fileTypeFromTokenizer;exports.fileTypeStream = fileTypeStream;exports.normalizeSampleSize = normalizeSampleSize;exports.supportedMimeTypes = exports.supportedExtensions = exports.reasonableDetectionSizeInBytes = void 0;
...
var _zip = require("./detectors/zip.js");
var _ebml = require("./detectors/ebml.js");
var _png = require("./detectors/png.js");
var _asf = require("./detectors/asf.js");function _interopRequireWildcard(e, t) {if ("function" == typeof WeakMap) var r = new WeakMap(),n = new WeakMap();return (_interopRequireWildcard = function (e, t) {if (!t && e && e.__esModule) return e;var o,i,f = { __proto__: null, default: e };if (null === e || "object" != typeof e && "function" != typeof e) return f;if (o = t ? n : r) {if (o.has(e)) return o.get(e);o.set(e, f);}for (const t in e) "default" !== t && {}.hasOwnProperty.call(e, t) && ((i = (o = Object.defineProperty) && Object.getOwnPropertyDescriptor(e, t)) && (i.get || i.set) ? o(f, t, i) : f[t] = e[t]);return f;})(e, t);} /**
...
const maximumNestedGzipDetectionSizeInBytes = _parser.maximumUntrustedSkipSizeInBytes;
const maximumNestedGzipProbeDepth = 1;
const unknownSizeGzipProbeTimeoutInMilliseconds = 100;
const maximumId3HeaderSizeInBytes = _parser.maximumUntrustedSkipSizeInBytes;
const maximumTiffTagCount = 512;
const maximumDetectionReentryCount = 256;
const maximumTiffStreamIfdOffsetInBytes = 1024 * 1024;
const maximumTiffIfdOffsetInBytes = _parser.maximumUntrustedSkipSizeInBytes;
...
function importAtRuntime(specifier) {
  return ((specifier) => new Promise((r) => r(`${specifier}`)).then((s) => jitiImport(s).then((m) => _interopRequireWildcard(m))))(specifier);
}
...
class FileTypeParser {
  ...
  async parseTokenizer(tokenizer, detectionReentryCount = 0) {
    ...
    for (const detector of this.detectors) {
      ...
      try {
        ...
        if (error instanceof _parser.ParserHardLimitError) {
          return;
        }
  ...
  async toDetectionStream(stream, options) {
    ...
    if (totalSize > 0) {
      const sample = chunks.length === 1 ? chunks[0] : (0, _uint8arrayExtras.concatUint8Arrays)(chunks);
      try {
  ...
  async detectGzip(tokenizer) {
    ...
    const hasUnknownSize = (0, _parser.hasUnknownFileSize)(tokenizer);
    let timeout;
    let probeSignal;
    let probeParser;
  ...
  check(header, options) {
    return (0, _parser.checkBytes)(this.buffer, header, options);
  }

  checkString(header, options) {
    return this.check((0, _tokens.stringToBytes)(header, options?.encoding), options);
  }
  ...
  detectConfident = async (tokenizer) => {
    ...
    if (this.checkString('ID3')) {
      await (0, _parser.safeIgnore)(tokenizer, 6, {
        maximumLength: 6,
        reason: 'ID3 header prefix'
      }); // Skip ID3 header until the header size
      const id3HeaderLength = await tokenizer.readToken(_tokens.uint32SyncSafeToken);
      ...
      try {
        await (0, _parser.safeIgnore)(tokenizer, id3HeaderLength, {
    ...
    if (this.check([0x50, 0x4B, 0x3, 0x4])) {// Local file header signature
      return (0, _zip.detectZip)(tokenizer);
    }
    ...
    if (this.checkString('OggS')) {
      ...
      if ((0, _parser.checkBytes)(type, [0x4F, 0x70, 0x75, 0x73, 0x48, 0x65, 0x61, 0x64])) {
        return {
          ext: 'opus',
      ...
      // If ' theora' in header.
      if ((0, _parser.checkBytes)(type, [0x80, 0x74, 0x68, 0x65, 0x6F, 0x72, 0x61])) {
        return {
          ext: 'ogv',
          mime: 'video/ogg'
        };
      ...
      if ((0, _parser.checkBytes)(type, [0x01, 0x76, 0x69, 0x64, 0x65, 0x6F, 0x00])) {
        return {
          ext: 'ogm',
          mime: 'video/ogg'
        };
      ...
      if ((0, _parser.checkBytes)(type, [0x7F, 0x46, 0x4C, 0x41, 0x43])) {
        return {
          ext: 'oga',
          mime: 'audio/ogg'
        };
      ...
      if ((0, _parser.checkBytes)(type, [0x53, 0x70, 0x65, 0x65, 0x78, 0x20, 0x20])) {
        return {
          ext: 'spx',
          mime: 'audio/ogg'
        };
      ...
      if ((0, _parser.checkBytes)(type, [0x01, 0x76, 0x6F, 0x72, 0x62, 0x69, 0x73])) {
        return {
          ext: 'ogg',
          mime: 'audio/ogg'
        };
    ...
    if (this.check([0x1A, 0x45, 0xDF, 0xA3])) {// Root element: EBML
      return (0, _ebml.detectEbml)(tokenizer);
    }
    ...
    if (this.check([0x89, 0x50, 0x4E, 0x47, 0x0D, 0x0A, 0x1A, 0x0A])) {
      return (0, _png.detectPng)(tokenizer);
    }
    ...
    if (this.check([0x30, 0x26, 0xB2, 0x75, 0x8E, 0x66, 0xCF, 0x11, 0xA6, 0xD9])) {
      return (0, _asf.detectAsf)(tokenizer);
    }
    ...
    this.check([0, 0, 0, 0, 0, 0], { offset: 257 }) && (0, _tokens.tarHeaderChecksumMatches)(this.buffer)) {
      return {
        ext: 'tar',
  ...
  async readTiffIFD(bigEndian) {
    ...
    if (
    (0, _parser.hasUnknownFileSize)(this.tokenizer) &&
  ...
  async readTiffHeader(bigEndian) {
    ...
    if (version === 42) {
      ...
      const maximumTiffOffset = (0, _parser.hasUnknownFileSize)(this.tokenizer) ? maximumTiffIfdOffsetInBytes : this.tokenizer.fileInfo.size;

      try {
        await (0, _parser.safeIgnore)(this.tokenizer, ifdOffset, {
