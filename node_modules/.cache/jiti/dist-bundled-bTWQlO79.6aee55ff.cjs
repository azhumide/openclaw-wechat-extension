...
const OPENCLAW_PACKAGE_ROOT = (0, _openclawRootBNWw3cXT.n)({
  ...
  cwd: process.cwd(),
  moduleUrl: "file:///home/rs/openclaw/dist/bundled-bTWQlO79.js".startsWith("file:") ? "file:///home/rs/openclaw/dist/bundled-bTWQlO79.js" : void 0
}) ?? ("file:///home/rs/openclaw/dist/bundled-bTWQlO79.js".startsWith("file:") ? _nodePath.default.resolve((0, _nodeUrl.fileURLToPath)(new URL("../../..", "file:///home/rs/openclaw/dist/bundled-bTWQlO79.js"))) : process.cwd());
...
function resolveBundledChannelRootScope(env = process.env) {
  const bundledPluginsDir = (0, _bundledDirDXKS8sgC.t)(env);
...
function listBundledChannelPluginMetadata(params) {
  return (0, _bundledPluginMetadataEtgTUll_.n)(params);
}
function resolveBundledChannelGeneratedPath(rootDir, entry, pluginDirName, scanDir) {
  return (0, _bundledPluginMetadataEtgTUll_.r)(rootDir, entry, pluginDirName, scanDir);
}
//#endregion
...
function normalizeChannelMeta(params) {
  ...
  const label = (0, _stringCoerceC1IzJjqi.c)(next?.label) ?? (0, _stringCoerceC1IzJjqi.c)(existing?.label) ?? (0, _stringCoerceC1IzJjqi.c)(next?.selectionLabel) ?? (0, _stringCoerceC1IzJjqi.c)(existing?.selectionLabel) ?? params.id;
  const selectionLabel = (0, _stringCoerceC1IzJjqi.c)(next?.selectionLabel) ?? (0, _stringCoerceC1IzJjqi.c)(existing?.selectionLabel) ?? label;
  const docsPath = (0, _stringCoerceC1IzJjqi.c)(next?.docsPath) ?? (0, _stringCoerceC1IzJjqi.c)(existing?.docsPath) ?? `/channels/${params.id}`;
  const blurb = (0, _stringCoerceC1IzJjqi.c)(next?.blurb) ?? (0, _stringCoerceC1IzJjqi.c)(existing?.blurb) ?? "";
  return {
...
function createModuleLoader() {
  ...
  return (modulePath) => {
    return (0, _jitiLoaderCacheBJKReQBR.t)({
      cache: jitiLoaders,
      modulePath,
      importerUrl: "file:///home/rs/openclaw/dist/bundled-bTWQlO79.js",
      argvEntry: process.argv[1],
      preferBuiltDist: true,
      jitiFilename: "file:///home/rs/openclaw/dist/bundled-bTWQlO79.js"
    });
  };
}
...
function loadChannelPluginModule(params) {
  ...
  if (params.shouldTryNativeRequire?.(safePath)) {
    const nativeModule = (0, _nativeModuleRequireDQr9dNVq.n)(safePath, { allowWindows: true });
...
const log = (0, _subsystemCWI_MDy_.t)("channels");
function resolveChannelPluginModuleEntry(moduleExport) {
  const resolved = (0, _moduleExportCrvs86vh.t)(moduleExport);
...
function loadGeneratedBundledChannelModule(params) {
  ...
  if (params.installRuntimeDeps !== false && (0, _bundledRuntimeRootB0Q1LSRO.t)(boundaryRoot)) {
    const prepared = (0, _bundledRuntimeRootB0Q1LSRO.n)({
  ...
  return loadChannelPluginModule({
    ...
    shouldTryNativeRequire: (safePath) => safePath.includes(`${_nodePath.default.sep}dist${_nodePath.default.sep}`) && (0, _nativeModuleRequireDQr9dNVq.t)(safePath)
  });
}
function loadGeneratedBundledChannelEntry(params) {
  try {
    ...
    const detail = (0, _errorsJbvi20TW.i)(error);
