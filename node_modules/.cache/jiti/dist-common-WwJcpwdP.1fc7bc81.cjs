...
var _toolImagesLDyVjuiq = require("./tool-images-LDyVjuiq.js");
...
async function imageResult(params) {
  ...
  return await (0, _toolImagesLDyVjuiq.r)({
    content,
    details: {
      path: params.path,
      ...params.details,
...
async function imageResultFromFile(params) {
  ...
  const mimeType = (await (0, _mimeSrMFIJPy.n)({ buffer: buf.slice(0, 256) })) ?? "image/png";
