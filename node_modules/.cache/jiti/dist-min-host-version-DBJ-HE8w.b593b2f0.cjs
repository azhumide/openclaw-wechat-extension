...
var _runtimeGuardCIw_BLPB = require("./runtime-guard-CIw_BLPB.js");
...
function parseMinHostVersionRequirement(raw, options = {}) {
  ...
  if (!(0, _runtimeGuardCIw_BLPB.a)(minimumLabel)) return null;
  return {
    raw: trimmed,
    minimumLabel
  };
...
function checkMinHostVersion(params) {
  ...
  const currentSemver = (0, _runtimeGuardCIw_BLPB.a)(currentVersion);
  if (!currentSemver) return {
    ok: false,
    kind: "unknown_host_version",
    requirement
  };
  if (!(0, _runtimeGuardCIw_BLPB.n)(currentSemver, (0, _runtimeGuardCIw_BLPB.a)(requirement.minimumLabel))) return {
    ok: false,
    kind: "incompatible",
    requirement,
    currentVersion
