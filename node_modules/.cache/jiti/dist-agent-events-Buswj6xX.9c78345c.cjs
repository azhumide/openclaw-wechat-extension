...
function emitAgentEvent(event) {
  ...
  (0, _listenersCsNxtVMD.t)(state.listeners, enriched);
}
...
function onAgentEvent(listener) {
  return (0, _listenersCsNxtVMD.n)(getAgentEventState().listeners, listener);
}
