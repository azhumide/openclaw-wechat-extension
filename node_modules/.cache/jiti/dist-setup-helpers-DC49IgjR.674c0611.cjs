...
var _setupPromotionHelpersIOE0qTeJ = require("./setup-promotion-helpers-iOE0qTeJ.js");
...
function moveSingleAccountChannelSectionToDefaultAccount(params) {
  ...
  if (Object.keys(accounts).length > 0) {
    const keysToMove = (0, _setupPromotionHelpersIOE0qTeJ.t)({
      channelKey: params.channelKey,
      channel: base
    });
    if (keysToMove.length === 0) return params.cfg;
    const resolvedTargetAccountKey = resolveExistingAccountKey(accounts, (0, _setupPromotionHelpersIOE0qTeJ.n)({
      channelKey: params.channelKey,
      channel: base
    }));
