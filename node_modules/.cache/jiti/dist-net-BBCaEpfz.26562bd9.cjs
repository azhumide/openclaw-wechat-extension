...
var _tailnetL4ESw9_ = require("./tailnet-L4ESw-9_.js");
var _ipZu3JmZlh = require("./ip-zu3JmZlh.js");
...
function pickPrimaryLanIPv4() {
  return (0, _tailnetL4ESw9_.i)((0, _tailnetL4ESw9_.a)(), {
    family: "IPv4",
...
function isPrivateOrLoopbackAddress(ip) {
  return (0, _ipZu3JmZlh.d)(ip);
}
function normalizeIp(ip) {
  return (0, _ipZu3JmZlh.p)(ip);
}
...
function isTrustedProxyAddress(ip, trustedProxies) {
  ...
  return trustedProxies.some((proxy) => {
    ...
    return (0, _ipZu3JmZlh.o)(normalized, candidate);
  });
}
...
async function resolveGatewayBindHost(bind, customHost) {
  ...
  if (mode === "tailnet") {
    const tailnetIP = (0, _tailnetL4ESw9_.n)();
