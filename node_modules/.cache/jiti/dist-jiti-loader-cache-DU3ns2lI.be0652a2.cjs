"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.t = getCachedPluginJitiLoader;var _sdkAliasK6JYDrXB = require("./sdk-alias-K6JYDrXB.js");
...
function getCachedPluginJitiLoader(params) {
  ...
  const defaultConfig = hasAliasOverride || hasTryNativeOverride ? (0, _sdkAliasK6JYDrXB.u)({
  ...
  const cacheKey = resolved.cacheKey ?? (0, _sdkAliasK6JYDrXB.r)({
    tryNative,
    aliasMap
  });
  ...
  const loader = (params.createLoader ?? _jiti.createJiti)(jitiFilename, {
    ...(0, _sdkAliasK6JYDrXB.n)(aliasMap),
    tryNative
  });
  params.cache.set(scopedCacheKey, loader);
  return loader;
}
//#endregion /* v9-8bd09055cc41f767 */
