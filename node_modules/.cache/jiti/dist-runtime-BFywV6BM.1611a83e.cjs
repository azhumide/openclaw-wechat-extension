...
const state = (() => {
  ...
  let registryState = globalState[_runtimeStateQlSEpF_I.t];
  if (!registryState) {
    registryState = {
      activeRegistry: null,
      activeVersion: 0,
    ...
    globalState[_runtimeStateQlSEpF_I.t] = registryState;
  }
