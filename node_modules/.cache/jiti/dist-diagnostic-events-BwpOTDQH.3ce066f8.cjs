"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports._ = isValidDiagnosticTraceId;exports.a = onDiagnosticEvent;exports.c = setDiagnosticsEnabledForProcess;exports.d = createDiagnosticTraceContextFromActiveScope;exports.f = formatDiagnosticTraceparent;exports.g = isValidDiagnosticTraceFlags;exports.h = isValidDiagnosticSpanId;exports.i = isDiagnosticsEnabled;exports.l = createChildDiagnosticTraceContext;exports.m = getActiveDiagnosticTraceContext;exports.n = emitDiagnosticEvent;exports.o = onInternalDiagnosticEvent;exports.p = freezeDiagnosticTraceContext;exports.r = emitTrustedDiagnosticEvent;exports.s = resetDiagnosticEventsForTest;exports.t = areDiagnosticsEnabledForProcess;exports.u = createDiagnosticTraceContext;exports.v = parseDiagnosticTraceparent;exports.y = runWithDiagnosticTraceContext;var _prototypeKeysB9rjoUHr = require("./prototype-keys-B9rjoUHr.js");
...
function enrichDiagnosticEvent(state, event) {
  ...
  for (const [key, value] of Object.entries(event)) {
    if ((0, _prototypeKeysB9rjoUHr.t)(key)) continue;
    enriched[key] = value;
  }
