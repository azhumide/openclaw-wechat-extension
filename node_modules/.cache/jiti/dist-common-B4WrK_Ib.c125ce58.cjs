...
function toSnakeCaseKey(key) {
  return (0, _stringCoerceC1IzJjqi.r)(key.replace(/([A-Z]+)([A-Z][a-z])/g, "$1_$2").replace(/([a-z0-9])([A-Z])/g, "$1_$2"));
}
...
async function imageResult(params) {
  ...
  return await (0, _toolImagesCE0bWSrm.r)({
    content,
    details: {
      path: params.path,
      ...params.details,
...
async function imageResultFromFile(params) {
  ...
  const mimeType = (await (0, _mimeZn7U6BSf.t)({ buffer: buf.slice(0, 256) })) ?? "image/png";
