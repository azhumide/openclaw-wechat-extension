"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = listLoadedChannelPlugins;exports.t = getLoadedChannelPluginById;var _stringCoerceCjxCKZ6B = require("./string-coerce-CjxCKZ6B.js");
var _idsBPsM98Uu = require("./ids-BPsM98Uu.js");
var _runtimeChannelStateCohMybAh = require("./runtime-channel-state-CohMybAh.js");
require("./registry-CGsqKAN1.js");
...
function coerceLoadedChannelPlugin(plugin) {
  const id = (0, _stringCoerceCjxCKZ6B.c)(plugin?.id) ?? "";
...
function resolveCachedChannelPlugins() {
  const registry = (0, _runtimeChannelStateCohMybAh.t)();
  const registryVersion = (0, _runtimeChannelStateCohMybAh.n)();
  ...
  const sorted = dedupeChannels(channelPlugins).toSorted((a, b) => {
    const indexA = _idsBPsM98Uu.n.indexOf(a.id);
    const indexB = _idsBPsM98Uu.n.indexOf(b.id);
...
function getLoadedChannelPluginById(id) {
  const resolvedId = (0, _stringCoerceCjxCKZ6B.c)(id) ?? "";
  if (!resolvedId) return;
  return resolveCachedChannelPlugins().byId.get(resolvedId);
}
//#endregion /* v9-56a8e5c0acb9eead */
