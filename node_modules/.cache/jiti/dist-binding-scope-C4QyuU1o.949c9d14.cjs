...
function normalizeRouteBindingChannelId(raw) {
  const normalized = (0, _idsBPsM98Uu.r)(raw);
  if (normalized) return normalized;
  return (0, _stringCoerceCjxCKZ6B.a)(raw) || null;
}
function resolveNormalizedRouteBindingMatch(binding) {
  ...
  return {
    agentId: (0, _sessionKeyCn2QoOyX.c)(binding.agentId),
    accountId: (0, _accountIdBM1T.n)(accountId),
    channelId
  };
}
