...
function toSnakeCaseKey(key) {
  return (0, _stringCoerceCjxCKZ6B.r)(key.replace(/([A-Z]+)([A-Z][a-z])/g, "$1_$2").replace(/([a-z0-9])([A-Z])/g, "$1_$2"));
}
...
async function imageResult(params) {
  ...
  return await (0, _toolImagesD3xLJx.r)({
    content,
    details: {
      path: params.path,
      ...params.details,
...
async function imageResultFromFile(params) {
  ...
  const mimeType = (await (0, _mimeDx8S3QoZ.t)({ buffer: buf.slice(0, 256) })) ?? "image/png";
