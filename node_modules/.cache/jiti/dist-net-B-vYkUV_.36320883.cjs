"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports._ = resolveRequestClientIp;exports.a = isLoopbackHost;exports.c = isSecureWebSocketUrl;exports.d = normalizeHostHeader;exports.f = pickPrimaryLanIPv4;exports.g = resolveHostName;exports.h = resolveGatewayListenHosts;exports.i = isLoopbackAddress;exports.l = isTrustedProxyAddress;exports.m = resolveGatewayBindHost;exports.n = isContainerEnvironment;exports.o = isPrivateOrLoopbackAddress;exports.p = resolveClientIp;exports.r = isLocalishHost;exports.s = isPrivateOrLoopbackHost;exports.t = defaultGatewayBindMode;exports.u = isValidIPv4;var _stringCoerceCjxCKZ6B = require("./string-coerce-CjxCKZ6B.js");
var _tailnetB84QdFQz = require("./tailnet-B84QdFQz.js");
var _ipBDZZzbo_ = require("./ip-BDZZzbo_.js");
...
function pickPrimaryLanIPv4() {
  return (0, _tailnetB84QdFQz.i)((0, _tailnetB84QdFQz.a)(), {
    family: "IPv4",
    preferredNames: ["en0", "eth0"]
  });
}
function normalizeHostHeader(hostHeader) {
  return (0, _stringCoerceCjxCKZ6B.a)(hostHeader);
}
...
function isPrivateOrLoopbackAddress(ip) {
  return (0, _ipBDZZzbo_.d)(ip);
}
function normalizeIp(ip) {
  return (0, _ipBDZZzbo_.p)(ip);
}
...
function isTrustedProxyAddress(ip, trustedProxies) {
  ...
  return trustedProxies.some((proxy) => {
    ...
    return (0, _ipBDZZzbo_.o)(normalized, candidate);
  });
}
...
async function resolveGatewayBindHost(bind, customHost) {
  ...
  if (mode === "tailnet") {
    const tailnetIP = (0, _tailnetB84QdFQz.n)();
...
function parseHostForAddressChecks(host) {
  if (!host) return null;
  const normalizedHost = (0, _stringCoerceCjxCKZ6B.a)(host);
