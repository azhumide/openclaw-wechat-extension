"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = resolveGlobalDedupeCache;exports.t = createDedupeCache;var _globalSingletonDSEXPThW = require("./global-singleton-DSEXPThW.js");
var _mapSizeDhix_22h = require("./map-size-Dhix_22h.js");
...
function createDedupeCache(options) {
  ...
  const prune = (now) => {
    ...
    (0, _mapSizeDhix_22h.t)(cache, maxSize);
  };
...
function resolveGlobalDedupeCache(key, options) {
  return (0, _globalSingletonDSEXPThW.n)(key, () => createDedupeCache(options));
}
//#endregion /* v9-b0eacee70422c357 */
