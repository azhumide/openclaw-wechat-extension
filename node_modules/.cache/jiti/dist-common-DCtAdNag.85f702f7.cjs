...
var _mimeDInSAXBk = require("./mime-DInSAXBk.js");
var _toolImagesMtK7dCuI = require("./tool-images-mtK7dCuI.js");
...
async function imageResult(params) {
  ...
  return await (0, _toolImagesMtK7dCuI.r)({
    content,
    details: {
      path: params.path,
      ...params.details,
...
async function imageResultFromFile(params) {
  ...
  const mimeType = (await (0, _mimeDInSAXBk.n)({ buffer: buf.slice(0, 256) })) ?? "image/png";
