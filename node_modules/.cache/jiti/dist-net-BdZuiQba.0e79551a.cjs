...
var _containerEnvironmentDDqRKx = require("./container-environment-D-dqRKx1.js");
var _tailnetCWLXt0n = require("./tailnet-CWLXt0n0.js");
var _ipWJY16y = require("./ip---wJY16y.js");
...
function pickPrimaryLanIPv4() {
  return (0, _tailnetCWLXt0n.i)((0, _tailnetCWLXt0n.a)(), {
    family: "IPv4",
...
function isPrivateOrLoopbackAddress(ip) {
  return (0, _ipWJY16y.d)(ip);
}
function normalizeIp(ip) {
  return (0, _ipWJY16y.p)(ip);
}
...
function isTrustedProxyAddress(ip, trustedProxies) {
  ...
  return trustedProxies.some((proxy) => {
    ...
    return (0, _ipWJY16y.o)(normalized, candidate);
  });
}
...
async function resolveGatewayBindHost(bind, customHost) {
  ...
  if (mode === "tailnet") {
    const tailnetIP = (0, _tailnetCWLXt0n.n)();
  ...
  if (mode === "auto") {
    if ((0, _containerEnvironmentDDqRKx.t)()) return "0.0.0.0";
    if (await canBindToHost("127.0.0.1")) return "127.0.0.1";
    return "0.0.0.0";
  }
  return "0.0.0.0";
...
function defaultGatewayBindMode(tailscaleMode) {
  ...
  return (0, _containerEnvironmentDDqRKx.t)() ? "auto" : "loopback";
}
/**
