...
var _tailnetXeQJXdvi = require("./tailnet-XeQJXdvi.js");
var _ipBMYroGI = require("./ip-BMYro-gI.js");
...
function pickPrimaryLanIPv4() {
  return (0, _tailnetXeQJXdvi.i)((0, _tailnetXeQJXdvi.a)(), {
    family: "IPv4",
    preferredNames: ["en0", "eth0"]
  });
}
function normalizeHostHeader(hostHeader) {
  return (0, _stringCoerceC1IzJjqi.a)(hostHeader);
}
...
function isPrivateOrLoopbackAddress(ip) {
  return (0, _ipBMYroGI.d)(ip);
}
function normalizeIp(ip) {
  return (0, _ipBMYroGI.p)(ip);
}
...
function isTrustedProxyAddress(ip, trustedProxies) {
  ...
  return trustedProxies.some((proxy) => {
    ...
    return (0, _ipBMYroGI.o)(normalized, candidate);
  });
}
...
async function resolveGatewayBindHost(bind, customHost) {
  ...
  if (mode === "tailnet") {
    const tailnetIP = (0, _tailnetXeQJXdvi.n)();
...
function parseHostForAddressChecks(host) {
  if (!host) return null;
  const normalizedHost = (0, _stringCoerceC1IzJjqi.a)(host);
