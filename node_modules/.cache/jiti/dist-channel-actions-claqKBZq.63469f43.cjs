"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = listTokenSourcedAccounts;exports.i = createUnionActionGate;exports.n = createMessageToolCardSchema;exports.r = resolveReactionMessageId;exports.t = createMessageToolButtonsSchema;var _commonC5vlmv7M = require("./common-C5vlmv7M.js");
require("./sandbox-paths-CGtJXpY7.js");
var _typeboxBukCJRtm = require("./typebox-BukCJRtm.js");
...
function resolveReactionMessageId(params) {
  return (0, _commonC5vlmv7M.h)(params.args, "messageId") ?? params.toolContext?.currentMessageId;
}
//#endregion
...
function createMessageToolButtonsSchema() {
  return _typebox.Type.Optional(_typebox.Type.Array(_typebox.Type.Array(_typebox.Type.Object({
    ...
    style: _typebox.Type.Optional((0, _typeboxBukCJRtm.i)([
    "danger",
    "success",
    "primary"]
    ))
