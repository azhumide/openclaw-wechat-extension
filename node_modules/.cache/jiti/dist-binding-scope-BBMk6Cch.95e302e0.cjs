...
function normalizeRouteBindingChannelId(raw) {
  const normalized = (0, _idsC5uBFLeA.r)(raw);
...
function resolveNormalizedRouteBindingMatch(binding) {
  ...
  return {
    agentId: (0, _sessionKeyHxP9B3Or.c)(binding.agentId),
    accountId: (0, _accountIdDhSD7lhD.n)(accountId),
    channelId
  };
}
