...
var _bundledRuntimeRootD11Fl_T = require("./bundled-runtime-root-D11Fl_T4.js");
...
var _manifestOwnerPolicyBHUJ11vd = require("./manifest-owner-policy-BHUJ11vd.js");
var _subsystemIzrDYZz = require("./subsystem-Izr-DYZz.js");
var _moduleExportZaghQ8eC = require("./module-export-zaghQ8eC.js");
...
const OPENCLAW_PACKAGE_ROOT = (0, _openclawRootBAiQfngU.n)({
  ...
  cwd: process.cwd(),
  moduleUrl: "file:///home/rs/openclaw/dist/bundled-Bd_aUa8x.js".startsWith("file:") ? "file:///home/rs/openclaw/dist/bundled-Bd_aUa8x.js" : void 0
}) ?? ("file:///home/rs/openclaw/dist/bundled-Bd_aUa8x.js".startsWith("file:") ? _nodePath.default.resolve((0, _nodeUrl.fileURLToPath)(new URL("../../..", "file:///home/rs/openclaw/dist/bundled-Bd_aUa8x.js"))) : process.cwd());
...
function resolveBundledChannelRootScope(env = process.env) {
  const bundledPluginsDir = (0, _bundledDirBdVWKJP.n)(env);
...
function listBundledChannelPluginMetadata(params) {
  return (0, _bundledPluginMetadataVxOxTVqO.n)(params);
}
function resolveBundledChannelGeneratedPath(rootDir, entry, pluginDirName, scanDir) {
  return (0, _bundledPluginMetadataVxOxTVqO.r)(rootDir, entry, pluginDirName, scanDir);
}
//#endregion
...
function createModuleLoader() {
  ...
  return (modulePath) => {
    return (0, _bundledPluginMetadataVxOxTVqO.o)({
      cache: jitiLoaders,
      modulePath,
      importerUrl: "file:///home/rs/openclaw/dist/bundled-Bd_aUa8x.js",
      argvEntry: process.argv[1],
      preferBuiltDist: true,
      jitiFilename: "file:///home/rs/openclaw/dist/bundled-Bd_aUa8x.js"
    });
  };
}
...
function loadChannelPluginModule(params) {
  ...
  if (params.shouldTryNativeRequire?.(safePath)) {
    const nativeModule = (0, _bundledPluginMetadataVxOxTVqO.c)(safePath, { allowWindows: true });
...
const log = (0, _subsystemIzrDYZz.t)("channels");
function resolveChannelPluginModuleEntry(moduleExport) {
  const resolved = (0, _moduleExportZaghQ8eC.t)(moduleExport);
...
function loadGeneratedBundledChannelModule(params) {
  ...
  if (params.installRuntimeDeps !== false && (0, _bundledRuntimeRootD11Fl_T.t)(boundaryRoot)) {
  ...
  return loadChannelPluginModule({
    ...
    shouldTryNativeRequire: (safePath) => safePath.includes(`${_nodePath.default.sep}dist${_nodePath.default.sep}`) && (0, _bundledPluginMetadataVxOxTVqO.s)(safePath)
  });
}
function loadGeneratedBundledChannelEntry(params) {
  try {
    ...
    const detail = (0, _errorsG8SYDTCe.i)(error);
...
function shouldIncludeBundledChannelSetupFeatureForConfig(params) {
  ...
  if (!(0, _manifestOwnerPolicyBHUJ11vd.i)({
    plugin: { id: pluginId },
    normalizedConfig: (0, _configStateCB4SZz9a.o)(params.config.plugins),
