...
var _mimeCl8JPQ = require("./mime-Cl8JP-q0.js");
var _toolImagesCYyckPsD = require("./tool-images-CYyckPsD.js");
...
async function imageResult(params) {
  ...
  return await (0, _toolImagesCYyckPsD.r)({
    content,
    details: {
      path: params.path,
      ...params.details,
...
async function imageResultFromFile(params) {
  ...
  const mimeType = (await (0, _mimeCl8JPQ.t)({ buffer: buf.slice(0, 256) })) ?? "image/png";
