"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = readSecretFileSync;exports.i = loadSecretFileSync;exports.n = void 0;exports.o = tryReadSecretFileSync;exports.r = void 0;exports.s = writePrivateSecretFileAtomic;exports.t = void 0;var _utilsBMRcljdi = require("./utils-BMRcljdi.js");
var _safeOpenSyncX8Q1U9Y = require("./safe-open-sync-X8Q1U9Y1.js");
...
function loadSecretFileSync(filePath, label, options = {}) {
  const resolvedPath = (0, _utilsBMRcljdi.m)(filePath.trim());
  ...
  const opened = (0, _safeOpenSyncX8Q1U9Y.t)({
