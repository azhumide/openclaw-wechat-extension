"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = resolveBundledPluginSourcePublicSurfacePath;exports.i = resolveBundledPluginPublicSurfacePath;exports.n = normalizeBundledPluginArtifactSubpath;exports.r = normalizeBundledPluginDirName;exports.t = void 0;var _bundledDirDygrJuRr = require("./bundled-dir-DygrJuRr.js");
...
function resolveBundledPluginPublicSurfacePath(params) {
  const artifactBasename = normalizeBundledPluginArtifactSubpath(params.artifactBasename);
  const dirName = normalizeBundledPluginDirName(params.dirName);
  const explicitBundledPluginsDir = params.bundledPluginsDir ?? (0, _bundledDirDygrJuRr.t)(params.env ?? process.env);
