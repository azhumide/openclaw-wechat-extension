"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.t = resolveBundledPluginsDir;var _stringCoerceC1IzJjqi = require("./string-coerce-C1IzJjqi.js");
...
function bundledPluginsDisabled(env) {
  const raw = (0, _stringCoerceC1IzJjqi.s)(env.OPENCLAW_DISABLE_BUNDLED_PLUGINS);
...
function resolveBundledPluginsDir(env = process.env) {
  ...
  if (override) {
    const resolvedOverride = (0, _utilsBMRcljdi.m)(override, env);
  ...
  try {
    ...
    (0, _openclawRootBNWw3cXT.n)({ moduleUrl: "file:///home/rs/openclaw/dist/bundled-dir-DXKS8sgC.js" })].
  ...
  try {
    let cursor = _nodePath.default.dirname((0, _nodeUrl.fileURLToPath)("file:///home/rs/openclaw/dist/bundled-dir-DXKS8sgC.js"));
    for (let i = 0; i < 6; i += 1) {
