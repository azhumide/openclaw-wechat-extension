"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.i = resolveImageSanitizationLimits;exports.n = sanitizeImageBlocks;exports.r = sanitizeToolResultImages;exports.t = sanitizeContentBlocksImages;var _subsystemCWI_MDy_ = require("./subsystem-CWI_MDy_.js");
var _base64BbC1Ujs = require("./base64-BbC1Ujs8.js");
var _imageOpsDFAxz8Ri = require("./image-ops-DFAxz8Ri.js");
...
const log = (0, _subsystemCWI_MDy_.t)("agents/tool-images");
...
async function resizeImageBase64IfNeeded(params) {
  ...
  const meta = await (0, _imageOpsDFAxz8Ri.a)(buf);
  ...
  const sideGrid = (0, _imageOpsDFAxz8Ri.r)(params.maxDimensionPx, sideStart);
  let smallest = null;
  for (const side of sideGrid) for (const quality of _imageOpsDFAxz8Ri.t) {
    const out = await (0, _imageOpsDFAxz8Ri.l)({
      buffer: buf,
      maxSide: side,
      quality,
...
async function sanitizeContentBlocksImages(blocks, label, opts = {}) {
  ...
  for (const block of blocks) {
    ...
    const canonicalData = (0, _base64BbC1Ujs.t)(data);
    if (!canonicalData) {
      out.push({
        type: "text",
