"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.i = openBoundaryFileSync;exports.n = matchBoundaryFileOpenFailure;exports.r = openBoundaryFile;exports.t = canUseBoundaryFileOpen;var _boundaryPathBSBSMt0u = require("./boundary-path-BSBSMt0u.js");
...
function openBoundaryFileSync(params) {
  ...
  const resolved = resolveBoundaryFilePathGeneric({
    ...
    resolve: (absolutePath) => (0, _boundaryPathBSBSMt0u.r)({
      absolutePath,
...
async function openBoundaryFile(params) {
  ...
  const maybeResolved = resolveBoundaryFilePathGeneric({
    absolutePath: params.absolutePath,
    resolve: (absolutePath) => (0, _boundaryPathBSBSMt0u.n)({
      absolutePath,
      rootPath: params.rootPath,
      rootCanonicalPath: params.rootRealPath,
      boundaryLabel: params.boundaryLabel,
