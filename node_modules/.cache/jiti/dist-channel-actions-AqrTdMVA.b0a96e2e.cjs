"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = listTokenSourcedAccounts;exports.i = createUnionActionGate;exports.n = createMessageToolCardSchema;exports.r = resolveReactionMessageId;exports.t = createMessageToolButtonsSchema;var _commonB4WrK_Ib = require("./common-B4WrK_Ib.js");
require("./sandbox-paths-11MZW8so.js");
var _typeboxBZ5aqCuO = require("./typebox-bZ5aqCuO.js");
...
function resolveReactionMessageId(params) {
  return (0, _commonB4WrK_Ib.h)(params.args, "messageId") ?? params.toolContext?.currentMessageId;
}
//#endregion
...
function createMessageToolButtonsSchema() {
  return _typebox.Type.Optional(_typebox.Type.Array(_typebox.Type.Array(_typebox.Type.Object({
    ...
    style: _typebox.Type.Optional((0, _typeboxBZ5aqCuO.i)([
    "danger",
    "success",
    "primary"]
    ))
