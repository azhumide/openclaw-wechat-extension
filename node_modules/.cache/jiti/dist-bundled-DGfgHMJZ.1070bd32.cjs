...
var _errorsC45PsBV = require("./errors-C45PsBV1.js");
var _openclawRootK_JEjUP = require("./openclaw-root-k_JEjU-p.js");
var _bundledDirJ2GlQTG = require("./bundled-dir-J2GlQTG6.js");
var _subsystemP_0xjnPe = require("./subsystem-P_0xjnPe.js");
var _boundaryFileReadCgZlf7kr = require("./boundary-file-read-cgZlf7kr.js");
var _bundledPluginMetadataDGaMsp9_ = require("./bundled-plugin-metadata-DGaMsp9_.js");
var _jitiLoaderCacheBZjTVQL = require("./jiti-loader-cache-BZjTV-qL.js");
var _bundledRuntimeRootNydfFYq = require("./bundled-runtime-root-NydfFYq1.js");
var _moduleExportBQWx2GE = require("./module-export-BQWx2GE-.js");
var _nodeUrl = require("node:url");
var _nodeFs = _interopRequireDefault(require("node:fs"));
var _nodePath = _interopRequireDefault(require("node:path"));function _interopRequireDefault(e) {return e && e.__esModule ? e : { default: e };}
//#region src/channels/plugins/bundled-root.ts
const OPENCLAW_PACKAGE_ROOT = (0, _openclawRootK_JEjUP.n)({
  argv1: process.argv[1],
  cwd: process.cwd(),
  moduleUrl: "file:///home/rs/openclaw/dist/bundled-DGfgHMJZ.js".startsWith("file:") ? "file:///home/rs/openclaw/dist/bundled-DGfgHMJZ.js" : void 0
}) ?? ("file:///home/rs/openclaw/dist/bundled-DGfgHMJZ.js".startsWith("file:") ? _nodePath.default.resolve((0, _nodeUrl.fileURLToPath)(new URL("../../..", "file:///home/rs/openclaw/dist/bundled-DGfgHMJZ.js"))) : process.cwd());
...
function resolveBundledChannelRootScope(env = process.env) {
  const bundledPluginsDir = (0, _bundledDirJ2GlQTG.t)(env);
...
function listBundledChannelPluginMetadata(params) {
  return (0, _bundledPluginMetadataDGaMsp9_.n)(params);
}
function resolveBundledChannelGeneratedPath(rootDir, entry, pluginDirName, scanDir) {
  return (0, _bundledPluginMetadataDGaMsp9_.r)(rootDir, entry, pluginDirName, scanDir);
}
//#endregion
...
function createModuleLoader() {
  ...
  return (modulePath) => {
    return (0, _jitiLoaderCacheBZjTVQL.t)({
      cache: jitiLoaders,
      modulePath,
      importerUrl: "file:///home/rs/openclaw/dist/bundled-DGfgHMJZ.js",
      argvEntry: process.argv[1],
      preferBuiltDist: true,
      jitiFilename: "file:///home/rs/openclaw/dist/bundled-DGfgHMJZ.js"
    });
  };
}
...
function loadChannelPluginModule(params) {
  ...
  if (params.shouldTryNativeRequire?.(safePath)) {
    const nativeModule = (0, _jitiLoaderCacheBZjTVQL.r)(safePath, { allowWindows: true });
...
const log = (0, _subsystemP_0xjnPe.t)("channels");
function resolveChannelPluginModuleEntry(moduleExport) {
  const resolved = (0, _moduleExportBQWx2GE.t)(moduleExport);
...
function loadGeneratedBundledChannelModule(params) {
  ...
  if (params.installRuntimeDeps !== false && (0, _bundledRuntimeRootNydfFYq.t)(boundaryRoot)) {
    const prepared = (0, _bundledRuntimeRootNydfFYq.n)({
  ...
  return loadChannelPluginModule({
    ...
    shouldTryNativeRequire: (safePath) => safePath.includes(`${_nodePath.default.sep}dist${_nodePath.default.sep}`) && (0, _jitiLoaderCacheBZjTVQL.n)(safePath)
  });
}
function loadGeneratedBundledChannelEntry(params) {
  try {
    ...
    const detail = (0, _errorsC45PsBV.i)(error);
