...
var _setupPromotionHelpersQelxY_ = require("./setup-promotion-helpers-qelxY_31.js");
...
function moveSingleAccountChannelSectionToDefaultAccount(params) {
  ...
  if (Object.keys(accounts).length > 0) {
    const keysToMove = (0, _setupPromotionHelpersQelxY_.t)({
      channelKey: params.channelKey,
      channel: base
    });
    if (keysToMove.length === 0) return params.cfg;
    const resolvedTargetAccountKey = resolveExistingAccountKey(accounts, (0, _setupPromotionHelpersQelxY_.n)({
      channelKey: params.channelKey,
      channel: base
    }));
