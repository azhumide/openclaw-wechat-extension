"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = collectBundledChannelConfigs;exports.i = resolveBundledPluginRepoEntryPath;exports.n = listBundledPluginMetadata;exports.o = normalizeBundledPluginStringList;exports.r = resolveBundledPluginGeneratedPath;exports.s = resolveBundledPluginScanDir;exports.t = findBundledPluginMetadataById;var _stringCoerceC1IzJjqi = require("./string-coerce-C1IzJjqi.js");
...
var _publicSurfaceRuntimeCfEeqjdH = require("./public-surface-runtime-CfEeqjdH.js");
var _sdkAliasIdiztGjr = require("./sdk-alias-idiztGjr.js");
...
function normalizeBundledPluginStringList(value) {
  return (0, _stringNormalizationBvcn03I.l)(value);
}
...
function isTopLevelPublicSurfaceSource(name) {
  if (!_publicSurfaceRuntimeCfEeqjdH.t.includes(_nodePath.default.extname(name))) return false;
...
function deriveBundledPluginIdHint(params) {
  ...
  const packageName = (0, _stringCoerceC1IzJjqi.c)(params.packageName);
...
function collectBundledPluginPublicSurfaceArtifacts(params) {
  const excluded = new Set((0, _stringNormalizationBvcn03I.l)([params.sourceEntry, params.setupEntry]).map((entry) => _nodePath.default.basename(entry)));
...
function resolveConfigSchemaExport(imported) {
  ...
  for (const [name, value] of Object.entries(imported)) {
    ...
    if (value && typeof value === "object") return (0, _configSchemaBEuj464I.r)(value);
  }
...
function getJiti(modulePath) {
  return (0, _jitiLoaderCacheBJKReQBR.t)({
    cache: jitiLoaders,
    modulePath,
    importerUrl: "file:///home/rs/openclaw/dist/bundled-plugin-metadata-etgTUll_.js",
    preferBuiltDist: true,
    jitiFilename: "file:///home/rs/openclaw/dist/bundled-plugin-metadata-etgTUll_.js"
  });
}
function resolveChannelConfigSchemaModulePath(pluginDir) {
  ...
  for (const basename of PUBLIC_CONFIG_SURFACE_BASENAMES) for (const extension of _publicSurfaceRuntimeCfEeqjdH.t) {
...
function collectBundledChannelConfigs(params) {
  ...
  for (const channelId of channelIds) {
    ...
    existingChannelConfigs[channelId] = {
      ...
      ...((0, _stringCoerceC1IzJjqi.c)(existing?.label) ?? (0, _stringCoerceC1IzJjqi.c)(channelMeta?.label) ? { label: (0, _stringCoerceC1IzJjqi.c)(existing?.label) ?? (0, _stringCoerceC1IzJjqi.c)(channelMeta?.label) } : {}),
      ...((0, _stringCoerceC1IzJjqi.c)(existing?.description) ?? (0, _stringCoerceC1IzJjqi.c)(channelMeta?.blurb) ? { description: (0, _stringCoerceC1IzJjqi.c)(existing?.description) ?? (0, _stringCoerceC1IzJjqi.c)(channelMeta?.blurb) } : {}),
...
const OPENCLAW_PACKAGE_ROOT = (0, _sdkAliasIdiztGjr.l)({
  modulePath: (0, _nodeUrl.fileURLToPath)("file:///home/rs/openclaw/dist/bundled-plugin-metadata-etgTUll_.js"),
  moduleUrl: "file:///home/rs/openclaw/dist/bundled-plugin-metadata-etgTUll_.js"
}) ?? (0, _nodeUrl.fileURLToPath)(new URL("../..", "file:///home/rs/openclaw/dist/bundled-plugin-metadata-etgTUll_.js"));
const CURRENT_MODULE_PATH = (0, _nodeUrl.fileURLToPath)("file:///home/rs/openclaw/dist/bundled-plugin-metadata-etgTUll_.js");
  ...
  for (const dirName of _nodeFs.default.readdirSync(resolvedScanDir, { withFileTypes: true }).filter((entry) => entry.isDirectory()).map((entry) => entry.name).toSorted((left, right) => left.localeCompare(right))) {
    ...
    entries.push({
      ...
      idHint: deriveBundledPluginIdHint({
        ...
        packageName: (0, _stringCoerceC1IzJjqi.c)(packageJson?.name),
      ...
      ...((0, _stringCoerceC1IzJjqi.c)(packageJson?.name) ? { packageName: (0, _stringCoerceC1IzJjqi.c)(packageJson?.name) } : {}),
      ...((0, _stringCoerceC1IzJjqi.c)(packageJson?.version) ? { packageVersion: (0, _stringCoerceC1IzJjqi.c)(packageJson?.version) } : {}),
      ...((0, _stringCoerceC1IzJjqi.c)(packageJson?.description) ? { packageDescription: (0, _stringCoerceC1IzJjqi.c)(packageJson?.description) } : {}),
