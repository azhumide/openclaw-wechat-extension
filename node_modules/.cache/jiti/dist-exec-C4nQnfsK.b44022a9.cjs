...
var _windowsCommandCit4MnND = require("./windows-command-Cit4MnND.js");
...
function resolveCommand(command) {
  return (0, _windowsCommandCit4MnND.t)({
    command,
    cmdCommands: [
    "corepack",
    "pnpm",
...
async function runExec(command, args, opts = 1e4) {
  ...
  try {
    ...
    const windowsEncoding = (0, _windowsCommandCit4MnND.o)();
    const decodedStdout = (0, _windowsCommandCit4MnND.a)({
      buffer: stdout,
      windowsEncoding
    });
    const decodedStderr = (0, _windowsCommandCit4MnND.a)({
      buffer: stderr,
      windowsEncoding
    });
    if ((0, _globalsCJu56k.a)()) {
      if (decodedStdout.trim()) (0, _loggerMz_TsqXj.t)(decodedStdout.trim());
      if (decodedStderr.trim()) (0, _loggerMz_TsqXj.n)(decodedStderr.trim());
    }
    return {
    ...
    if (err && typeof err === "object") {
      ...
      if (Buffer.isBuffer(errorWithOutput.stdout)) errorWithOutput.stdout = (0, _windowsCommandCit4MnND.a)({
        buffer: errorWithOutput.stdout,
        windowsEncoding
      });
      if (Buffer.isBuffer(errorWithOutput.stderr)) errorWithOutput.stderr = (0, _windowsCommandCit4MnND.a)({
        buffer: errorWithOutput.stderr,
        windowsEncoding
      });
    }
    if ((0, _globalsCJu56k.a)()) (0, _loggerMz_TsqXj.n)((0, _globalsCJu56k.t)(`Command failed: ${command} ${args.join(" ")}`));
    throw err;
  }
}
...
async function runCommandWithTimeout(argv, optionsOrTimeout) {
  ...
  const stdio = (0, _windowsCommandCit4MnND.n)({
    hasInput,
    preferInherit: true
  });
  ...
  return await new Promise((resolve, reject) => {
    ...
    const resolveFromClose = (code, signal) => {
      ...
      resolve({
        ...
        stdout: (0, _windowsCommandCit4MnND.a)({
          buffer: Buffer.concat(stdoutChunks),
          windowsEncoding
        }),
        stderr: (0, _windowsCommandCit4MnND.a)({
