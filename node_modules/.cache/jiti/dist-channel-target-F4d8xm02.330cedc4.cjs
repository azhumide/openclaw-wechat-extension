...
var _bootstrapRegistryDJ6DpIG = require("./bootstrap-registry-DJ6Dp-iG.js");
...
function listActionTargetAliasSpecs(action, params, channel) {
  ...
  const channelSpec = (0, _bootstrapRegistryDJ6DpIG.t)(normalizedChannel)?.actions?.messageActionTargetAliases?.[action];
