...
var _bundledPluginMetadataDBCPq4zK = require("./bundled-plugin-metadata-DBCPq4zK.js");
var _jitiLoaderCacheDU3ns2lI = require("./jiti-loader-cache-DU3ns2lI.js");
var _bundledRuntimeRootCuaPBWeD = require("./bundled-runtime-root-CuaPBWeD.js");
...
const OPENCLAW_PACKAGE_ROOT = (0, _openclawRootBNWw3cXT.n)({
  ...
  cwd: process.cwd(),
  moduleUrl: "file:///home/rs/openclaw/dist/bundled-Bd4FvHUg.js".startsWith("file:") ? "file:///home/rs/openclaw/dist/bundled-Bd4FvHUg.js" : void 0
}) ?? ("file:///home/rs/openclaw/dist/bundled-Bd4FvHUg.js".startsWith("file:") ? _nodePath.default.resolve((0, _nodeUrl.fileURLToPath)(new URL("../../..", "file:///home/rs/openclaw/dist/bundled-Bd4FvHUg.js"))) : process.cwd());
...
function listBundledChannelPluginMetadata(params) {
  return (0, _bundledPluginMetadataDBCPq4zK.n)(params);
}
function resolveBundledChannelGeneratedPath(rootDir, entry, pluginDirName, scanDir) {
  return (0, _bundledPluginMetadataDBCPq4zK.r)(rootDir, entry, pluginDirName, scanDir);
}
//#endregion
...
function createModuleLoader() {
  ...
  return (modulePath) => {
    return (0, _jitiLoaderCacheDU3ns2lI.t)({
      cache: jitiLoaders,
      modulePath,
      importerUrl: "file:///home/rs/openclaw/dist/bundled-Bd4FvHUg.js",
      argvEntry: process.argv[1],
      preferBuiltDist: true,
      jitiFilename: "file:///home/rs/openclaw/dist/bundled-Bd4FvHUg.js"
    });
  };
}
...
function loadGeneratedBundledChannelModule(params) {
  ...
  if (params.installRuntimeDeps !== false && (0, _bundledRuntimeRootCuaPBWeD.t)(boundaryRoot)) {
    const prepared = (0, _bundledRuntimeRootCuaPBWeD.n)({
