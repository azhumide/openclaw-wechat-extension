"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = normalizeAccountId;exports.r = normalizeOptionalAccountId;exports.t = void 0;var _stringCoerceCjxCKZ6B = require("./string-coerce-CjxCKZ6B.js");
var _prototypeKeysC_bmkCd = require("./prototype-keys-C_bmkCd2.js");
...
function normalizeCanonicalAccountId(value) {
  ...
  if (!canonical || (0, _prototypeKeysC_bmkCd.t)(canonical)) return;
  return canonical;
}
