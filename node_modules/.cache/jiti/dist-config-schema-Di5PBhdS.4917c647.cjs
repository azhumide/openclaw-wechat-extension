"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = emptyChannelConfigSchema;exports.i = buildNestedDmConfigSchema;exports.n = buildCatchallMultiAccountChannelSchema;exports.r = buildChannelConfigSchema;exports.t = void 0;var _zodSchemaCoreDkd4NgDa = require("./zod-schema.core-Dkd4NgDa.js");
...
function buildNestedDmConfigSchema(extraShape) {
  const baseShape = {
    ...
    policy: _zodSchemaCoreDkd4NgDa.o.optional(),
