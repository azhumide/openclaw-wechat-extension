"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.i = listBundledChannelPluginIds;exports.n = getBootstrapChannelSecrets;exports.r = iterateBootstrapChannelPlugins;exports.t = getBootstrapChannelPlugin;var _stringCoerceCjxCKZ6B = require("./string-coerce-CjxCKZ6B.js");
var _channelCatalogRegistryDMFLMPnf = require("./channel-catalog-registry-DMFLMPnf.js");
var _bundledBYRFSTH = require("./bundled-BYR-fSTH.js");
...
function listBundledChannelPluginIdsForRoot(packageRoot, env = process.env) {
  ...
  const loaded = (0, _channelCatalogRegistryDMFLMPnf.t)({
    origin: "bundled",
    env
...
function listBundledChannelPluginIds() {
  return listBundledChannelPluginIdsForRoot((0, _bundledBYRFSTH.g)().cacheKey);
}
//#endregion
...
function resolveBootstrapChannelId(id) {
  return (0, _stringCoerceCjxCKZ6B.c)(id) ?? "";
}
...
function getBootstrapPlugins(cacheKey = (0, _bundledBYRFSTH.g)().cacheKey, env = process.env) {
...
function resolveActiveBootstrapPlugins() {
  return getBootstrapPlugins((0, _bundledBYRFSTH.g)().cacheKey);
}
...
function getBootstrapChannelPlugin(id) {
  ...
  let setupPlugin;
  try {
    runtimePlugin = (0, _bundledBYRFSTH.n)(resolvedId);
    setupPlugin = (0, _bundledBYRFSTH.i)(resolvedId);
  } catch {
...
function getBootstrapChannelSecrets(id) {
  ...
  try {
    const merged = mergePluginSection((0, _bundledBYRFSTH.r)(resolvedId), (0, _bundledBYRFSTH.a)(resolvedId));
