...
function resolveDefaultHomeDir() {
  return (0, _homeDirC44RaPME.o)(process.env, _nodeOs.default.homedir);
}
/** Build a homedir thunk that respects OPENCLAW_HOME for the given env. */
function envHomedir(env) {
  return () => (0, _homeDirC44RaPME.o)(env, _nodeOs.default.homedir);
}
...
function resolveStateDir(env = process.env, homedir = envHomedir(env)) {
  const effectiveHomedir = () => (0, _homeDirC44RaPME.o)(env, homedir);
...
function resolveUserPath(input, env = process.env, homedir = envHomedir(env)) {
  return (0, _homeDirC44RaPME.r)(input, {
    env,
    homedir
  });
}
