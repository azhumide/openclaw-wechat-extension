...
var _windowsCommandBJNUzmuk = require("./windows-command-BJNUzmuk.js");
...
function resolveCommand(command) {
  return (0, _windowsCommandBJNUzmuk.t)({
    command,
    cmdCommands: [
    "corepack",
    "pnpm",
...
async function runExec(command, args, opts = 1e4) {
  ...
  try {
    ...
    const windowsEncoding = (0, _windowsCommandBJNUzmuk.o)();
    const decodedStdout = (0, _windowsCommandBJNUzmuk.a)({
      buffer: stdout,
      windowsEncoding
    });
    const decodedStderr = (0, _windowsCommandBJNUzmuk.a)({
      buffer: stderr,
      windowsEncoding
    });
    if ((0, _globals8N5C2Ov_.a)()) {
      if (decodedStdout.trim()) (0, _loggerDzNKIQlP.t)(decodedStdout.trim());
      if (decodedStderr.trim()) (0, _loggerDzNKIQlP.n)(decodedStderr.trim());
    }
    return {
    ...
    if (err && typeof err === "object") {
      ...
      if (Buffer.isBuffer(errorWithOutput.stdout)) errorWithOutput.stdout = (0, _windowsCommandBJNUzmuk.a)({
        buffer: errorWithOutput.stdout,
        windowsEncoding
      });
      if (Buffer.isBuffer(errorWithOutput.stderr)) errorWithOutput.stderr = (0, _windowsCommandBJNUzmuk.a)({
        buffer: errorWithOutput.stderr,
        windowsEncoding
      });
    }
    if ((0, _globals8N5C2Ov_.a)()) (0, _loggerDzNKIQlP.n)((0, _globals8N5C2Ov_.t)(`Command failed: ${command} ${args.join(" ")}`));
    throw err;
  }
}
...
async function runCommandWithTimeout(argv, optionsOrTimeout) {
  ...
  const stdio = (0, _windowsCommandBJNUzmuk.n)({
    hasInput,
    preferInherit: true
  });
  ...
  return await new Promise((resolve, reject) => {
    ...
    const resolveFromClose = (code, signal) => {
      ...
      resolve({
        ...
        stdout: (0, _windowsCommandBJNUzmuk.a)({
          buffer: Buffer.concat(stdoutChunks),
          windowsEncoding
        }),
        stderr: (0, _windowsCommandBJNUzmuk.a)({
