...
var _bootstrapRegistryNCgrvsYW = require("./bootstrap-registry-NCgrvsYW.js");
...
function listActionTargetAliasSpecs(action, params, channel) {
  ...
  const channelSpec = (0, _bootstrapRegistryNCgrvsYW.t)(normalizedChannel)?.actions?.messageActionTargetAliases?.[action];
