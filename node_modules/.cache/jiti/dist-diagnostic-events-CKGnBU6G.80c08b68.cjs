...
function enrichDiagnosticEvent(state, event) {
  ...
  for (const [key, value] of Object.entries(event)) {
    if ((0, _prototypeKeysRBElZn9Q.t)(key)) continue;
    enriched[key] = value;
  }
