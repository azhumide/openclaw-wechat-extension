"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = readSecretFileSync;exports.i = loadSecretFileSync;exports.n = void 0;exports.o = tryReadSecretFileSync;exports.r = void 0;exports.s = writePrivateSecretFileAtomic;exports.t = void 0;var _utilsDvkbxKCZ = require("./utils-DvkbxKCZ.js");
var _safeOpenSyncBJeT2IXz = require("./safe-open-sync-BJeT2IXz.js");
...
function loadSecretFileSync(filePath, label, options = {}) {
  const resolvedPath = (0, _utilsDvkbxKCZ.p)(filePath.trim());
  ...
  const opened = (0, _safeOpenSyncBJeT2IXz.t)({
