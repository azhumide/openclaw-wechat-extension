...
var _zodParseDQ4iaJeH = require("./zod-parse-DQ4iaJeH.js");
...
function parsePossiblyNoisyStatus(raw) {
  ...
  return (0, _zodParseDQ4iaJeH.t)(TailscaleStatusSchema, raw.slice(start, end + 1));
}
