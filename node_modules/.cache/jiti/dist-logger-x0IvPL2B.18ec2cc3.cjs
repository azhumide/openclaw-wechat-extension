"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.A = getPositiveIntFlagValue;exports.B = isValueToken;exports.C = isYes;exports.D = getCommandPathWithRootOptions;exports.E = buildParseArgv;exports.F = hasRootVersionAlias;exports.H = isNodeRuntime;exports.I = isRootHelpInvocation;exports.L = isRootVersionInvocation;exports.M = getVerboseFlag;exports.N = hasFlag;exports.O = getCommandPositionalsWithRootOptions;exports.P = hasHelpOrVersion;exports.R = shouldMigrateStateFromPath;exports.S = isVerbose;exports.T = setYes;exports.V = isBunRuntime;exports._ = levelToMinLevel;exports.a = getLogger;exports.b = readLoggingConfig;exports.c = resetLogger;exports.d = formatLocalIsoWithOffset;exports.f = formatTimestamp;exports.h = exports.g = void 0;exports.i = getChildLogger;exports.j = getPrimaryCommand;exports.k = getFlagValue;exports.l = setLoggerOverride;exports.m = resolveEnvLogLevelOverride;exports.n = void 0;exports.o = getResolvedLoggerSettings;exports.p = isValidTimeZone;exports.r = void 0;exports.s = isFileLogLevelEnabled;exports.t = void 0;exports.u = toPinoLikeLogger;exports.v = normalizeLogLevel;exports.w = setVerbose;exports.x = shouldSkipMutatingLoggingConfigRead;exports.y = tryParseLogLevel;exports.z = consumeRootOptionToken;var _redactBl2deF7j = require("./redact-Bl2deF7j.js");
var _stringCoerceC1IzJjqi = require("./string-coerce-C1IzJjqi.js");
var _diagnosticEventsCz86_awm = require("./diagnostic-events-Cz86_awm.js");
var _diagnosticTraceContextD6vXBN = require("./diagnostic-trace-context-D6vXBN1-.js");
var _prototypeKeysCL1MnaY = require("./prototype-keys-CL1-mnaY.js");
var _tmpOpenclawDirCoGSA7K = require("./tmp-openclaw-dir-CoGSA-7K.js");
...
function normalizeRuntimeBasename(execPath) {
  ...
  return (0, _stringCoerceC1IzJjqi.a)(lastSlash === -1 ? trimmed : trimmed.slice(lastSlash + 1));
}
...
const requireConfig$1 = (0, _redactBl2deF7j.o)("file:///home/rs/openclaw/dist/logger-x0IvPL2B.js");
...
function resolveEnvLogLevelOverride() {
  const trimmed = (0, _stringCoerceC1IzJjqi.c)(process.env.OPENCLAW_LOG_LEVEL) ?? "";
  if (!trimmed) {
...
function resolveDefaultLogDir() {
  return canUseNodeFs() ? (0, _tmpOpenclawDirCoGSA7K.n)() : _tmpOpenclawDirCoGSA7K.t;
}
function resolveDefaultLogFile(defaultLogDir) {
  return canUseNodeFs() ? _nodePath.default.join(defaultLogDir, "openclaw.log") : `${_tmpOpenclawDirCoGSA7K.t}/openclaw.log`;
}
...
const requireConfig = (0, _redactBl2deF7j.o)("file:///home/rs/openclaw/dist/logger-x0IvPL2B.js");
...
function sanitizeDiagnosticLogText(value, maxChars) {
  return clampDiagnosticLogText((0, _redactBl2deF7j.r)(clampDiagnosticLogText(value, maxChars)), maxChars);
}
...
function assignDiagnosticLogAttribute(attributes, state, key, value) {
  ...
  if ((0, _prototypeKeysCL1MnaY.t)(normalizedKey)) return;
  if ((0, _redactBl2deF7j.r)(normalizedKey) !== normalizedKey) return;
...
function normalizeTraceContext(value) {
  ...
  if (!(0, _diagnosticTraceContextD6vXBN.s)(candidate.traceId)) return;
  if (candidate.spanId !== void 0 && !(0, _diagnosticTraceContextD6vXBN.a)(candidate.spanId)) return;
  if (candidate.parentSpanId !== void 0 && !(0, _diagnosticTraceContextD6vXBN.a)(candidate.parentSpanId)) return;
  if (candidate.traceFlags !== void 0 && !(0, _diagnosticTraceContextD6vXBN.o)(candidate.traceFlags)) return;
  return {
...
function attachDiagnosticEventTransport(logger) {
  logger.attachTransport((logObj) => {
    try {
      (0, _diagnosticEventsCz86_awm.n)(buildDiagnosticLogRecord(logObj));
    } catch {}
  });
}
...
const __test__ = exports.r = { shouldSkipMutatingLoggingConfigRead };
