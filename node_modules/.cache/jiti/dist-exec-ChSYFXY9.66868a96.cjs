...
var _openclawExecEnvCvj4Mspx = require("./openclaw-exec-env-Cvj4Mspx.js");
var _globalsDCctf2Pw = require("./globals-DCctf2Pw.js");
var _loggerC7FmQ1yA = require("./logger-C7FmQ1yA.js");
var _windowsCommandCT9mLjtw = require("./windows-command-CT9mLjtw.js");
...
function resolveCommand(command) {
  return (0, _windowsCommandCT9mLjtw.t)({
    command,
    cmdCommands: [
    "corepack",
    "pnpm",
...
async function runExec(command, args, opts = 1e4) {
  ...
  try {
    ...
    if ((0, _globalsDCctf2Pw.a)()) {
      if (stdout.trim()) (0, _loggerC7FmQ1yA.t)(stdout.trim());
      if (stderr.trim()) (0, _loggerC7FmQ1yA.n)(stderr.trim());
    }
    return {
      stdout,
      stderr
    ...
    if ((0, _globalsDCctf2Pw.a)()) (0, _loggerC7FmQ1yA.n)((0, _globalsDCctf2Pw.t)(`Command failed: ${command} ${args.join(" ")}`));
    throw err;
  }
}
...
function resolveCommandEnv(params) {
  ...
  return (0, _openclawExecEnvCvj4Mspx.n)(resolvedEnv);
}
async function runCommandWithTimeout(argv, optionsOrTimeout) {
  ...
  const stdio = (0, _windowsCommandCT9mLjtw.n)({
    hasInput,
    preferInherit: true
  });
