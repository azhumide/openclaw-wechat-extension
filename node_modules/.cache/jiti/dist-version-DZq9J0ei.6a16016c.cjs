"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = resolveBinaryVersion;exports.c = resolveUsableRuntimeVersion;exports.i = readVersionFromPackageJsonForModuleUrl;exports.l = resolveVersionFromModuleUrl;exports.n = void 0;exports.o = resolveCompatibilityHostVersion;exports.r = readVersionFromBuildInfoForModuleUrl;exports.s = resolveRuntimeServiceVersion;exports.t = void 0;var _stringCoerceC1IzJjqi = require("./string-coerce-C1IzJjqi.js");
...
function readVersionFromJsonCandidates(moduleUrl, candidates, opts = {}) {
  try {
    ...
    for (const candidate of candidates) try {
      ...
      const version = (0, _stringCoerceC1IzJjqi.c)(parsed.version);
      if (!version) continue;
...
function resolveUsableRuntimeVersion(version) {
  const trimmed = (0, _stringCoerceC1IzJjqi.c)(version);
