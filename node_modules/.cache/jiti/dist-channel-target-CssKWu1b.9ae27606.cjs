"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = actionHasTarget;exports.n = exports.i = void 0;exports.o = actionRequiresTarget;exports.r = applyTargetToParams;exports.s = hasPotentialPluginActionParam;exports.t = void 0;var _stringCoerceC1IzJjqi = require("./string-coerce-C1IzJjqi.js");
var _bootstrapRegistryB5CzXl3O = require("./bootstrap-registry-b5CzXl3O.js");
...
function hasPotentialPluginActionParam(params) {
  return Object.entries(params).some(([key, value]) => {
    ...
    if (typeof value === "string") return Boolean((0, _stringCoerceC1IzJjqi.c)(value));
...
function listActionTargetAliasSpecs(action, params, channel) {
  ...
  const normalizedChannel = (0, _stringCoerceC1IzJjqi.s)(channel);
  if (!normalizedChannel || !hasPotentialPluginActionParam(params)) return specs;
  const channelSpec = (0, _bootstrapRegistryB5CzXl3O.t)(normalizedChannel)?.actions?.messageActionTargetAliases?.[action];
...
function actionHasTarget(action, params, options) {
  if ((0, _stringCoerceC1IzJjqi.c)(params.to) ?? "") return true;
  if ((0, _stringCoerceC1IzJjqi.c)(params.channelId) ?? "") return true;
...
const hasNonEmptyString = exports.i = _stringCoerceC1IzJjqi.t;
const CHANNEL_TARGET_DESCRIPTION = exports.n = "Recipient/channel: E.164 for WhatsApp/Signal, Telegram chat id/@username, Discord/Slack channel/user, or iMessage handle/chat_id";
...
function applyTargetToParams(params) {
  const target = (0, _stringCoerceC1IzJjqi.c)(params.args.target) ?? "";
