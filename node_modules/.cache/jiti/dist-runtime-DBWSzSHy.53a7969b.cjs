...
const state = (() => {
  ...
  let registryState = globalState[_runtimeStateZ0a_K0Je.t];
  if (!registryState) {
    registryState = {
      activeRegistry: null,
      activeVersion: 0,
    ...
    globalState[_runtimeStateZ0a_K0Je.t] = registryState;
  }
