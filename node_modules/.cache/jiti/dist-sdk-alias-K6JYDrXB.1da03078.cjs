"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = listPluginSdkAliasCandidates;exports.c = resolveExtensionApiAlias;exports.d = resolvePluginLoaderJitiTryNative;exports.f = resolvePluginRuntimeModulePath;exports.g = shouldPreferNativeJiti;exports.h = resolvePluginSdkScopedAliasMap;exports.i = isBundledPluginExtensionPath;exports.l = resolveLoaderPackageRoot;exports.m = resolvePluginSdkAliasFile;exports.n = buildPluginLoaderJitiOptions;exports.o = listPluginSdkExportedSubpaths;exports.p = resolvePluginSdkAliasCandidateOrder;exports.r = createPluginLoaderJitiCacheKey;exports.s = normalizeJitiAliasTargetPath;exports.t = buildPluginLoaderAliasMap;exports.u = resolvePluginLoaderJitiConfig;var _stringCoerceC1IzJjqi = require("./string-coerce-C1IzJjqi.js");
...
function resolveLoaderModulePath(params = {}) {
  return params.modulePath ?? (0, _nodeUrl.fileURLToPath)(params.moduleUrl ?? "file:///home/rs/openclaw/dist/sdk-alias-K6JYDrXB.js");
}
...
function hasTrustedOpenClawRootIndicator(params) {
  ...
  const hasOpenClawBin = typeof params.packageJson.bin === "string" && (0, _stringCoerceC1IzJjqi.a)(params.packageJson.bin).includes("openclaw") || typeof params.packageJson.bin === "object" && params.packageJson.bin !== null && typeof params.packageJson.bin.openclaw === "string";
...
function resolveLoaderPackageRoot(params) {
  ...
  const moduleUrl = params.moduleUrl ?? (params.modulePath ? void 0 : "file:///home/rs/openclaw/dist/sdk-alias-K6JYDrXB.js");
...
function isUsableDistPluginSdkArtifact(candidate) {
  ...
  switch ((0, _stringCoerceC1IzJjqi.a)(_nodePath.default.extname(candidate))) {
    case ".js":
    case ".mjs":
    case ".cjs":break;
    default:return true;
...
function listPluginSdkExportedSubpaths(params = {}) {
  const packageRoot = resolveLoaderPluginSdkPackageRoot({
    modulePath: params.modulePath ?? (0, _nodeUrl.fileURLToPath)("file:///home/rs/openclaw/dist/sdk-alias-K6JYDrXB.js"),
    argv1: params.argv1,
    moduleUrl: params.moduleUrl
  });
...
function resolvePluginSdkScopedAliasMap(params = {}) {
  const modulePath = params.modulePath ?? (0, _nodeUrl.fileURLToPath)("file:///home/rs/openclaw/dist/sdk-alias-K6JYDrXB.js");
  const packageRoot = resolveLoaderPluginSdkPackageRoot({
    modulePath,
    argv1: params.argv1,
    moduleUrl: params.moduleUrl
...
function shouldPreferNativeJiti(modulePath) {
  ...
  switch ((0, _stringCoerceC1IzJjqi.a)(_nodePath.default.extname(modulePath))) {
    case ".js":
    case ".mjs":
    case ".cjs":
