"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = resolveGlobalDedupeCache;exports.t = createDedupeCache;var _globalSingletonCqneY5Pr = require("./global-singleton-CqneY5Pr.js");
var _mapSizeDf8xy7PG = require("./map-size-Df8xy7PG.js");
...
function createDedupeCache(options) {
  ...
  const prune = (now) => {
    ...
    (0, _mapSizeDf8xy7PG.t)(cache, maxSize);
  };
...
function resolveGlobalDedupeCache(key, options) {
  return (0, _globalSingletonCqneY5Pr.n)(key, () => createDedupeCache(options));
}
//#endregion /* v9-b869b1941084cf11 */
