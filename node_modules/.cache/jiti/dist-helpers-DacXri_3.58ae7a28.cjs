...
function buildAccountScopedDmSecurityPolicy(params) {
  ...
  const defaultBasePath = `channels.${params.channelKey}.accounts.${_accountIdDhSD7lhD.t}.`;
  const accountConfig = channelConfig?.accounts?.[resolvedAccountId];
  const defaultAccountConfig = params.inheritSharedDefaultsFromDefaultAccount && resolvedAccountId !== "default" ? channelConfig?.accounts?.[_accountIdDhSD7lhD.t] : void 0;
