"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = collectBundledChannelConfigs;exports.i = resolveBundledPluginRepoEntryPath;exports.n = listBundledPluginMetadata;exports.o = normalizeBundledPluginStringList;exports.r = resolveBundledPluginGeneratedPath;exports.s = resolveBundledPluginScanDir;exports.t = findBundledPluginMetadataById;var _stringCoerceBje8XVt = require("./string-coerce-Bje8XVt9.js");
...
var _publicSurfaceRuntimeBcu38yhg = require("./public-surface-runtime-Bcu38yhg.js");
var _jitiLoaderCacheBZjTVQL = require("./jiti-loader-cache-BZjTV-qL.js");
var _sdkAliasDC8_q6CF = require("./sdk-alias-DC8_q6CF.js");
...
function normalizeBundledPluginStringList(value) {
  return (0, _stringNormalizationDEQ0pIpk.l)(value);
}
...
function isTopLevelPublicSurfaceSource(name) {
  if (!_publicSurfaceRuntimeBcu38yhg.t.includes(_nodePath.default.extname(name))) return false;
...
function collectBundledPluginPublicSurfaceArtifacts(params) {
  const excluded = new Set((0, _stringNormalizationDEQ0pIpk.l)([params.sourceEntry, params.setupEntry]).map((entry) => _nodePath.default.basename(entry)));
...
function resolveConfigSchemaExport(imported) {
  ...
  for (const [name, value] of Object.entries(imported)) {
    ...
    if (value && typeof value === "object") return (0, _configSchemaD4PhJFTs.r)(value);
  }
...
function getJiti(modulePath) {
  return (0, _jitiLoaderCacheBZjTVQL.t)({
    cache: jitiLoaders,
    modulePath,
    importerUrl: "file:///home/rs/openclaw/dist/bundled-plugin-metadata-DGaMsp9_.js",
    preferBuiltDist: true,
    jitiFilename: "file:///home/rs/openclaw/dist/bundled-plugin-metadata-DGaMsp9_.js"
  });
}
function resolveChannelConfigSchemaModulePath(pluginDir) {
  ...
  for (const basename of PUBLIC_CONFIG_SURFACE_BASENAMES) for (const extension of _publicSurfaceRuntimeBcu38yhg.t) {
...
const OPENCLAW_PACKAGE_ROOT = (0, _sdkAliasDC8_q6CF.l)({
  modulePath: (0, _nodeUrl.fileURLToPath)("file:///home/rs/openclaw/dist/bundled-plugin-metadata-DGaMsp9_.js"),
  moduleUrl: "file:///home/rs/openclaw/dist/bundled-plugin-metadata-DGaMsp9_.js"
}) ?? (0, _nodeUrl.fileURLToPath)(new URL("../..", "file:///home/rs/openclaw/dist/bundled-plugin-metadata-DGaMsp9_.js"));
const CURRENT_MODULE_PATH = (0, _nodeUrl.fileURLToPath)("file:///home/rs/openclaw/dist/bundled-plugin-metadata-DGaMsp9_.js");
...
function collectBundledPluginMetadata(packageRoot, includeChannelConfigs, includeSyntheticChannelConfigs, scanDir) {
  ...
  for (const dirName of _nodeFs.default.readdirSync(resolvedScanDir, { withFileTypes: true }).filter((entry) => entry.isDirectory()).map((entry) => entry.name).toSorted((left, right) => left.localeCompare(right))) {
    ...
    const manifestResult = (0, _manifestC0Wa8IEc.i)(pluginDir, false);
    if (!manifestResult.ok) continue;
    const packageJson = readPackageManifest(pluginDir);
    const packageManifest = (0, _manifestC0Wa8IEc.r)(packageJson);
