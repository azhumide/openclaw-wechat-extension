"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = listPluginSdkAliasCandidates;exports.c = resolveExtensionApiAlias;exports.d = resolvePluginLoaderJitiTryNative;exports.f = resolvePluginRuntimeModulePath;exports.g = shouldPreferNativeJiti;exports.h = resolvePluginSdkScopedAliasMap;exports.i = isBundledPluginExtensionPath;exports.l = resolveLoaderPackageRoot;exports.m = resolvePluginSdkAliasFile;exports.n = buildPluginLoaderJitiOptions;exports.o = listPluginSdkExportedSubpaths;exports.p = resolvePluginSdkAliasCandidateOrder;exports.r = createPluginLoaderJitiCacheKey;exports.s = normalizeJitiAliasTargetPath;exports.t = buildPluginLoaderAliasMap;exports.u = resolvePluginLoaderJitiConfig;var _stringCoerceCjxCKZ6B = require("./string-coerce-CjxCKZ6B.js");
...
function resolveLoaderModulePath(params = {}) {
  return params.modulePath ?? (0, _nodeUrl.fileURLToPath)(params.moduleUrl ?? "file:///home/rs/openclaw/dist/sdk-alias-Dij9SbK3.js");
}
...
function hasTrustedOpenClawRootIndicator(params) {
  ...
  const hasOpenClawBin = typeof params.packageJson.bin === "string" && (0, _stringCoerceCjxCKZ6B.a)(params.packageJson.bin).includes("openclaw") || typeof params.packageJson.bin === "object" && params.packageJson.bin !== null && typeof params.packageJson.bin.openclaw === "string";
...
function resolveTrustedOpenClawRootFromArgvHint(params) {
  ...
  const packageRoot = (0, _openclawRootGhlHRwjz.n)({
    cwd: params.cwd,
    argv1: params.argv1
  });
...
function resolveLoaderPackageRoot(params) {
  ...
  const fromModulePath = (0, _openclawRootGhlHRwjz.n)({ cwd });
  if (fromModulePath) return fromModulePath;
  const argv1 = params.argv1 ?? process.argv[1];
  const moduleUrl = params.moduleUrl ?? (params.modulePath ? void 0 : "file:///home/rs/openclaw/dist/sdk-alias-Dij9SbK3.js");
  return (0, _openclawRootGhlHRwjz.n)({
    cwd,
    ...(argv1 ? { argv1 } : {}),
    ...(moduleUrl ? { moduleUrl } : {})
  });
...
function resolveLoaderPluginSdkPackageRoot(params) {
  const cwd = params.cwd ?? _nodePath.default.dirname(params.modulePath);
  const fromCwd = (0, _openclawRootGhlHRwjz.n)({ cwd });
  const fromExplicitHints = resolveTrustedOpenClawRootFromArgvHint({
    cwd,
    argv1: params.argv1
  }) ?? (params.moduleUrl ? (0, _openclawRootGhlHRwjz.n)({
    cwd,
...
function isUsableDistPluginSdkArtifact(candidate) {
  ...
  switch ((0, _stringCoerceCjxCKZ6B.a)(_nodePath.default.extname(candidate))) {
    case ".js":
    case ".mjs":
    case ".cjs":break;
    default:return true;
...
function listPluginSdkExportedSubpaths(params = {}) {
  const packageRoot = resolveLoaderPluginSdkPackageRoot({
    modulePath: params.modulePath ?? (0, _nodeUrl.fileURLToPath)("file:///home/rs/openclaw/dist/sdk-alias-Dij9SbK3.js"),
    argv1: params.argv1,
    moduleUrl: params.moduleUrl
  });
...
function resolvePluginSdkScopedAliasMap(params = {}) {
  const modulePath = params.modulePath ?? (0, _nodeUrl.fileURLToPath)("file:///home/rs/openclaw/dist/sdk-alias-Dij9SbK3.js");
  const packageRoot = resolveLoaderPluginSdkPackageRoot({
    modulePath,
    argv1: params.argv1,
    moduleUrl: params.moduleUrl
...
function shouldPreferNativeJiti(modulePath) {
  ...
  switch ((0, _stringCoerceCjxCKZ6B.a)(_nodePath.default.extname(modulePath))) {
    case ".js":
    case ".mjs":
    case ".cjs":
