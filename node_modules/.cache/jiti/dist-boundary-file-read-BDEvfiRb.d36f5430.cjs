"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.i = openBoundaryFileSync;exports.n = matchBoundaryFileOpenFailure;exports.r = openBoundaryFile;exports.t = canUseBoundaryFileOpen;var _boundaryPathC2iMx2xR = require("./boundary-path-C2iMx2xR.js");
...
function openBoundaryFileSync(params) {
  ...
  const resolved = resolveBoundaryFilePathGeneric({
    ...
    resolve: (absolutePath) => (0, _boundaryPathC2iMx2xR.r)({
      absolutePath,
...
async function openBoundaryFile(params) {
  ...
  const maybeResolved = resolveBoundaryFilePathGeneric({
    absolutePath: params.absolutePath,
    resolve: (absolutePath) => (0, _boundaryPathC2iMx2xR.n)({
      absolutePath,
      rootPath: params.rootPath,
      rootCanonicalPath: params.rootRealPath,
      boundaryLabel: params.boundaryLabel,
