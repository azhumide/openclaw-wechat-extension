"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = resolveGatewayBindUrl;exports.t = resolveTailnetHostWithRunner;var _stringCoerceBje8XVt = require("./string-coerce-Bje8XVt9.js");
var _zodParseBzTcxszB = require("./zod-parse-BzTcxszB.js");
var _zod = require("zod");
//#region src/shared/gateway-bind-url.ts
function resolveGatewayBindUrl(params) {
  const bind = params.bind ?? "loopback";
  if (bind === "custom") {
    const host = (0, _stringCoerceBje8XVt.c)(params.customBindHost);
    if (host) return {
...
function parsePossiblyNoisyStatus(raw) {
  ...
  return (0, _zodParseBzTcxszB.t)(TailscaleStatusSchema, raw.slice(start, end + 1));
}
