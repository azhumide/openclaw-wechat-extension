"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports._ = parseDiagnosticTraceparent;exports.a = onDiagnosticEvent;exports.c = createChildDiagnosticTraceContext;exports.d = formatDiagnosticTraceparent;exports.f = freezeDiagnosticTraceContext;exports.g = isValidDiagnosticTraceId;exports.h = isValidDiagnosticTraceFlags;exports.i = isDiagnosticsEnabled;exports.l = createDiagnosticTraceContext;exports.m = isValidDiagnosticSpanId;exports.n = emitDiagnosticEvent;exports.o = onInternalDiagnosticEvent;exports.p = getActiveDiagnosticTraceContext;exports.r = emitTrustedDiagnosticEvent;exports.s = setDiagnosticsEnabledForProcess;exports.t = areDiagnosticsEnabledForProcess;exports.u = createDiagnosticTraceContextFromActiveScope;exports.v = runWithDiagnosticTraceContext;var _prototypeKeysDneRHviA = require("./prototype-keys-DneRHviA.js");
...
function enrichDiagnosticEvent(state, event) {
  ...
  for (const [key, value] of Object.entries(event)) {
    if ((0, _prototypeKeysDneRHviA.t)(key)) continue;
    enriched[key] = value;
  }
