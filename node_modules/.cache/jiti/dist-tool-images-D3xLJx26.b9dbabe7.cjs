"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.i = resolveImageSanitizationLimits;exports.n = sanitizeImageBlocks;exports.r = sanitizeToolResultImages;exports.t = sanitizeContentBlocksImages;var _subsystemBmJ5rL4Q = require("./subsystem-bmJ5rL4Q.js");
var _base64Jn7E7URN = require("./base64-jn7E7URN.js");
var _imageOpsBnniXEYc = require("./image-ops-BnniXEYc.js");
...
const log = (0, _subsystemBmJ5rL4Q.t)("agents/tool-images");
...
async function resizeImageBase64IfNeeded(params) {
  ...
  const meta = await (0, _imageOpsBnniXEYc.a)(buf);
  ...
  const sideGrid = (0, _imageOpsBnniXEYc.r)(params.maxDimensionPx, sideStart);
  let smallest = null;
  for (const side of sideGrid) for (const quality of _imageOpsBnniXEYc.t) {
    const out = await (0, _imageOpsBnniXEYc.l)({
      buffer: buf,
      maxSide: side,
      quality,
...
async function sanitizeContentBlocksImages(blocks, label, opts = {}) {
  ...
  for (const block of blocks) {
    ...
    const canonicalData = (0, _base64Jn7E7URN.t)(data);
    if (!canonicalData) {
      out.push({
        type: "text",
