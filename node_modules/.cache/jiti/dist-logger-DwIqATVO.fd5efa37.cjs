...
function sanitizeDiagnosticLogText(value, maxChars) {
  return clampDiagnosticLogText((0, _redactDGGawMpx.r)(clampDiagnosticLogText(value, maxChars)), maxChars);
}
...
function assignDiagnosticLogAttribute(attributes, state, key, value) {
  ...
  if ((0, _redactDGGawMpx.r)(normalizedKey) !== normalizedKey) return;
...
function resolveSettings() {
  ...
  const cfg = loggingState.overrideSettings ?? (0, _redactDGGawMpx.o)();
...
function buildLogger(settings) {
  ...
  logger.attachTransport((logObj) => {
    try {
      ...
      const payload = `${(0, _redactDGGawMpx.r)(JSON.stringify({
        ...logObj,
        time
      }))}\n`;
...
const __test__ = exports.r = { shouldSkipMutatingLoggingConfigRead: _redactDGGawMpx.s };
