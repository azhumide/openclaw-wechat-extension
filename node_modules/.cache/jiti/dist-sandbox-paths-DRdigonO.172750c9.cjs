"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = resolveSandboxPath;exports.i = resolveSandboxInputPath;exports.n = assertSandboxPath;exports.o = resolveSandboxedMediaSource;exports.r = resolveAllowedManagedMediaPath;exports.t = assertMediaNotDataUrl;var _utilsBYAfe1GS = require("./utils-BYAfe1GS.js");
var _tmpOpenclawDirCHnChpj = require("./tmp-openclaw-dir-CHnChpj-.js");
var _boundaryPathBUtehO_x = require("./boundary-path-BUtehO_x.js");
var _archivePathCGedFy4L = require("./archive-path-CGedFy4L.js");
var _pathAliasGuardsCjHK6ieK = require("./path-alias-guards-CjHK6ieK.js");
var _localFileAccessCXcqzY8v = require("./local-file-access-CXcqzY8v.js");
var _mediaSourceUrlDY_PNRA = require("./media-source-url-DY_PNRA6.js");
...
function hostPathLooksAbsolute(expanded) {
  return _nodePath.default.isAbsolute(expanded) || (0, _archivePathCGedFy4L.t)(expanded);
}
function resolveToCwd(filePath, cwd) {
  const expanded = expandPath(filePath);
  if ((0, _archivePathCGedFy4L.t)(expanded)) return _nodePath.default.win32.normalize(expanded);
...
function resolveSandboxPath(params) {
  ...
  if (relative.startsWith("..") || _nodePath.default.isAbsolute(relative) || (0, _archivePathCGedFy4L.t)(relative)) throw new Error(`Path escapes sandbox root (${shortPath(rootResolved)}): ${params.filePath}`);
  return {
    resolved,
    relative
  };
...
async function assertSandboxPath(params) {
  ...
  await (0, _pathAliasGuardsCjHK6ieK.n)({
...
function isManagedMediaPathUnderRoot(candidate) {
  ...
  const mediaRoot = _nodePath.default.join((0, _utilsBYAfe1GS.d)(), "media");
...
async function resolveAllowedManagedMediaPath(candidate) {
  ...
  await assertNoManagedMediaAliasEscape({
    filePath: resolved,
    managedMediaRoot: _nodePath.default.resolve((0, _utilsBYAfe1GS.d)(), "media")
  });
  return resolved;
}
async function resolveSandboxedMediaSource(params) {
  ...
  if (!raw) return raw;
  if ((0, _mediaSourceUrlDY_PNRA.t)(raw)) return raw;
  let candidate = raw;
  if (/^file:\/\//i.test(candidate)) {
    ...
    try {
      candidate = (0, _localFileAccessCXcqzY8v.a)(candidate);
    } catch (err) {
  ...
  (0, _localFileAccessCXcqzY8v.t)(candidate, "Sandbox media path");
...
function mapContainerWorkspaceFileUrl(params) {
  ...
  if ((0, _localFileAccessCXcqzY8v.r)(parsed.pathname)) return;
...
async function resolveAllowedTmpMediaPath(params) {
  ...
  const openClawTmpDir = _nodePath.default.resolve((0, _tmpOpenclawDirCHnChpj.n)());
  if (!(0, _boundaryPathBUtehO_x.s)(openClawTmpDir, resolved)) return;
