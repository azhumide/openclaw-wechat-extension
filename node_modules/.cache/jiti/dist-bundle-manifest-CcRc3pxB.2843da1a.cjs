"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = loadBundleManifest;exports.c = formatPosixMode;exports.d = safeStatSync;exports.i = detectBundleManifestFormat;exports.l = isPathInside;exports.n = void 0;exports.o = mergeBundlePathLists;exports.r = void 0;exports.s = normalizeBundlePathList;exports.t = void 0;exports.u = safeRealpathSync;var _stringCoerceBje8XVt = require("./string-coerce-Bje8XVt9.js");
...
function isPathInside(baseDir, targetPath) {
  return (0, _boundaryPathBphsbLa.s)(baseDir, targetPath);
}
...
function detectBundleManifestFormat(rootDir) {
  ...
  if (_manifestGzgxnRAf.t.some((candidate) => _nodeFs.default.existsSync(_nodePath.default.join(rootDir, candidate)))) return null;
  if ([
