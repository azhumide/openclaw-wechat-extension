"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.i = resolveImageSanitizationLimits;exports.n = sanitizeImageBlocks;exports.r = sanitizeToolResultImages;exports.t = sanitizeContentBlocksImages;var _subsystemIzrDYZz = require("./subsystem-Izr-DYZz.js");
var _base64DNkM2oGu = require("./base64-DNkM2oGu.js");
var _imageOpsIhzyaQjL = require("./image-ops-IhzyaQjL.js");
...
const log = (0, _subsystemIzrDYZz.t)("agents/tool-images");
...
async function resizeImageBase64IfNeeded(params) {
  ...
  const meta = await (0, _imageOpsIhzyaQjL.a)(buf);
  ...
  const sideGrid = (0, _imageOpsIhzyaQjL.r)(params.maxDimensionPx, sideStart);
  let smallest = null;
  for (const side of sideGrid) for (const quality of _imageOpsIhzyaQjL.t) {
    const out = await (0, _imageOpsIhzyaQjL.l)({
      buffer: buf,
      maxSide: side,
      quality,
...
async function sanitizeContentBlocksImages(blocks, label, opts = {}) {
  ...
  for (const block of blocks) {
    ...
    const canonicalData = (0, _base64DNkM2oGu.t)(data);
    if (!canonicalData) {
      out.push({
        type: "text",
