"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.i = openBoundaryFileSync;exports.n = matchBoundaryFileOpenFailure;exports.r = openBoundaryFile;exports.t = canUseBoundaryFileOpen;var _boundaryPath6aPPz8oV = require("./boundary-path-6aPPz8oV.js");
...
function openBoundaryFileSync(params) {
  ...
  const resolved = resolveBoundaryFilePathGeneric({
    ...
    resolve: (absolutePath) => (0, _boundaryPath6aPPz8oV.r)({
      absolutePath,
...
async function openBoundaryFile(params) {
  ...
  const maybeResolved = resolveBoundaryFilePathGeneric({
    absolutePath: params.absolutePath,
    resolve: (absolutePath) => (0, _boundaryPath6aPPz8oV.n)({
      absolutePath,
      rootPath: params.rootPath,
      rootCanonicalPath: params.rootRealPath,
      boundaryLabel: params.boundaryLabel,
