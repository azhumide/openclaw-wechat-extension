...
var _zodParseAfMoZn6k = require("./zod-parse-AfMoZn6k.js");
...
function parsePossiblyNoisyStatus(raw) {
  ...
  return (0, _zodParseAfMoZn6k.t)(TailscaleStatusSchema, raw.slice(start, end + 1));
}
