"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports._ = fileSignatureMatches;exports.a = refreshPersistedInstalledPluginIndexSync;exports.c = getCurrentPluginMetadataSnapshotState;exports.d = isInstalledPluginEnabled;exports.f = loadInstalledPluginIndex;exports.g = resolveInstalledPluginIndexPolicyHash;exports.h = extractPluginInstallRecordsFromInstalledPluginIndex;exports.i = refreshPersistedInstalledPluginIndex;exports.l = setCurrentPluginMetadataSnapshotState;exports.m = hasOptionalMissingPluginManifestFile;exports.n = readPersistedInstalledPluginIndex;exports.o = writePersistedInstalledPluginIndex;exports.p = collectPluginManifestCompatCodes;exports.r = readPersistedInstalledPluginIndexSync;exports.s = clearCurrentPluginMetadataSnapshotState;exports.t = inspectPersistedInstalledPluginIndex;exports.u = getInstalledPluginRecord;exports.v = hashJson;var _versionEw9InAD = require("./version-Ew9InAD4.js");
var _prototypeKeysRBElZn9Q = require("./prototype-keys-RBElZn9Q.js");
var _discoveryB19Xdk1_ = require("./discovery-B19Xdk1_.js");
var _slotsBSAZAn7a = require("./slots-BSAZAn7a.js");
var _configState6n1ivR = require("./config-state-6n1ivR82.js");
var _installSourceInfoDkiXB1v = require("./install-source-info-DkiXB1v4.js");
var _jsonFilesBvzDldMA = require("./json-files-BvzDldMA.js");
var _manifestRegistryC9Iavh = require("./manifest-registry-C9Iavh95.js");
var _jsonFileDFvVnXBR = require("./json-file-DFvVnXBR.js");
var _zodParseCnyYByY = require("./zod-parse-CnyYByY3.js");
...
function resolveInstalledPluginIndexPolicyHash(config) {
  const normalized = (0, _configState6n1ivR.o)(config?.plugins);
  const channelPolicy = {};
...
function buildStartupInfo(record) {
  return {
    ...
    memory: (0, _slotsBSAZAn7a.r)(record.kind, "memory"),
...
function resolvePackageJsonPath(candidate) {
  ...
  const packageDir = (0, _discoveryB19Xdk1_.f)(candidate.packageDir) ?? _nodePath.default.resolve(candidate.packageDir);
...
function resolvePackageJsonRelativePath(rootDir, packageJsonPath) {
  const resolvedRootDir = (0, _discoveryB19Xdk1_.f)(rootDir) ?? _nodePath.default.resolve(rootDir);
...
function describePackageInstallSource(candidate) {
  ...
  if (!install) return;
  return (0, _installSourceInfoDkiXB1v.t)(install, { expectedPackageName: candidate?.packageName });
}
...
function buildInstalledPluginIndexRecords(params) {
  ...
  const normalizedConfig = (0, _configState6n1ivR.o)(params.config?.plugins);
  return params.registry.plugins.map((record) => {
    ...
    const enabled = (0, _configState6n1ivR.s)({
      id: record.id,
...
function resolveInstalledPluginIndexRegistry(params) {
  if (params.candidates) return {
    ...
    registry: (0, _manifestRegistryC9Iavh.t)({
  ...
  const normalized = (0, _configState6n1ivR.o)(params.config?.plugins);
  const installRecords = params.installRecords ?? (0, _manifestRegistryC9Iavh.s)({ env: params.env });
  const discovery = (0, _discoveryB19Xdk1_.t)({
    workspaceDir: params.workspaceDir,
...
function buildInstalledPluginIndex(params) {
  ...
  const installRecords = normalizeInstallRecordMap(params.installRecords ?? (0, _manifestRegistryC9Iavh.s)({
    env,
  ...
  return {
    ...
    hostContractVersion: (0, _versionEw9InAD.o)(env),
...
function isInstalledPluginEnabled(index, pluginId, config) {
  ...
  const normalizedConfig = (0, _configState6n1ivR.o)(config?.plugins);
  const state = (0, _configState6n1ivR.c)({
    id: record.pluginId,
    origin: record.origin,
    config: normalizedConfig,
    rootConfig: config,
...
function copySafeInstallRecords(records) {
  ...
  for (const [pluginId, record] of Object.entries(records)) {
    if ((0, _prototypeKeysRBElZn9Q.t)(pluginId)) continue;
    safeRecords[pluginId] = record;
  }
  return safeRecords;
}
function parseInstalledPluginIndex(value) {
  const parsed = (0, _zodParseCnyYByY.n)(InstalledPluginIndexSchema, value);
...
async function readPersistedInstalledPluginIndex(options = {}) {
  return parseInstalledPluginIndex(await (0, _jsonFilesBvzDldMA.i)((0, _manifestRegistryC9Iavh.u)(options)));
}
function readPersistedInstalledPluginIndexSync(options = {}) {
  return parseInstalledPluginIndex((0, _jsonFilesBvzDldMA.a)((0, _manifestRegistryC9Iavh.u)(options)));
}
async function writePersistedInstalledPluginIndex(index, options = {}) {
  const filePath = (0, _manifestRegistryC9Iavh.u)(options);
  await (0, _jsonFilesBvzDldMA.o)(filePath, {
    ...index,
    warning: INSTALLED_PLUGIN_INDEX_WARNING
  }, {
...
function writePersistedInstalledPluginIndexSync(index, options = {}) {
  const filePath = (0, _manifestRegistryC9Iavh.u)(options);
  (0, _jsonFileDFvVnXBR.n)(filePath, {
    ...index,
    warning: INSTALLED_PLUGIN_INDEX_WARNING
  });
  clearCurrentPluginMetadataSnapshotState();
...
function canRefreshPersistedPolicyState(persisted, params) {
  ...
  const env = params.env ?? process.env;
  if (persisted.version !== 1 || persisted.hostContractVersion !== (0, _versionEw9InAD.o)(env) || persisted.compatRegistryVersion !== resolveCompatRegistryVersion() || persisted.migrationVersion !== 1) return false;
...
function refreshPersistedPolicyState(persisted, params) {
  ...
  return {
    ...
    plugins: persisted.plugins.map((plugin) => ({
      ...plugin,
      enabled: (0, _configState6n1ivR.s)({
        id: plugin.pluginId,
