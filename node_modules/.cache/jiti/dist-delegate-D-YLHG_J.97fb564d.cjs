"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = delegateCompactionToRuntime;exports.t = buildMemorySystemPromptAddition;var _memoryStateC4P0nzNL = require("./memory-state-C4P0nzNL.js");
var _promptCacheStability30yMmhed = require("./prompt-cache-stability-30yMmhed.js");function _interopRequireWildcard(e, t) {if ("function" == typeof WeakMap) var r = new WeakMap(),n = new WeakMap();return (_interopRequireWildcard = function (e, t) {if (!t && e && e.__esModule) return e;var o,i,f = { __proto__: null, default: e };if (null === e || "object" != typeof e && "function" != typeof e) return f;if (o = t ? n : r) {if (o.has(e)) return o.get(e);o.set(e, f);}for (const t in e) "default" !== t && {}.hasOwnProperty.call(e, t) && ((i = (o = Object.defineProperty) && Object.getOwnPropertyDescriptor(e, t)) && (i.get || i.set) ? o(f, t, i) : f[t] = e[t]);return f;})(e, t);}
//#region src/context-engine/delegate.ts
let compactRuntimePromise = null;
function loadCompactRuntime() {
  compactRuntimePromise ??= Promise.resolve().then(() => jitiImport("./compact.runtime-CS48oCoB.js").then((m) => _interopRequireWildcard(m)));
...
function buildMemorySystemPromptAddition(params) {
  const lines = (0, _memoryStateC4P0nzNL.n)({
    availableTools: params.availableTools,
    citationsMode: params.citationsMode
  });
  if (lines.length === 0) return;
  return (0, _promptCacheStability30yMmhed.n)(lines.join("\n")) || void 0;
}
//#endregion /* v9-49736d1cf498c4cc */
