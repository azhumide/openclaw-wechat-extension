"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = emptyChannelConfigSchema;exports.i = buildNestedDmConfigSchema;exports.n = buildCatchallMultiAccountChannelSchema;exports.r = buildChannelConfigSchema;exports.t = void 0;var _zodSchemaCoreUrFIFYTN = require("./zod-schema.core-urFIFYTN.js");
...
function buildNestedDmConfigSchema(extraShape) {
  const baseShape = {
    ...
    policy: _zodSchemaCoreUrFIFYTN.o.optional(),
