...
function normalizeIpParseInput(raw) {
  const trimmed = (0, _stringCoerceC1IzJjqi.c)(raw);
  if (!trimmed) return;
...
function normalizeIpAddress(raw) {
  ...
  if (!parsed) return;
  return (0, _stringCoerceC1IzJjqi.a)(normalizeIpv4MappedAddress(parsed).toString());
}
