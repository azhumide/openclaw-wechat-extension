...
function resolveLoaderModulePath(params = {}) {
  return params.modulePath ?? (0, _nodeUrl.fileURLToPath)(params.moduleUrl ?? "file:///home/rs/openclaw/dist/sdk-alias-DC8_q6CF.js");
}
...
function resolveTrustedOpenClawRootFromArgvHint(params) {
  ...
  const packageRoot = (0, _openclawRootK_JEjUP.n)({
    cwd: params.cwd,
    argv1: params.argv1
  });
...
function resolveLoaderPackageRoot(params) {
  ...
  const fromModulePath = (0, _openclawRootK_JEjUP.n)({ cwd });
  if (fromModulePath) return fromModulePath;
  const argv1 = params.argv1 ?? process.argv[1];
  const moduleUrl = params.moduleUrl ?? (params.modulePath ? void 0 : "file:///home/rs/openclaw/dist/sdk-alias-DC8_q6CF.js");
  return (0, _openclawRootK_JEjUP.n)({
    cwd,
    ...(argv1 ? { argv1 } : {}),
    ...(moduleUrl ? { moduleUrl } : {})
  });
...
function resolveLoaderPluginSdkPackageRoot(params) {
  const cwd = params.cwd ?? _nodePath.default.dirname(params.modulePath);
  const fromCwd = (0, _openclawRootK_JEjUP.n)({ cwd });
  const fromExplicitHints = resolveTrustedOpenClawRootFromArgvHint({
    cwd,
    argv1: params.argv1
  }) ?? (params.moduleUrl ? (0, _openclawRootK_JEjUP.n)({
    cwd,
...
function listPluginSdkExportedSubpaths(params = {}) {
  const packageRoot = resolveLoaderPluginSdkPackageRoot({
    modulePath: params.modulePath ?? (0, _nodeUrl.fileURLToPath)("file:///home/rs/openclaw/dist/sdk-alias-DC8_q6CF.js"),
    argv1: params.argv1,
    moduleUrl: params.moduleUrl
  });
...
function resolvePluginSdkScopedAliasMap(params = {}) {
  const modulePath = params.modulePath ?? (0, _nodeUrl.fileURLToPath)("file:///home/rs/openclaw/dist/sdk-alias-DC8_q6CF.js");
  const packageRoot = resolveLoaderPluginSdkPackageRoot({
    modulePath,
    argv1: params.argv1,
    moduleUrl: params.moduleUrl
