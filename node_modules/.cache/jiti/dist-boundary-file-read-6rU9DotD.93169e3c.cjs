"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.i = openBoundaryFileSync;exports.n = matchBoundaryFileOpenFailure;exports.r = openBoundaryFile;exports.t = canUseBoundaryFileOpen;var _boundaryPathBphsbLa = require("./boundary-path-BphsbLa5.js");
...
function openBoundaryFileSync(params) {
  ...
  const resolved = resolveBoundaryFilePathGeneric({
    ...
    resolve: (absolutePath) => (0, _boundaryPathBphsbLa.r)({
      absolutePath,
...
async function openBoundaryFile(params) {
  ...
  const maybeResolved = resolveBoundaryFilePathGeneric({
    absolutePath: params.absolutePath,
    resolve: (absolutePath) => (0, _boundaryPathBphsbLa.n)({
      absolutePath,
      rootPath: params.rootPath,
      rootCanonicalPath: params.rootRealPath,
      boundaryLabel: params.boundaryLabel,
