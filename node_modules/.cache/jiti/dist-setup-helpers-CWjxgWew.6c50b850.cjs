...
function applyAccountNameToChannelSection(params) {
  ...
  const accountId = (0, _accountIdDhSD7lhD.n)(params.accountId);
...
function migrateBaseNameToDefaultAccount(params) {
  ...
  if (!defaultAccount.name) accounts[_accountIdDhSD7lhD.t] = {
    ...defaultAccount,
    name: baseName
  };
...
function prepareScopedSetupConfig(params) {
  ...
  if (!params.migrateBaseName || (0, _accountIdDhSD7lhD.n)(params.accountId) === "default") return namedConfig;
...
function createPatchedAccountSetupAdapter(params) {
  return {
    resolveAccountId: ({ accountId }) => (0, _accountIdDhSD7lhD.n)(accountId),
...
function resolveExistingAccountKey(accounts, targetAccountId) {
  for (const existingKey of Object.keys(accounts)) if ((0, _accountIdDhSD7lhD.n)(existingKey) === targetAccountId) return existingKey;
...
function moveSingleAccountChannelSectionToDefaultAccount(params) {
  ...
  if (Object.keys(accounts).length > 0) {
    const keysToMove = (0, _setupPromotionHelpersDWjoiUFB.t)({
      channelKey: params.channelKey,
      channel: base
    });
    if (keysToMove.length === 0) return params.cfg;
    const resolvedTargetAccountKey = resolveExistingAccountKey(accounts, (0, _setupPromotionHelpersDWjoiUFB.n)({
      channelKey: params.channelKey,
      channel: base
    }));
  ...
  return moveSingleAccountKeysIntoAccount({
    ...
    accounts,
    keysToMove,
    targetAccountId: _accountIdDhSD7lhD.t
  });
}
//#endregion /* v9-6afecb1c9581bd10 */
