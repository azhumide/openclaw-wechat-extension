"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = resolveGatewayBindUrl;exports.t = resolveTailnetHostWithRunner;var _stringCoerceCjxCKZ6B = require("./string-coerce-CjxCKZ6B.js");
var _zodParseDrvB8WE = require("./zod-parse-DrvB8WE0.js");
var _zod = require("zod");
//#region src/shared/gateway-bind-url.ts
function resolveGatewayBindUrl(params) {
  const bind = params.bind ?? "loopback";
  if (bind === "custom") {
    const host = (0, _stringCoerceCjxCKZ6B.c)(params.customBindHost);
    if (host) return {
...
function parsePossiblyNoisyStatus(raw) {
  ...
  return (0, _zodParseDrvB8WE.t)(TailscaleStatusSchema, raw.slice(start, end + 1));
}
