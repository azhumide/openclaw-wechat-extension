...
require("./subsystem-CWI_MDy_.js");
require("./paths-BG0ad0P6.js");
require("./types.secrets-Zn5Zyn7M.js");
require("./net-AycWGi8-.js");
var _configSchemaBEuj464I = require("./config-schema-BEuj464I.js");
var _sessionKeyUtilsBT0y7mVK = require("./session-key-utils-BT0y7mVK.js");
var _sessionKeyEpIbK3Oz = require("./session-key-EpIbK3Oz.js");
var _registryB9khhdbq = require("./registry-B9khhdbq.js");
require("./delegate-CzMbuyut.js");
require("./common-B4WrK_Ib.js");
require("./typebox-BuMrfVlx.js");
var _helpersTGDlD7dJ = require("./helpers-TGDlD7dJ.js");
require("./resolve-route-DWtJo8cH.js");
var _baseSessionKeyCZjBtZxE = require("./base-session-key-CZjBtZxE.js");
var _threadingHelpersCQiUkJ5m = require("./threading-helpers-CQiUkJ5m.js");
var _threadIdBS5VtEc = require("./thread-id-BS5-VtEc.js");
require("./setup-helpers-CErkrrS9.js");
require("./secret-file-CTXjHVQf.js");
require("./tailscale-status-Ca9OERuf.js");
require("./persistent-bindings.resolve-CPFjJxo8.js");function _interopRequireWildcard(e, t) {if ("function" == typeof WeakMap) var r = new WeakMap(),n = new WeakMap();return (_interopRequireWildcard = function (e, t) {if (!t && e && e.__esModule) return e;var o,i,f = { __proto__: null, default: e };if (null === e || "object" != typeof e && "function" != typeof e) return f;if (o = t ? n : r) {if (o.has(e)) return o.get(e);o.set(e, f);}for (const t in e) "default" !== t && {}.hasOwnProperty.call(e, t) && ((i = (o = Object.defineProperty) && Object.getOwnPropertyDescriptor(e, t)) && (i.get || i.set) ? o(f, t, i) : f[t] = e[t]);return f;})(e, t);}
...
async function ensureConfiguredAcpBindingReady(params) {
  return (await Promise.resolve().then(() => jitiImport("./persistent-bindings.lifecycle-C-xqwy4_.js").then((m) => _interopRequireWildcard(m)))).ensureConfiguredAcpBindingReady(params);
}
let cachedSdkChatChannelMeta;
function resolveSdkChatChannelMeta(id) {
  const cacheKey = (0, _bundledDirDXKS8sgC.t)(process.env) ?? "";
  if (cachedSdkChatChannelMeta?.cacheKey !== cacheKey) cachedSdkChatChannelMeta = {
    cacheKey,
    metaById: (0, _registryB9khhdbq.l)()
  };
...
function stripChannelTargetPrefix(raw, ...providers) {
  ...
  for (const provider of providers) {
    const prefix = `${(0, _stringCoerceC1IzJjqi.a)(provider)}:`;
    if ((0, _stringCoerceC1IzJjqi.a)(trimmed).startsWith(prefix)) return trimmed.slice(prefix.length).trim();
  }
  return trimmed;
}
...
function buildChannelOutboundSessionRoute(params) {
  const baseSessionKey = (0, _baseSessionKeyCZjBtZxE.t)({
    cfg: params.cfg,
...
function recoverCurrentThreadSessionId(params) {
  const current = (0, _sessionKeyUtilsBT0y7mVK.c)(params.currentSessionKey);
  if (!current.baseSessionKey || !current.threadId) return;
  if ((0, _stringCoerceC1IzJjqi.s)(current.baseSessionKey) !== (0, _stringCoerceC1IzJjqi.s)(params.route.baseSessionKey)) return;
  const context = {
    route: params.route,
...
function buildThreadAwareOutboundSessionRoute(params) {
  ...
  const threadKeys = (0, _sessionKeyEpIbK3Oz.d)({
...
function resolveThreadAwareOutboundCandidate(threadId) {
  const sessionThreadId = (0, _threadIdBS5VtEc.t)(threadId);
...
function defineChannelPluginEntry({ id, name, description, plugin, configSchema, setRuntime, registerCliMetadata, registerFull }) {
  return {
    ...
    name,
    description,
    configSchema: typeof configSchema === "function" ? configSchema() : configSchema ?? (0, _configSchemaBEuj464I.a)(),
    register(api) {
...
function resolveChatChannelSecurity(security) {
  ...
  return {
    resolveDmPolicy: ({ cfg, accountId, account }) => (0, _helpersTGDlD7dJ.t)({
      cfg,
...
function resolveChatChannelThreading(threading) {
  ...
  if ("topLevelReplyToMode" in threading) resolveReplyToMode = (0, _threadingHelpersCQiUkJ5m.r)(threading.topLevelReplyToMode);else
  resolveReplyToMode = (0, _threadingHelpersCQiUkJ5m.t)(threading.scopedAccountReplyToMode);
  return {
    ...threading,
    resolveReplyToMode
  };
