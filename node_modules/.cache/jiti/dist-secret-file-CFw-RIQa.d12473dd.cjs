"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = readSecretFileSync;exports.i = loadSecretFileSync;exports.n = void 0;exports.o = tryReadSecretFileSync;exports.r = void 0;exports.s = writePrivateSecretFileAtomic;exports.t = void 0;var _utilsBYAfe1GS = require("./utils-BYAfe1GS.js");
var _safeOpenSyncCOtvg2e = require("./safe-open-sync-COtvg2e4.js");
...
function loadSecretFileSync(filePath, label, options = {}) {
  const resolvedPath = (0, _utilsBYAfe1GS.p)(filePath.trim());
  ...
  const opened = (0, _safeOpenSyncCOtvg2e.t)({
