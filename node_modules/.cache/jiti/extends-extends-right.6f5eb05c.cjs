...
var _templateLiteral = require("../types/template-literal.mjs");
var _union = require("../types/union.mjs");
var _unknown = require("../types/unknown.mjs");
var _extendsLeft = require("./extends-left.mjs");
var Result = _interopRequireWildcard(require("./result.mjs"));
var _decode = require("../engine/template-literal/decode.mjs");
...
function ExtendsRightInfer(inferred, name, left, right) {
  return Result.Match((0, _extendsLeft.ExtendsLeft)(inferred, left, right), (checkInferred) => Result.ExtendsTrue(_index2.Memory.Assign(_index2.Memory.Assign(inferred, checkInferred), { [name]: left })), () => Result.ExtendsFalse());
}
...
function ExtendsRightEnum(inferred, left, right) {
  ...
  return (0, _extendsLeft.ExtendsLeft)(inferred, left, union);
}
function ExtendsRightIntersect(inferred, left, right) {
  return _index.Guard.TakeLeft(right, (head, tail) => Result.Match((0, _extendsLeft.ExtendsLeft)(inferred, left, head), (inferred) => ExtendsRightIntersect(inferred, left, tail), () => Result.ExtendsFalse()), () => Result.ExtendsTrue(inferred));
}
function ExtendsRightTemplateLiteral(inferred, left, right) {
  const decoded = (0, _decode.TemplateLiteralDecode)(right);
  return (0, _extendsLeft.ExtendsLeft)(inferred, left, decoded);
}
function ExtendsRightUnion(inferred, left, right) {
  return _index.Guard.TakeLeft(right, (head, tail) => Result.Match((0, _extendsLeft.ExtendsLeft)(inferred, left, head), (inferred) => Result.ExtendsTrue(inferred), () => ExtendsRightUnion(inferred, left, tail)), () => Result.ExtendsFalse());
}
function ExtendsRight(inferred, left, right) {
  ...
  (0, _templateLiteral.IsTemplateLiteral)(right) ? ExtendsRightTemplateLiteral(inferred, left, right.pattern) :
