"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.i = validateArchiveEntryPath;exports.n = resolveArchiveOutputPath;exports.r = stripArchivePath;exports.t = isWindowsDrivePath;var _pathSafetyUg2lxoe = require("./path-safety-ug2lxoe3.js");
...
function resolveArchiveOutputPath(params) {
  const safeBase = (0, _pathSafetyUg2lxoe.n)(params.rootDir);
