...
function resolveUserPath(input, env = process.env, homedir = _nodeOs.default.homedir) {
  if (!input) return "";
  return (0, _homeDirCrqRP4qn.r)(input, {
    env,
    homedir
  });
}
function resolveConfigDir(env = process.env, homedir = _nodeOs.default.homedir) {
  ...
  const newDir = _nodePath.default.join((0, _homeDirCrqRP4qn.o)(env, homedir), ".openclaw");
  try {
...
function resolveHomeDir() {
  return (0, _homeDirCrqRP4qn.n)(process.env, _nodeOs.default.homedir);
}
