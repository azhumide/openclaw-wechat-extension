...
function normalizeRouteBindingChannelId(raw) {
  const normalized = (0, _ids2bZIXJNM.r)(raw);
  if (normalized) return normalized;
  return (0, _stringCoerceC1IzJjqi.a)(raw) || null;
}
function resolveNormalizedRouteBindingMatch(binding) {
  ...
  return {
    agentId: (0, _sessionKeyEpIbK3Oz.c)(binding.agentId),
    accountId: (0, _accountIdC3j_3_su.n)(accountId),
    channelId
  };
}
