"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = shouldSpawnWithShell;exports.i = runExec;exports.n = resolveProcessExitCode;exports.o = resolveWindowsCommandShim;exports.r = runCommandWithTimeout;exports.s = spawnWithFallback;exports.t = resolveCommandEnv;var _stringCoerceC1IzJjqi = require("./string-coerce-C1IzJjqi.js");
var _openclawExecEnvB_Z1z9iZ = require("./openclaw-exec-env-B_Z1z9iZ.js");
...
function resolveWindowsCommandShim(params) {
  ...
  const basename = (0, _stringCoerceC1IzJjqi.a)(_nodePath.default.basename(params.command));
...
function isWindowsBatchCommand(resolvedCommand) {
  ...
  const ext = (0, _stringCoerceC1IzJjqi.a)(_nodePath.default.extname(resolvedCommand));
...
function resolveNpmArgvForWindows(argv) {
  ...
  const basename = (0, _stringCoerceC1IzJjqi.a)(_nodePath.default.basename(argv[0])).replace(/\.(cmd|exe|bat)$/, "");
  ...
  if (!_nodeFs.default.existsSync(cliPath)) {
    ...
    return [(0, _stringCoerceC1IzJjqi.a)(_nodePath.default.extname(command)) ? command : `${command}.cmd`, ...argv.slice(1)];
  }
  return [
...
async function runExec(command, args, opts = 1e4) {
  ...
  try {
    ...
    if ((0, _globalsDeRFSEIV.a)()) {
      if (stdout.trim()) (0, _loggerBvytzgs.t)(stdout.trim());
      if (stderr.trim()) (0, _loggerBvytzgs.n)(stderr.trim());
    }
    return {
      stdout,
      stderr
    ...
    if ((0, _globalsDeRFSEIV.a)()) (0, _loggerBvytzgs.n)((0, _globalsDeRFSEIV.t)(`Command failed: ${command} ${args.join(" ")}`));
    throw err;
  }
}
...
function resolveCommandEnv(params) {
  ...
  return (0, _openclawExecEnvB_Z1z9iZ.n)(resolvedEnv);
}
