...
function normalizeIpParseInput(raw) {
  const trimmed = (0, _stringCoerceCjxCKZ6B.c)(raw);
  if (!trimmed) return;
...
function normalizeIpAddress(raw) {
  ...
  if (!parsed) return;
  return (0, _stringCoerceCjxCKZ6B.a)(normalizeIpv4MappedAddress(parsed).toString());
}
