"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = assertNoPathAliasEscape;exports.t = void 0;var _boundaryPathC2iMx2xR = require("./boundary-path-C2iMx2xR.js");
...
async function assertNoHardlinkedFinalPath(params) {
  ...
  try {
    ...
    if ((0, _boundaryPathC2iMx2xR.o)(err)) return;
    throw err;
  }
...
const PATH_ALIAS_POLICIES = exports.t = _boundaryPathC2iMx2xR.t;
async function assertNoPathAliasEscape(params) {
  const resolved = await (0, _boundaryPathC2iMx2xR.n)({
