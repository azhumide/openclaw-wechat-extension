...
var _base64MGBDnil = require("./base64-M-GBDnil.js");
var _imageOpsCDj1vqKD = require("./image-ops-CDj1vqKD.js");
...
async function resizeImageBase64IfNeeded(params) {
  ...
  const meta = await (0, _imageOpsCDj1vqKD.a)(buf);
  ...
  const sideGrid = (0, _imageOpsCDj1vqKD.r)(params.maxDimensionPx, sideStart);
  let smallest = null;
  for (const side of sideGrid) for (const quality of _imageOpsCDj1vqKD.t) {
    const out = await (0, _imageOpsCDj1vqKD.l)({
      buffer: buf,
      maxSide: side,
      quality,
...
async function sanitizeContentBlocksImages(blocks, label, opts = {}) {
  ...
  for (const block of blocks) {
    ...
    const canonicalData = (0, _base64MGBDnil.t)(data);
    if (!canonicalData) {
      out.push({
        type: "text",
