...
var _asyncIterator = require("../../types/async-iterator.mjs");
...
function FromType(properties, type) {
  ...
  (0, _asyncIterator.IsAsyncIterator)(type) ? (0, _asyncIterator.AsyncIterator)(FromType(properties, type.iteratorItems)) :
