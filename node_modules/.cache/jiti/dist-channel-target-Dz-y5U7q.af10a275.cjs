"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = actionHasTarget;exports.n = exports.i = void 0;exports.o = actionRequiresTarget;exports.r = applyTargetToParams;exports.s = hasPotentialPluginActionParam;exports.t = void 0;var _stringCoerceCjxCKZ6B = require("./string-coerce-CjxCKZ6B.js");
var _bootstrapRegistryCRajYk = require("./bootstrap-registry-cRajYk82.js");
...
function hasPotentialPluginActionParam(params) {
  return Object.entries(params).some(([key, value]) => {
    ...
    if (typeof value === "string") return Boolean((0, _stringCoerceCjxCKZ6B.c)(value));
...
function listActionTargetAliasSpecs(action, params, channel) {
  ...
  const normalizedChannel = (0, _stringCoerceCjxCKZ6B.s)(channel);
  if (!normalizedChannel || !hasPotentialPluginActionParam(params)) return specs;
  const channelSpec = (0, _bootstrapRegistryCRajYk.t)(normalizedChannel)?.actions?.messageActionTargetAliases?.[action];
...
function actionHasTarget(action, params, options) {
  if ((0, _stringCoerceCjxCKZ6B.c)(params.to) ?? "") return true;
  if ((0, _stringCoerceCjxCKZ6B.c)(params.channelId) ?? "") return true;
...
const hasNonEmptyString = exports.i = _stringCoerceCjxCKZ6B.t;
...
function applyTargetToParams(params) {
  const target = (0, _stringCoerceCjxCKZ6B.c)(params.args.target) ?? "";
