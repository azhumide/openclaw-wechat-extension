"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = isWithinDir;exports.i = validateArchiveEntryPath;exports.n = resolveArchiveOutputPath;exports.r = stripArchivePath;exports.t = isWindowsDrivePath;var _boundaryPathBUtehO_x = require("./boundary-path-BUtehO_x.js");
...
function isWithinDir(rootDir, targetPath) {
  return (0, _boundaryPathBUtehO_x.s)(rootDir, targetPath);
}
//#endregion
