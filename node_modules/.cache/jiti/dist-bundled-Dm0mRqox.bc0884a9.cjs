...
var _bundledRuntimeRootUEDpOiQ = require("./bundled-runtime-root-UEDpOiQ-.js");
...
const OPENCLAW_PACKAGE_ROOT = (0, _openclawRootK_JEjUP.n)({
  ...
  cwd: process.cwd(),
  moduleUrl: "file:///home/rs/openclaw/dist/bundled-Dm0mRqox.js".startsWith("file:") ? "file:///home/rs/openclaw/dist/bundled-Dm0mRqox.js" : void 0
}) ?? ("file:///home/rs/openclaw/dist/bundled-Dm0mRqox.js".startsWith("file:") ? _nodePath.default.resolve((0, _nodeUrl.fileURLToPath)(new URL("../../..", "file:///home/rs/openclaw/dist/bundled-Dm0mRqox.js"))) : process.cwd());
...
function createModuleLoader() {
  ...
  return (modulePath) => {
    return (0, _jitiLoaderCacheBZjTVQL.t)({
      cache: jitiLoaders,
      modulePath,
      importerUrl: "file:///home/rs/openclaw/dist/bundled-Dm0mRqox.js",
      argvEntry: process.argv[1],
      preferBuiltDist: true,
      jitiFilename: "file:///home/rs/openclaw/dist/bundled-Dm0mRqox.js"
    });
  };
}
...
const log = (0, _subsystemBIXRI3F.t)("channels");
...
function loadGeneratedBundledChannelModule(params) {
  ...
  if (params.installRuntimeDeps !== false && (0, _bundledRuntimeRootUEDpOiQ.t)(boundaryRoot)) {
    const prepared = (0, _bundledRuntimeRootUEDpOiQ.n)({
...
function loadGeneratedBundledChannelEntry(params) {
  try {
    ...
    const detail = (0, _errorsCp0VGEoT.i)(error);
