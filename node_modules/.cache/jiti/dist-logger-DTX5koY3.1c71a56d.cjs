"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.A = hasFlag;exports.C = buildParseArgv;exports.D = getPositiveIntFlagValue;exports.E = getFlagValue;exports.F = shouldMigrateStateFromPath;exports.I = consumeRootOptionToken;exports.L = isValueToken;exports.M = hasRootVersionAlias;exports.N = isRootHelpInvocation;exports.O = getPrimaryCommand;exports.P = isRootVersionInvocation;exports.R = isBunRuntime;exports.S = shouldSkipMutatingLoggingConfigRead;exports.T = getCommandPositionalsWithRootOptions;exports._ = void 0;exports.a = getLogger;exports.b = tryParseLogLevel;exports.c = registerLogTransport;exports.d = toPinoLikeLogger;exports.f = formatLocalIsoWithOffset;exports.g = void 0;exports.h = resolveEnvLogLevelOverride;exports.i = getChildLogger;exports.j = hasHelpOrVersion;exports.k = getVerboseFlag;exports.l = resetLogger;exports.m = isValidTimeZone;exports.n = void 0;exports.o = getResolvedLoggerSettings;exports.p = formatTimestamp;exports.r = void 0;exports.s = isFileLogLevelEnabled;exports.t = void 0;exports.u = setLoggerOverride;exports.v = levelToMinLevel;exports.w = getCommandPathWithRootOptions;exports.x = readLoggingConfig;exports.y = normalizeLogLevel;exports.z = isNodeRuntime;var _nodeRequireDvwmVoHm = require("./node-require-DvwmVoHm.js");
var _stringCoerceCjxCKZ6B = require("./string-coerce-CjxCKZ6B.js");
var _tmpOpenclawDirCWQcmOLf = require("./tmp-openclaw-dir-CWQcmOLf.js");
...
function normalizeRuntimeBasename(execPath) {
  ...
  return (0, _stringCoerceCjxCKZ6B.a)(lastSlash === -1 ? trimmed : trimmed.slice(lastSlash + 1));
}
...
const requireConfig$1 = (0, _nodeRequireDvwmVoHm.t)("file:///home/rs/openclaw/dist/logger-DTX5koY3.js");
...
function resolveEnvLogLevelOverride() {
  const trimmed = (0, _stringCoerceCjxCKZ6B.c)(process.env.OPENCLAW_LOG_LEVEL) ?? "";
  if (!trimmed) {
...
function resolveDefaultLogDir() {
  return canUseNodeFs() ? (0, _tmpOpenclawDirCWQcmOLf.n)() : _tmpOpenclawDirCWQcmOLf.t;
}
function resolveDefaultLogFile(defaultLogDir) {
  return canUseNodeFs() ? _nodePath.default.join(defaultLogDir, "openclaw.log") : `${_tmpOpenclawDirCWQcmOLf.t}/openclaw.log`;
}
...
const requireConfig = (0, _nodeRequireDvwmVoHm.t)("file:///home/rs/openclaw/dist/logger-DTX5koY3.js");
