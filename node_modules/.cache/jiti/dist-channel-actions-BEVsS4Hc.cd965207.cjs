"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = listTokenSourcedAccounts;exports.i = createUnionActionGate;exports.n = createMessageToolCardSchema;exports.r = resolveReactionMessageId;exports.t = createMessageToolButtonsSchema;var _commonRq2JD8YM = require("./common-Rq2JD8YM.js");
require("./sandbox-paths-D63o8O1C.js");
var _typeboxCCoQKQzx = require("./typebox-CCoQKQzx.js");
...
function resolveReactionMessageId(params) {
  return (0, _commonRq2JD8YM.h)(params.args, "messageId") ?? params.toolContext?.currentMessageId;
}
//#endregion
...
function createMessageToolButtonsSchema() {
  return _typebox.Type.Optional(_typebox.Type.Array(_typebox.Type.Array(_typebox.Type.Object({
    ...
    style: _typebox.Type.Optional((0, _typeboxCCoQKQzx.i)([
    "danger",
    "success",
    "primary"]
    ))
