"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.t = formatCliCommand;var _profileUtilsBUSMWomV = require("./profile-utils-BUSMWomV.js");
var _cliNameDM6eVQSN = require("./cli-name-DM6eVQSN.js");
...
function formatCliCommand(command, env = process.env) {
  const normalizedCommand = (0, _cliNameDM6eVQSN.t)(command, (0, _cliNameDM6eVQSN.n)());
  ...
  const profile = (0, _profileUtilsBUSMWomV.n)(env.OPENCLAW_PROFILE);
