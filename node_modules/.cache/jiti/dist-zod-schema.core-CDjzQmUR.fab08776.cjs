"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.I = exports.F = exports.E = exports.D = exports.C = exports.A = void 0;exports.L = createAllowDenyChannelRulesSchema;exports.y = exports.x = exports.w = exports.v = exports.u = exports.t = exports.s = exports.r = exports.p = exports.o = exports.n = exports.m = exports.l = exports.k = exports.j = exports.i = exports.h = exports.g = exports.f = exports.d = exports.c = exports.b = exports.a = exports._ = exports.T = exports.S = exports.P = exports.O = exports.N = exports.M = void 0;var _execSafetyDFkb_GXF = require("./exec-safety-DFkb_GXF.js");
var _refContractBXXK72d = require("./ref-contract-BXXK72d4.js");
var _stringNormalizationBrdBBNdu = require("./string-normalization-BrdBBNdu.js");
var _typesModelsBAlR6uU = require("./types.models-BAlR6uU6.js");
var _zodSchemaSensitiveC5HbbcEP = require("./zod-schema.sensitive-C5HbbcEP.js");
...
const FileSecretRefSchema = _zod.z.object({
  ...
  provider: _zod.z.string().regex(SECRET_PROVIDER_ALIAS_PATTERN, "Secret reference provider must match /^[a-z][a-z0-9_-]{0,63}$/ (example: \"default\")."),
  id: _zod.z.string().refine(_refContractBXXK72d.s, "File secret reference id must be an absolute JSON pointer (example: \"/providers/openai/apiKey\"), or \"value\" for singleValue mode.")
}).strict();
const ExecSecretRefSchema = _zod.z.object({
  source: _zod.z.literal("exec"),
  provider: _zod.z.string().regex(SECRET_PROVIDER_ALIAS_PATTERN, "Secret reference provider must match /^[a-z][a-z0-9_-]{0,63}$/ (example: \"default\")."),
  id: _zod.z.string().refine(_refContractBXXK72d.o, (0, _refContractBXXK72d.a)())
}).strict();
...
const SecretsExecProviderSchema = _zod.z.object({
  source: _zod.z.literal("exec"),
  command: _zod.z.string().min(1).refine((value) => (0, _execSafetyDFkb_GXF.t)(value), "secrets.providers.*.command is unsafe.").refine((value) => isAbsolutePath(value), "secrets.providers.*.command must be an absolute path."),
...
const ModelApiSchema = _zod.z.enum(_typesModelsBAlR6uU.t);
...
const ConfiguredProviderRequestTlsSchema = _zod.z.object({
  ca: SecretInputSchema.optional().register(_zodSchemaSensitiveC5HbbcEP.t),
  cert: SecretInputSchema.optional().register(_zodSchemaSensitiveC5HbbcEP.t),
  key: SecretInputSchema.optional().register(_zodSchemaSensitiveC5HbbcEP.t),
  passphrase: SecretInputSchema.optional().register(_zodSchemaSensitiveC5HbbcEP.t),
...
_zod.z.object({
  ...
  token: SecretInputSchema.register(_zodSchemaSensitiveC5HbbcEP.t)
}).strict(),
_zod.z.object({
  mode: _zod.z.literal("header"),
  headerName: _zod.z.string().min(1),
  value: SecretInputSchema.register(_zodSchemaSensitiveC5HbbcEP.t),
...
const ConfiguredProviderRequestFields = {
  headers: _zod.z.record(_zod.z.string(), SecretInputSchema.register(_zodSchemaSensitiveC5HbbcEP.t)).optional(),
...
const ModelProviderSchema = _zod.z.object({
  ...
  apiKey: SecretInputSchema.optional().register(_zodSchemaSensitiveC5HbbcEP.t),
  auth: _zod.z.union([
...
const GroupChatSchema = exports.c = _zod.z.object({
  ...
  visibleReplies: _zod.z.enum(["automatic", "message_tool"]).optional()
}).strict().optional();
...
const TtsProviderConfigSchema = _zod.z.object({ apiKey: SecretInputSchema.optional().register(_zodSchemaSensitiveC5HbbcEP.t) }).catchall(_zod.z.union([
_zod.z.string(),
_zod.z.number(),
_zod.z.boolean(),
_zod.z.null(),
...
const normalizeAllowFrom = (values) => (0, _stringNormalizationBrdBBNdu.s)(values);
...
const TranscribeAudioSchema = exports.k = _zod.z.object({
  command: _zod.z.array(_zod.z.string()).superRefine((value, ctx) => {
    ...
    if (!(0, _execSafetyDFkb_GXF.t)(executable)) ctx.addIssue({
      code: _zod.z.ZodIssueCode.custom,
      path: [0],
...
const ExecutableTokenSchema = exports.s = _zod.z.string().refine(_execSafetyDFkb_GXF.t, "expected safe executable name or path");
