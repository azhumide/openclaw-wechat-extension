...
var _mimeBVvNIo = require("./mime-B-vvNIo6.js");
var _toolImagesGG8dJ_Bm = require("./tool-images-gG8dJ_Bm.js");
...
async function imageResult(params) {
  ...
  return await (0, _toolImagesGG8dJ_Bm.r)({
    content,
    details: {
      path: params.path,
      ...params.details,
...
async function imageResultFromFile(params) {
  ...
  const mimeType = (await (0, _mimeBVvNIo.n)({ buffer: buf.slice(0, 256) })) ?? "image/png";
