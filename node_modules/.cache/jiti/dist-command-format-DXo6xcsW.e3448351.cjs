...
var _cliNameDkMU7l0_ = require("./cli-name-DkMU7l0_.js");
...
function formatCliCommand(command, env = process.env) {
  const normalizedCommand = (0, _cliNameDkMU7l0_.t)(command, (0, _cliNameDkMU7l0_.n)());
