...
require("./subsystem-bmJ5rL4Q.js");
require("./paths-D92DjaZ-.js");
require("./types.secrets-BZ6RGKR0.js");
require("./net-B-vYkUV_.js");
var _configSchema8E_CZC = require("./config-schema-8E_-cZ-c.js");
var _sessionKeyCn2QoOyX = require("./session-key-Cn2QoOyX.js");
var _registryCGsqKAN = require("./registry-CGsqKAN1.js");
require("./delegate-Ik7QOhdo.js");
require("./common-C5vlmv7M.js");
require("./typebox-BukCJRtm.js");
var _helpersC681VFMb = require("./helpers-C681VFMb.js");
require("./resolve-route-DwllTWFS.js");
var _baseSessionKeyBkrZ2aBK = require("./base-session-key-BkrZ2aBK.js");
var _threadingHelpersCeoXKJ0f = require("./threading-helpers-CeoXKJ0f.js");
var _threadIdBP0ILaYW = require("./thread-id-BP0ILaYW.js");
require("./setup-helpers-BV8XdMxU.js");
require("./secret-file-D8oF5NCW.js");
require("./tailscale-status-C-GSL5-1.js");
require("./persistent-bindings.resolve-y8-IEpqu.js");function _interopRequireWildcard(e, t) {if ("function" == typeof WeakMap) var r = new WeakMap(),n = new WeakMap();return (_interopRequireWildcard = function (e, t) {if (!t && e && e.__esModule) return e;var o,i,f = { __proto__: null, default: e };if (null === e || "object" != typeof e && "function" != typeof e) return f;if (o = t ? n : r) {if (o.has(e)) return o.get(e);o.set(e, f);}for (const t in e) "default" !== t && {}.hasOwnProperty.call(e, t) && ((i = (o = Object.defineProperty) && Object.getOwnPropertyDescriptor(e, t)) && (i.get || i.set) ? o(f, t, i) : f[t] = e[t]);return f;})(e, t);}
...
async function ensureConfiguredAcpBindingReady(params) {
  return (await Promise.resolve().then(() => jitiImport("./persistent-bindings.lifecycle-BdBns2yD.js").then((m) => _interopRequireWildcard(m)))).ensureConfiguredAcpBindingReady(params);
}
let cachedSdkChatChannelMeta;
function resolveSdkChatChannelMeta(id) {
  const cacheKey = (0, _bundledDirU738ay4K.t)(process.env) ?? "";
  if (cachedSdkChatChannelMeta?.cacheKey !== cacheKey) cachedSdkChatChannelMeta = {
    cacheKey,
    metaById: (0, _registryCGsqKAN.l)()
  };
...
function stripChannelTargetPrefix(raw, ...providers) {
  ...
  for (const provider of providers) {
    const prefix = `${(0, _stringCoerceCjxCKZ6B.a)(provider)}:`;
    if ((0, _stringCoerceCjxCKZ6B.a)(trimmed).startsWith(prefix)) return trimmed.slice(prefix.length).trim();
  }
  return trimmed;
}
...
function buildChannelOutboundSessionRoute(params) {
  const baseSessionKey = (0, _baseSessionKeyBkrZ2aBK.t)({
    cfg: params.cfg,
...
function recoverCurrentThreadSessionId(params) {
  const current = (0, _sessionKeyCn2QoOyX.C)(params.currentSessionKey);
  if (!current.baseSessionKey || !current.threadId) return;
  if ((0, _stringCoerceCjxCKZ6B.s)(current.baseSessionKey) !== (0, _stringCoerceCjxCKZ6B.s)(params.route.baseSessionKey)) return;
  const context = {
    route: params.route,
...
function buildThreadAwareOutboundSessionRoute(params) {
  ...
  const threadKeys = (0, _sessionKeyCn2QoOyX.d)({
...
function resolveThreadAwareOutboundCandidate(threadId) {
  const sessionThreadId = (0, _threadIdBP0ILaYW.t)(threadId);
...
function defineChannelPluginEntry({ id, name, description, plugin, configSchema, setRuntime, registerCliMetadata, registerFull }) {
  return {
    ...
    name,
    description,
    configSchema: typeof configSchema === "function" ? configSchema() : configSchema ?? (0, _configSchema8E_CZC.a)(),
    register(api) {
...
function resolveChatChannelSecurity(security) {
  ...
  return {
    resolveDmPolicy: ({ cfg, accountId, account }) => (0, _helpersC681VFMb.t)({
      cfg,
...
function resolveChatChannelThreading(threading) {
  ...
  if ("topLevelReplyToMode" in threading) resolveReplyToMode = (0, _threadingHelpersCeoXKJ0f.r)(threading.topLevelReplyToMode);else
  resolveReplyToMode = (0, _threadingHelpersCeoXKJ0f.t)(threading.scopedAccountReplyToMode);
  return {
    ...threading,
    resolveReplyToMode
  };
