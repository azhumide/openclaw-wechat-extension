...
var _registryLmPqGvar = require("./registry-LmPqGvar.js");
var _agentScope_6dFncNS = require("./agent-scope-_6dFncNS.js");
require("./plugins-Bb8ciqtj.js");
var _runtimeDBWSzSHy = require("./runtime-DBWSzSHy.js");
var _bindingsDFu1CQmr = require("./bindings-DFu1CQmr.js");
var _resolveRouteBBu_Xnrr = require("./resolve-route-BBu_Xnrr.js");
...
function resolveLoadedChannelPlugin(channel) {
  ...
  return (0, _registryLmPqGvar.t)(normalized);
}
...
function compileConfiguredBindingRule(params) {
  const agentId = (0, _resolveRouteBBu_Xnrr.r)(params.cfg, params.binding.agentId ?? "main");
...
function compileConfiguredBindingRegistry(params) {
  ...
  for (const binding of (0, _bindingsDFu1CQmr.r)(params.cfg)) {
...
function resolveCompiledBindingRegistry(cfg) {
  const activeRegistry = (0, _runtimeDBWSzSHy.g)();
  const registryVersion = (0, _runtimeDBWSzSHy.n)();
...
function primeCompiledBindingRegistry(cfg) {
  ...
  compiledRegistryCache.set(cfg, {
    registryRef: activeRegistry,
    registryVersion: (0, _runtimeDBWSzSHy.n)(),
    registry
  });
  return registry;
}
