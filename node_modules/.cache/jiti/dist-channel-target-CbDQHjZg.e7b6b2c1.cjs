...
var _bootstrapRegistryDxDaUpQW = require("./bootstrap-registry-DxDaUpQW.js");
...
function listActionTargetAliasSpecs(action, params, channel) {
  ...
  const channelSpec = (0, _bootstrapRegistryDxDaUpQW.t)(normalizedChannel)?.actions?.messageActionTargetAliases?.[action];
