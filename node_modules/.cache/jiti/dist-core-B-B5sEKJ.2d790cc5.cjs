...
require("./delegate-DhIA43Us.js");
require("./common-FRZrPBKu.js");
require("./typebox-IX5tiYkD.js");
var _helpersCqviAPwR = require("./helpers-CqviAPwR.js");
require("./resolve-route-kEdonC_-.js");
var _baseSessionKey_uOeQbN = require("./base-session-key-_uOeQbN6.js");
var _threadingHelpersBoWIwGJ = require("./threading-helpers-BoWIwGJ6.js");
var _threadIdCoPyYZsw = require("./thread-id-CoPyYZsw.js");
require("./setup-helpers-DueR_siR.js");
require("./secret-file-CFw-RIQa.js");
require("./tailscale-status-30Wr1Db6.js");
require("./persistent-bindings.resolve-ExPHUUFa.js");function _interopRequireWildcard(e, t) {if ("function" == typeof WeakMap) var r = new WeakMap(),n = new WeakMap();return (_interopRequireWildcard = function (e, t) {if (!t && e && e.__esModule) return e;var o,i,f = { __proto__: null, default: e };if (null === e || "object" != typeof e && "function" != typeof e) return f;if (o = t ? n : r) {if (o.has(e)) return o.get(e);o.set(e, f);}for (const t in e) "default" !== t && {}.hasOwnProperty.call(e, t) && ((i = (o = Object.defineProperty) && Object.getOwnPropertyDescriptor(e, t)) && (i.get || i.set) ? o(f, t, i) : f[t] = e[t]);return f;})(e, t);}
...
async function ensureConfiguredAcpBindingReady(params) {
  return (await Promise.resolve().then(() => jitiImport("./persistent-bindings.lifecycle-BfjjuoKV.js").then((m) => _interopRequireWildcard(m)))).ensureConfiguredAcpBindingReady(params);
}
...
function buildChannelOutboundSessionRoute(params) {
  const baseSessionKey = (0, _baseSessionKey_uOeQbN.t)({
    cfg: params.cfg,
