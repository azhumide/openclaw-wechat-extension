...
var _bundledD1aAllsd = require("./bundled-D1aAllsd.js");
...
function getLoadedChannelSetupPromotionSurface(channelKey) {
  return asPromotionSurface((0, _registryCi9ATKEN.n)(channelKey)?.setup);
}
function getBundledChannelSetupPromotionSurface(channelKey) {
  if (!(0, _bundledD1aAllsd.o)(channelKey, "configPromotion")) return null;
  return asPromotionSurface((0, _bundledD1aAllsd.n)(channelKey)?.setup);
}
