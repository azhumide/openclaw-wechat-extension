...
var _configSchemaDGNvFT8C = require("./config-schema-DGNvFT8C.js");
require("./subsystem-Izr-DYZz.js");
require("./net-DDjdGYkE.js");
var _sessionKeyUtilsB9qLc2A = require("./session-key-utils-B9qLc2A8.js");
var _sessionKeyC6FNnIG = require("./session-key-C6F-NnIG.js");
var _registryC85w3UMa = require("./registry-C85w3UMa.js");
require("./delegate-pN56NbCF.js");
require("./common-WwJcpwdP.js");
require("./typebox-CX1CigOB.js");
var _helpersD5_OgjA = require("./helpers-D5_OgjA3.js");
require("./resolve-route-B-BcZvIS.js");
var _baseSessionKeyCWT_8kPJ = require("./base-session-key-CWT_8kPJ.js");
var _threadingHelpersBk_hNQw = require("./threading-helpers-Bk_hN-Qw.js");
var _threadIdBAwVwM2X = require("./thread-id-BAwVwM2X.js");
require("./setup-helpers-gYLJgwG8.js");
require("./secret-file-CgkfmkcP.js");
require("./tailscale-status-B-OsSHAu.js");
require("./persistent-bindings.resolve-BFZpVBcb.js");function _interopRequireWildcard(e, t) {if ("function" == typeof WeakMap) var r = new WeakMap(),n = new WeakMap();return (_interopRequireWildcard = function (e, t) {if (!t && e && e.__esModule) return e;var o,i,f = { __proto__: null, default: e };if (null === e || "object" != typeof e && "function" != typeof e) return f;if (o = t ? n : r) {if (o.has(e)) return o.get(e);o.set(e, f);}for (const t in e) "default" !== t && {}.hasOwnProperty.call(e, t) && ((i = (o = Object.defineProperty) && Object.getOwnPropertyDescriptor(e, t)) && (i.get || i.set) ? o(f, t, i) : f[t] = e[t]);return f;})(e, t);}
...
async function ensureConfiguredAcpBindingReady(params) {
  return (await Promise.resolve().then(() => jitiImport("./persistent-bindings.lifecycle-CmDFU-6k.js").then((m) => _interopRequireWildcard(m)))).ensureConfiguredAcpBindingReady(params);
}
let cachedSdkChatChannelMeta;
function resolveSdkChatChannelMeta(id) {
  const cacheKey = (0, _bundledDirBdVWKJP.n)(process.env) ?? "";
  if (cachedSdkChatChannelMeta?.cacheKey !== cacheKey) cachedSdkChatChannelMeta = {
    cacheKey,
    metaById: (0, _registryC85w3UMa.l)()
  };
...
function buildChannelOutboundSessionRoute(params) {
  const baseSessionKey = (0, _baseSessionKeyCWT_8kPJ.t)({
    cfg: params.cfg,
...
function buildThreadAwareOutboundSessionRoute(params) {
  ...
  const threadKeys = (0, _sessionKeyC6FNnIG.d)({
...
function resolveThreadAwareOutboundCandidate(threadId) {
  const sessionThreadId = (0, _threadIdBAwVwM2X.t)(threadId);
...
function defineChannelPluginEntry({ id, name, description, plugin, configSchema, setRuntime, registerCliMetadata, registerFull }) {
  return {
    ...
    name,
    description,
    configSchema: typeof configSchema === "function" ? configSchema() : configSchema ?? (0, _configSchemaDGNvFT8C.a)(),
    register(api) {
...
function resolveChatChannelSecurity(security) {
  ...
  return {
    resolveDmPolicy: ({ cfg, accountId, account }) => (0, _helpersD5_OgjA.t)({
      cfg,
...
function resolveChatChannelThreading(threading) {
  ...
  if ("topLevelReplyToMode" in threading) resolveReplyToMode = (0, _threadingHelpersBk_hNQw.r)(threading.topLevelReplyToMode);else
  resolveReplyToMode = (0, _threadingHelpersBk_hNQw.t)(threading.scopedAccountReplyToMode);
  return {
    ...threading,
    resolveReplyToMode
  };
