...
var _bundledDGfgHMJZ = require("./bundled-DGfgHMJZ.js");
...
function getLoadedChannelSetupPromotionSurface(channelKey) {
  return asPromotionSurface((0, _registryCepMPIe.n)(channelKey)?.setup);
}
function getBundledChannelSetupPromotionSurface(channelKey) {
  if (!(0, _bundledDGfgHMJZ.o)(channelKey, "configPromotion")) return null;
  return asPromotionSurface((0, _bundledDGfgHMJZ.n)(channelKey)?.setup);
}
