...
require("./types.secrets-ClP-vJ-P.js");
var _bundledDirDygrJuRr = require("./bundled-dir-DygrJuRr.js");
require("./subsystem-rHhUC6qs.js");
require("./net-BBCaEpfz.js");
var _sessionKeyUtilsNaHBWFyS = require("./session-key-utils-naHBWFyS.js");
var _sessionKeyHxP9B3Or = require("./session-key-hxP9B3Or.js");
var _configSchemaDi5PBhdS = require("./config-schema-Di5PBhdS.js");
var _registryGHcDenJ = require("./registry-GHcDenJ3.js");
require("./delegate-ByWKXAaY.js");
require("./common-C4RGIxnG.js");
require("./typebox-CjvQ7Ch7.js");
var _helpersDacXri_ = require("./helpers-DacXri_3.js");
require("./resolve-route-C2h77Rnt.js");
var _baseSessionKeyD3m3uGAu = require("./base-session-key-D3m3uGAu.js");
var _threadingHelpersBz5uPhFc = require("./threading-helpers-Bz5uPhFc.js");
var _threadIdDDzmOvpx = require("./thread-id-DDzmOvpx.js");
require("./setup-helpers-CWjxgWew.js");
require("./secret-file-BEd6O4bq.js");
require("./tailscale-status-TIS3YuXv.js");
require("./persistent-bindings.resolve-BZZfnQzp.js");function _interopRequireWildcard(e, t) {if ("function" == typeof WeakMap) var r = new WeakMap(),n = new WeakMap();return (_interopRequireWildcard = function (e, t) {if (!t && e && e.__esModule) return e;var o,i,f = { __proto__: null, default: e };if (null === e || "object" != typeof e && "function" != typeof e) return f;if (o = t ? n : r) {if (o.has(e)) return o.get(e);o.set(e, f);}for (const t in e) "default" !== t && {}.hasOwnProperty.call(e, t) && ((i = (o = Object.defineProperty) && Object.getOwnPropertyDescriptor(e, t)) && (i.get || i.set) ? o(f, t, i) : f[t] = e[t]);return f;})(e, t);}
...
async function ensureConfiguredAcpBindingReady(params) {
  return (await Promise.resolve().then(() => jitiImport("./persistent-bindings.lifecycle-CQoTFNO2.js").then((m) => _interopRequireWildcard(m)))).ensureConfiguredAcpBindingReady(params);
}
let cachedSdkChatChannelMeta;
function resolveSdkChatChannelMeta(id) {
  const cacheKey = (0, _bundledDirDygrJuRr.t)(process.env) ?? "";
  if (cachedSdkChatChannelMeta?.cacheKey !== cacheKey) cachedSdkChatChannelMeta = {
    cacheKey,
    metaById: (0, _registryGHcDenJ.l)()
  };
...
function buildChannelOutboundSessionRoute(params) {
  const baseSessionKey = (0, _baseSessionKeyD3m3uGAu.t)({
    cfg: params.cfg,
...
function recoverCurrentThreadSessionId(params) {
  const current = (0, _sessionKeyUtilsNaHBWFyS.c)(params.currentSessionKey);
...
function buildThreadAwareOutboundSessionRoute(params) {
  ...
  const threadKeys = (0, _sessionKeyHxP9B3Or.d)({
...
function resolveThreadAwareOutboundCandidate(threadId) {
  const sessionThreadId = (0, _threadIdDDzmOvpx.t)(threadId);
...
function defineChannelPluginEntry({ id, name, description, plugin, configSchema, setRuntime, registerCliMetadata, registerFull }) {
  return {
    ...
    name,
    description,
    configSchema: typeof configSchema === "function" ? configSchema() : configSchema ?? (0, _configSchemaDi5PBhdS.a)(),
    register(api) {
...
function resolveChatChannelSecurity(security) {
  ...
  return {
    resolveDmPolicy: ({ cfg, accountId, account }) => (0, _helpersDacXri_.t)({
      cfg,
...
function resolveChatChannelThreading(threading) {
  ...
  if ("topLevelReplyToMode" in threading) resolveReplyToMode = (0, _threadingHelpersBz5uPhFc.r)(threading.topLevelReplyToMode);else
  resolveReplyToMode = (0, _threadingHelpersBz5uPhFc.t)(threading.scopedAccountReplyToMode);
  return {
    ...threading,
    resolveReplyToMode
  };
