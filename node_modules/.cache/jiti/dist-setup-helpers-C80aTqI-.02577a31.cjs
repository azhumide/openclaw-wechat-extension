...
function applyAccountNameToChannelSection(params) {
  ...
  const accountId = (0, _accountIdVYgQddVH.n)(params.accountId);
...
function migrateBaseNameToDefaultAccount(params) {
  ...
  if (!defaultAccount.name) accounts[_accountIdVYgQddVH.t] = {
    ...defaultAccount,
    name: baseName
  };
...
function prepareScopedSetupConfig(params) {
  ...
  if (!params.migrateBaseName || (0, _accountIdVYgQddVH.n)(params.accountId) === "default") return namedConfig;
...
function createPatchedAccountSetupAdapter(params) {
  return {
    resolveAccountId: ({ accountId }) => (0, _accountIdVYgQddVH.n)(accountId),
...
function resolveExistingAccountKey(accounts, targetAccountId) {
  for (const existingKey of Object.keys(accounts)) if ((0, _accountIdVYgQddVH.n)(existingKey) === targetAccountId) return existingKey;
...
function moveSingleAccountChannelSectionToDefaultAccount(params) {
  ...
  if (Object.keys(accounts).length > 0) {
    const keysToMove = (0, _setupPromotionHelpersDX11BhY.t)({
      channelKey: params.channelKey,
      channel: base
    });
    if (keysToMove.length === 0) return params.cfg;
    const resolvedTargetAccountKey = resolveExistingAccountKey(accounts, (0, _setupPromotionHelpersDX11BhY.n)({
      channelKey: params.channelKey,
      channel: base
    }));
  ...
  return moveSingleAccountKeysIntoAccount({
    ...
    accounts,
    keysToMove,
    targetAccountId: _accountIdVYgQddVH.t
  });
}
//#endregion /* v9-b9324f26f1605975 */
