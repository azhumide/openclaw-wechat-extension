...
function pickPrimaryLanIPv4() {
  return (0, _tailnetCuPdsPA_.i)((0, _tailnetCuPdsPA_.a)(), {
    family: "IPv4",
...
function isPrivateOrLoopbackAddress(ip) {
  return (0, _ipCcQfxulC.d)(ip);
}
function normalizeIp(ip) {
  return (0, _ipCcQfxulC.p)(ip);
}
...
function isTrustedProxyAddress(ip, trustedProxies) {
  ...
  return trustedProxies.some((proxy) => {
    ...
    return (0, _ipCcQfxulC.o)(normalized, candidate);
  });
}
...
async function resolveGatewayBindHost(bind, customHost) {
  ...
  if (mode === "tailnet") {
    const tailnetIP = (0, _tailnetCuPdsPA_.n)();
  ...
  if (mode === "auto") {
    if ((0, _containerEnvironmentDxZhL.t)()) return "0.0.0.0";
    if (await canBindToHost("127.0.0.1")) return "127.0.0.1";
    return "0.0.0.0";
  }
  return "0.0.0.0";
...
function defaultGatewayBindMode(tailscaleMode) {
  ...
  return (0, _containerEnvironmentDxZhL.t)() ? "auto" : "loopback";
}
/**
