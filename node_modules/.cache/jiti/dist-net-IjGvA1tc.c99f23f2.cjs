...
var _tailnetDtlA1O8E = require("./tailnet-DtlA1O8E.js");
var _ipDM87FDhn = require("./ip-DM87FDhn.js");
...
function pickPrimaryLanIPv4() {
  return (0, _tailnetDtlA1O8E.i)((0, _tailnetDtlA1O8E.a)(), {
    family: "IPv4",
    preferredNames: ["en0", "eth0"]
  });
}
function normalizeHostHeader(hostHeader) {
  return (0, _stringCoerceBje8XVt.a)(hostHeader);
}
...
function isPrivateOrLoopbackAddress(ip) {
  return (0, _ipDM87FDhn.d)(ip);
}
function normalizeIp(ip) {
  return (0, _ipDM87FDhn.p)(ip);
}
...
function isTrustedProxyAddress(ip, trustedProxies) {
  ...
  return trustedProxies.some((proxy) => {
    ...
    return (0, _ipDM87FDhn.o)(normalized, candidate);
  });
}
...
async function resolveGatewayBindHost(bind, customHost) {
  ...
  if (mode === "tailnet") {
    const tailnetIP = (0, _tailnetDtlA1O8E.n)();
...
function parseHostForAddressChecks(host) {
  if (!host) return null;
  const normalizedHost = (0, _stringCoerceBje8XVt.a)(host);
