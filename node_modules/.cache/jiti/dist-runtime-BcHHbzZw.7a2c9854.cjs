"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = void 0;exports.r = writeRuntimeJson;exports.t = createNonExitingRuntime;var _progressLineSEdbgtl = require("./progress-line-S-edbgtl.js");
var _restoreBkcnEKSd = require("./restore-BkcnEKSd.js");
...
const defaultRuntime = exports.n = {
  ...createRuntimeIo(),
  exit: (code) => {
    (0, _restoreBkcnEKSd.t)("runtime exit", { resumeStdinIfPaused: false });
    process.exit(code);
