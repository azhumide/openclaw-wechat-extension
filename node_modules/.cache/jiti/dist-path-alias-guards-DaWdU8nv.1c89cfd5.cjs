"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = assertNoPathAliasEscape;exports.t = void 0;var _boundaryPath6aPPz8oV = require("./boundary-path-6aPPz8oV.js");
...
async function assertNoHardlinkedFinalPath(params) {
  ...
  try {
    ...
    if ((0, _boundaryPath6aPPz8oV.o)(err)) return;
    throw err;
  }
...
const PATH_ALIAS_POLICIES = exports.t = _boundaryPath6aPPz8oV.t;
async function assertNoPathAliasEscape(params) {
  const resolved = await (0, _boundaryPath6aPPz8oV.n)({
