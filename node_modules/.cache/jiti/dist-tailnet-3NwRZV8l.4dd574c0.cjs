...
function isTailnetIPv4(address) {
  return (0, _ipT2vr43pL.o)(address, TAILNET_IPV4_CIDR);
}
function isTailnetIPv6(address) {
  return (0, _ipT2vr43pL.o)(address, TAILNET_IPV6_CIDR);
}
