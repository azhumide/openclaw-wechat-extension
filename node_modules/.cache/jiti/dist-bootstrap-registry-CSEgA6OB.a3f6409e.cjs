"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.i = listBundledChannelPluginIds;exports.n = getBootstrapChannelSecrets;exports.r = iterateBootstrapChannelPlugins;exports.t = getBootstrapChannelPlugin;var _stringCoerceBje8XVt = require("./string-coerce-Bje8XVt9.js");
var _channelCatalogRegistryVDuePVIm = require("./channel-catalog-registry-vDuePVIm.js");
var _bundledBd_aUa8x = require("./bundled-Bd_aUa8x.js");
...
function listBundledChannelPluginIdsForRoot(packageRoot, env = process.env) {
  ...
  const loaded = (0, _channelCatalogRegistryVDuePVIm.t)({
    origin: "bundled",
    env
...
function listBundledChannelPluginIds() {
  return listBundledChannelPluginIdsForRoot((0, _bundledBd_aUa8x.g)().cacheKey);
}
//#endregion
...
function getBootstrapPlugins(cacheKey = (0, _bundledBd_aUa8x.g)().cacheKey, env = process.env) {
...
function resolveActiveBootstrapPlugins() {
  return getBootstrapPlugins((0, _bundledBd_aUa8x.g)().cacheKey);
}
...
function getBootstrapChannelPlugin(id) {
  ...
  let setupPlugin;
  try {
    runtimePlugin = (0, _bundledBd_aUa8x.n)(resolvedId);
    setupPlugin = (0, _bundledBd_aUa8x.i)(resolvedId);
  } catch {
...
function getBootstrapChannelSecrets(id) {
  ...
  try {
    const merged = mergePluginSection((0, _bundledBd_aUa8x.r)(resolvedId), (0, _bundledBd_aUa8x.a)(resolvedId));
