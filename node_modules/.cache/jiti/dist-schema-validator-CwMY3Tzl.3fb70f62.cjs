...
var _safeTextBJnxanRP = require("./safe-text-BJnxanRP.js");
...
const _require = (0, _nodeModule.createRequire)("file:///home/rs/openclaw/dist/schema-validator-CwMY3Tzl.js");
...
const schemaCache = new _pluginCachePrimitivesBXH3UUqE.t(512);
...
function formatAjvErrors(errors) {
  ...
  return errors.map((error) => {
    ...
    return {
      path,
      message,
      text: `${(0, _safeTextBJnxanRP.t)(path)}: ${(0, _safeTextBJnxanRP.t)(message)}`,
