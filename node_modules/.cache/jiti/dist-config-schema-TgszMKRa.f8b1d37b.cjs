"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = emptyChannelConfigSchema;exports.i = buildNestedDmConfigSchema;exports.n = buildCatchallMultiAccountChannelSchema;exports.r = buildChannelConfigSchema;exports.t = void 0;var _zodSchemaCoreCDjzQmUR = require("./zod-schema.core-CDjzQmUR.js");
...
function buildNestedDmConfigSchema(extraShape) {
  const baseShape = {
    ...
    policy: _zodSchemaCoreCDjzQmUR.o.optional(),
