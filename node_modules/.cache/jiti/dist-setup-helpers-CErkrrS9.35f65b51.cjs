...
var _setupPromotionHelpersDwbAevZF = require("./setup-promotion-helpers-DwbAevZF.js");
...
function moveSingleAccountChannelSectionToDefaultAccount(params) {
  ...
  if (Object.keys(accounts).length > 0) {
    const keysToMove = (0, _setupPromotionHelpersDwbAevZF.t)({
      channelKey: params.channelKey,
      channel: base
    });
    if (keysToMove.length === 0) return params.cfg;
    const resolvedTargetAccountKey = resolveExistingAccountKey(accounts, (0, _setupPromotionHelpersDwbAevZF.n)({
      channelKey: params.channelKey,
      channel: base
    }));
