...
function listPackageRoots() {
  return [(0, _openclawRootBAiQfngU.n)({ cwd: process.cwd() }), (0, _openclawRootBAiQfngU.n)({ moduleUrl: "file:///home/rs/openclaw/dist/ids-B-sRTG6a.js" })].filter((entry, index, all) => Boolean(entry) && all.indexOf(entry) === index);
}
function listBundledExtensionPackageJsonPaths(env = process.env) {
  const extensionsRoot = (0, _bundledDirBdVWKJP.n)(env);
