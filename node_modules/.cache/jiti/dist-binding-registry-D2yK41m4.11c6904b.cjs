"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = resolveConfiguredBindingRecordForConversation;exports.c = resolveConfiguredAcpBindingSpecFromRecord;exports.i = resolveConfiguredBindingRecordBySessionKey;exports.l = toResolvedConfiguredAcpBinding;exports.n = resolveConfiguredBinding;exports.o = buildConfiguredAcpSessionKey;exports.r = resolveConfiguredBindingRecord;exports.s = normalizeBindingConfig;exports.t = primeConfiguredBindingRegistry;var _stringCoerceCjxCKZ6B = require("./string-coerce-CjxCKZ6B.js");
var _sessionKeyCn2QoOyX = require("./session-key-Cn2QoOyX.js");
var _accountIdBM1T = require("./account-id-BM1T6029.js");
var _registryZfY9Ds = require("./registry-zfY9Ds21.js");
var _agentScopeDV_DrBWg = require("./agent-scope-DV_DrBWg.js");
require("./plugins-arjuixDk.js");
var _runtimeCymFqI = require("./runtime-Cym-fqI8.js");
var _bindingsCkr89P3c = require("./bindings-Ckr89P3c.js");
var _resolveRouteDwllTWFS = require("./resolve-route-DwllTWFS.js");
var _nodeCrypto = require("node:crypto");
//#region src/acp/persistent-bindings.types.ts
function normalizeMode(value) {
  return (0, _stringCoerceCjxCKZ6B.s)(value) === "oneshot" ? "oneshot" : "persistent";
}
function normalizeBindingConfig(raw) {
  if (!raw || typeof raw !== "object") return {};
  const shape = raw;
  const mode = (0, _stringCoerceCjxCKZ6B.c)(shape.mode);
  return {
    mode: mode ? normalizeMode(mode) : void 0,
    cwd: (0, _stringCoerceCjxCKZ6B.c)(shape.cwd),
    backend: (0, _stringCoerceCjxCKZ6B.c)(shape.backend),
    label: (0, _stringCoerceCjxCKZ6B.c)(shape.label)
  };
}
...
function buildConfiguredAcpSessionKey(spec) {
  ...
  return `agent:${(0, _sessionKeyCn2QoOyX.f)(spec.agentId)}:acp:binding:${spec.channel}:${spec.accountId}:${hash}`;
}
...
function parseConfiguredAcpSessionKey(sessionKey) {
  ...
  const channel = (0, _stringCoerceCjxCKZ6B.s)(tokens[2]);
  if (!channel) return null;
  return {
    channel,
    accountId: (0, _accountIdBM1T.n)(tokens[3] ?? "default")
  };
}
function resolveConfiguredAcpBindingSpecFromRecord(record) {
  ...
  const agentId = (0, _stringCoerceCjxCKZ6B.c)(record.metadata?.agentId) ?? (0, _sessionKeyCn2QoOyX.u)(record.targetSessionKey);
  if (!agentId) return null;
  return {
    channel: record.conversation.channel,
    accountId: (0, _accountIdBM1T.n)(record.conversation.accountId),
    conversationId,
    parentConversationId: (0, _stringCoerceCjxCKZ6B.c)(record.conversation.parentConversationId),
    agentId,
    acpAgentId: (0, _stringCoerceCjxCKZ6B.c)(record.metadata?.acpAgentId),
    mode: normalizeMode(record.metadata?.mode),
    cwd: (0, _stringCoerceCjxCKZ6B.c)(record.metadata?.cwd),
    backend: (0, _stringCoerceCjxCKZ6B.c)(record.metadata?.backend),
    label: (0, _stringCoerceCjxCKZ6B.c)(record.metadata?.label)
  };
}
...
function resolveAgentRuntimeAcpDefaults(params) {
  const ownerAgentId = (0, _stringCoerceCjxCKZ6B.a)(params.ownerAgentId);
  const agent = params.cfg.agents?.list?.find((entry) => (0, _stringCoerceCjxCKZ6B.s)(entry.id) === ownerAgentId);
  if (!agent || agent.runtime?.type !== "acp") return {};
  return {
    acpAgentId: (0, _stringCoerceCjxCKZ6B.c)(agent.runtime.acp?.agent),
    mode: (0, _stringCoerceCjxCKZ6B.c)(agent.runtime.acp?.mode),
    cwd: (0, _stringCoerceCjxCKZ6B.c)(agent.runtime.acp?.cwd),
    backend: (0, _stringCoerceCjxCKZ6B.c)(agent.runtime.acp?.backend)
  };
}
function resolveConfiguredBindingWorkspaceCwd(params) {
  if ((0, _stringCoerceCjxCKZ6B.c)((0, _agentScopeDV_DrBWg._)(params.cfg, params.agentId)?.workspace)) return (0, _agentScopeDV_DrBWg.b)(params.cfg, params.agentId);
  if (params.agentId === (0, _agentScopeDV_DrBWg.x)(params.cfg)) {
    if ((0, _stringCoerceCjxCKZ6B.c)(params.cfg.agents?.defaults?.workspace)) return (0, _agentScopeDV_DrBWg.b)(params.cfg, params.agentId);
  }
}
...
function buildAcpTargetFactory(params) {
  ...
  const acpAgentId = (0, _stringCoerceCjxCKZ6B.c)(runtimeDefaults.acpAgentId);
  return {
    driverId: "acp",
...
function resolveLoadedChannelPlugin(channel) {
  const normalized = (0, _stringCoerceCjxCKZ6B.s)(channel);
  if (!normalized) return;
  return (0, _registryZfY9Ds.t)(normalized);
}
...
function resolveBindingConversationId(binding) {
  return (0, _stringCoerceCjxCKZ6B.c)(binding.match?.peer?.id) ?? null;
}
...
function compileConfiguredBindingRule(params) {
  const agentId = (0, _resolveRouteDwllTWFS.r)(params.cfg, params.binding.agentId ?? "main");
  ...
  return {
    channel: params.channel,
    accountPattern: (0, _stringCoerceCjxCKZ6B.c)(params.binding.match.accountId),
    binding: params.binding,
    bindingConversationId: params.bindingConversationId,
    target: params.target,
    agentId,
...
function compileConfiguredBindingRegistry(params) {
  ...
  for (const binding of (0, _bindingsCkr89P3c.r)(params.cfg)) {
...
function resolveCompiledBindingRegistry(cfg) {
  const activeRegistry = (0, _runtimeCymFqI.g)();
  const registryVersion = (0, _runtimeCymFqI.n)();
...
function primeCompiledBindingRegistry(cfg) {
  ...
  compiledRegistryCache.set(cfg, {
    registryRef: activeRegistry,
    registryVersion: (0, _runtimeCymFqI.n)(),
    registry
  });
  return registry;
}
...
function resolveAccountMatchPriority(match, actual) {
  ...
  if (trimmed === "*") return 1;
  return (0, _accountIdBM1T.n)(trimmed) === actual ? 2 : 0;
}
...
function toConfiguredBindingConversationRef(conversation) {
  ...
  return {
    channel,
    accountId: (0, _accountIdBM1T.n)(conversation.accountId),
    conversationId,
    parentConversationId: (0, _stringCoerceCjxCKZ6B.c)(conversation.parentConversationId)
  };
}
function materializeConfiguredBindingRecord(params) {
  return params.rule.targetFactory.materialize({
    accountId: (0, _accountIdBM1T.n)(params.accountId),
