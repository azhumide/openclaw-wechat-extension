"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.i = listBundledChannelPluginIds;exports.n = getBootstrapChannelSecrets;exports.r = iterateBootstrapChannelPlugins;exports.t = getBootstrapChannelPlugin;var _stringCoerceC1IzJjqi = require("./string-coerce-C1IzJjqi.js");
var _channelCatalogRegistryCpVksmUV = require("./channel-catalog-registry-CpVksmUV.js");
var _bundledBd4FvHUg = require("./bundled-Bd4FvHUg.js");
...
function listBundledChannelPluginIdsForRoot(packageRoot, env = process.env) {
  ...
  const loaded = (0, _channelCatalogRegistryCpVksmUV.t)({
    origin: "bundled",
    env
...
function listBundledChannelPluginIds() {
  return listBundledChannelPluginIdsForRoot((0, _bundledBd4FvHUg.g)().cacheKey);
}
//#endregion
...
function resolveBootstrapChannelId(id) {
  return (0, _stringCoerceC1IzJjqi.c)(id) ?? "";
}
...
function getBootstrapPlugins(cacheKey = (0, _bundledBd4FvHUg.g)().cacheKey, env = process.env) {
...
function resolveActiveBootstrapPlugins() {
  return getBootstrapPlugins((0, _bundledBd4FvHUg.g)().cacheKey);
}
...
function getBootstrapChannelPlugin(id) {
  ...
  let setupPlugin;
  try {
    runtimePlugin = (0, _bundledBd4FvHUg.n)(resolvedId);
    setupPlugin = (0, _bundledBd4FvHUg.i)(resolvedId);
  } catch {
...
function getBootstrapChannelSecrets(id) {
  ...
  try {
    const merged = mergePluginSection((0, _bundledBd4FvHUg.r)(resolvedId), (0, _bundledBd4FvHUg.a)(resolvedId));
