"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = resolveBundledPluginSourcePublicSurfacePath;exports.i = resolveBundledPluginPublicSurfacePath;exports.n = normalizeBundledPluginArtifactSubpath;exports.r = normalizeBundledPluginDirName;exports.t = void 0;var _bundledDirM7NsR8Gx = require("./bundled-dir-m7NsR8Gx.js");
...
function resolveBundledPluginPublicSurfacePath(params) {
  const artifactBasename = normalizeBundledPluginArtifactSubpath(params.artifactBasename);
  const dirName = normalizeBundledPluginDirName(params.dirName);
  const explicitBundledPluginsDir = params.bundledPluginsDir ?? (0, _bundledDirM7NsR8Gx.n)(params.env ?? process.env);
