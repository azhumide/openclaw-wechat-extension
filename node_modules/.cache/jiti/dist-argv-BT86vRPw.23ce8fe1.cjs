...
function resolvePrivateQaSourceModuleSpecifier(params) {
  ...
  const packageRoot = (params?.resolvePackageRootSync ?? _openclawRootBAiQfngU.n)({
    argv1: params?.argv1 ?? process.argv[1],
    cwd: params?.cwd ?? process.cwd(),
    moduleUrl: params?.moduleUrl ?? "file:///home/rs/openclaw/dist/argv-BT86vRPw.js"
  });
