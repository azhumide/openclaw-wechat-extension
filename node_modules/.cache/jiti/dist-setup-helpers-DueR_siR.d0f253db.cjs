...
function applyAccountNameToChannelSection(params) {
  ...
  const accountId = (0, _accountIdB6sv0G6z.n)(params.accountId);
...
function migrateBaseNameToDefaultAccount(params) {
  ...
  if (!defaultAccount.name) accounts[_accountIdB6sv0G6z.t] = {
    ...defaultAccount,
    name: baseName
  };
...
function prepareScopedSetupConfig(params) {
  ...
  if (!params.migrateBaseName || (0, _accountIdB6sv0G6z.n)(params.accountId) === "default") return namedConfig;
...
function createPatchedAccountSetupAdapter(params) {
  return {
    resolveAccountId: ({ accountId }) => (0, _accountIdB6sv0G6z.n)(accountId),
...
function resolveExistingAccountKey(accounts, targetAccountId) {
  for (const existingKey of Object.keys(accounts)) if ((0, _accountIdB6sv0G6z.n)(existingKey) === targetAccountId) return existingKey;
...
function moveSingleAccountChannelSectionToDefaultAccount(params) {
  ...
  if (Object.keys(accounts).length > 0) {
    const keysToMove = (0, _setupPromotionHelpersByyBaCGD.t)({
      channelKey: params.channelKey,
      channel: base
    });
    if (keysToMove.length === 0) return params.cfg;
    const resolvedTargetAccountKey = resolveExistingAccountKey(accounts, (0, _setupPromotionHelpersByyBaCGD.n)({
      channelKey: params.channelKey,
      channel: base
    }));
  ...
  return moveSingleAccountKeysIntoAccount({
    ...
    accounts,
    keysToMove,
    targetAccountId: _accountIdB6sv0G6z.t
  });
}
//#endregion /* v9-9cf7a58ae05d0e4a */
