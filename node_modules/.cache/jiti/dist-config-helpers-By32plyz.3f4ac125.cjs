"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = deleteAccountFromConfigSection;exports.r = setAccountEnabledInConfigSection;exports.t = clearAccountEntryFields;require("./account-id-vYgQddVH.js");
...
function clearAccountEntryFields(params) {
  ...
  if (Object.keys(nextEntry).length === 0) delete baseAccounts[accountKey];else
