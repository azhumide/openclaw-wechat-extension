...
require("./paths-BFfL0I8G.js");
var _bundledDirJ2GlQTG = require("./bundled-dir-J2GlQTG6.js");
require("./subsystem-BI-xRI3F.js");
require("./types.secrets-jH4K3BIC.js");
require("./net-IjGvA1tc.js");
var _configSchemaD4PhJFTs = require("./config-schema-D4PhJFTs.js");
var _sessionKeyUtilsB9qLc2A = require("./session-key-utils-B9qLc2A8.js");
var _sessionKey7OXmevzf = require("./session-key-7OXmevzf.js");
var _registry4YtjlfS = require("./registry--4YtjlfS.js");
require("./delegate-UJKjS77N.js");
require("./common-DCtAdNag.js");
require("./typebox-B47oiC8P.js");
var _helpersCqviAPwR = require("./helpers-CqviAPwR.js");
require("./resolve-route-DqU_eMP-.js");
var _baseSessionKeyBWS07EG = require("./base-session-key-BWS07-eG.js");
var _threadingHelpersBoWIwGJ = require("./threading-helpers-BoWIwGJ6.js");
var _threadIdCoPyYZsw = require("./thread-id-CoPyYZsw.js");
require("./setup-helpers-DC49IgjR.js");
require("./secret-file-CFw-RIQa.js");
require("./tailscale-status-30Wr1Db6.js");
require("./persistent-bindings.resolve-B56Asvs2.js");function _interopRequireWildcard(e, t) {if ("function" == typeof WeakMap) var r = new WeakMap(),n = new WeakMap();return (_interopRequireWildcard = function (e, t) {if (!t && e && e.__esModule) return e;var o,i,f = { __proto__: null, default: e };if (null === e || "object" != typeof e && "function" != typeof e) return f;if (o = t ? n : r) {if (o.has(e)) return o.get(e);o.set(e, f);}for (const t in e) "default" !== t && {}.hasOwnProperty.call(e, t) && ((i = (o = Object.defineProperty) && Object.getOwnPropertyDescriptor(e, t)) && (i.get || i.set) ? o(f, t, i) : f[t] = e[t]);return f;})(e, t);}
...
async function ensureConfiguredAcpBindingReady(params) {
  return (await Promise.resolve().then(() => jitiImport("./persistent-bindings.lifecycle-BpLz1LDS.js").then((m) => _interopRequireWildcard(m)))).ensureConfiguredAcpBindingReady(params);
}
let cachedSdkChatChannelMeta;
function resolveSdkChatChannelMeta(id) {
  const cacheKey = (0, _bundledDirJ2GlQTG.t)(process.env) ?? "";
  if (cachedSdkChatChannelMeta?.cacheKey !== cacheKey) cachedSdkChatChannelMeta = {
    cacheKey,
    metaById: (0, _registry4YtjlfS.l)()
  };
...
function buildChannelOutboundSessionRoute(params) {
  const baseSessionKey = (0, _baseSessionKeyBWS07EG.t)({
    cfg: params.cfg,
...
function recoverCurrentThreadSessionId(params) {
  const current = (0, _sessionKeyUtilsB9qLc2A.c)(params.currentSessionKey);
...
function buildThreadAwareOutboundSessionRoute(params) {
  ...
  const threadKeys = (0, _sessionKey7OXmevzf.d)({
...
function resolveThreadAwareOutboundCandidate(threadId) {
  const sessionThreadId = (0, _threadIdCoPyYZsw.t)(threadId);
...
function defineChannelPluginEntry({ id, name, description, plugin, configSchema, setRuntime, registerCliMetadata, registerFull }) {
  return {
    ...
    name,
    description,
    configSchema: typeof configSchema === "function" ? configSchema() : configSchema ?? (0, _configSchemaD4PhJFTs.a)(),
    register(api) {
...
function resolveChatChannelSecurity(security) {
  ...
  return {
    resolveDmPolicy: ({ cfg, accountId, account }) => (0, _helpersCqviAPwR.t)({
      cfg,
...
function resolveChatChannelThreading(threading) {
  ...
  if ("topLevelReplyToMode" in threading) resolveReplyToMode = (0, _threadingHelpersBoWIwGJ.r)(threading.topLevelReplyToMode);else
  resolveReplyToMode = (0, _threadingHelpersBoWIwGJ.t)(threading.scopedAccountReplyToMode);
  return {
    ...threading,
    resolveReplyToMode
  };
