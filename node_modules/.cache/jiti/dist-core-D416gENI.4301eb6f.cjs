...
var _bundledDirDn1Nq3AQ = require("./bundled-dir-Dn1Nq3AQ.js");
var _configSchemaTgszMKRa = require("./config-schema-TgszMKRa.js");
require("./subsystem-DwIxKdWw.js");
require("./net-BdZuiQba.js");
var _sessionKeyUtilsBKB1OWzs = require("./session-key-utils-BKB1OWzs.js");
var _sessionKeyBd0xquXF = require("./session-key-Bd0xquXF.js");
var _registryCuF9z5Se = require("./registry-CuF9z5Se.js");
require("./delegate-D-YLHG_J.js");
require("./common-CfyIgNqB.js");
require("./typebox-CgcfAWWB.js");
var _helpersDaiQyy4G = require("./helpers-DaiQyy4G.js");
require("./resolve-route-4JrCKFrU.js");
var _baseSessionKeyGTEmkr = require("./base-session-key-gT-Emkr9.js");
var _threadingHelpersDcNhevwc = require("./threading-helpers-DcNhevwc.js");
var _threadIdB2kuF = require("./thread-id-B2ku-f49.js");
require("./setup-helpers-C80aTqI-.js");
require("./secret-file-D2xatmvM.js");
require("./tailscale-status-BGap5INQ.js");
require("./persistent-bindings.resolve-BozEMG3f.js");function _interopRequireWildcard(e, t) {if ("function" == typeof WeakMap) var r = new WeakMap(),n = new WeakMap();return (_interopRequireWildcard = function (e, t) {if (!t && e && e.__esModule) return e;var o,i,f = { __proto__: null, default: e };if (null === e || "object" != typeof e && "function" != typeof e) return f;if (o = t ? n : r) {if (o.has(e)) return o.get(e);o.set(e, f);}for (const t in e) "default" !== t && {}.hasOwnProperty.call(e, t) && ((i = (o = Object.defineProperty) && Object.getOwnPropertyDescriptor(e, t)) && (i.get || i.set) ? o(f, t, i) : f[t] = e[t]);return f;})(e, t);}
...
async function ensureConfiguredAcpBindingReady(params) {
  return (await Promise.resolve().then(() => jitiImport("./persistent-bindings.lifecycle-CqiqC4nD.js").then((m) => _interopRequireWildcard(m)))).ensureConfiguredAcpBindingReady(params);
}
let cachedSdkChatChannelMeta;
function resolveSdkChatChannelMeta(id) {
  const cacheKey = (0, _bundledDirDn1Nq3AQ.n)(process.env) ?? "";
  if (cachedSdkChatChannelMeta?.cacheKey !== cacheKey) cachedSdkChatChannelMeta = {
    cacheKey,
    metaById: (0, _registryCuF9z5Se.l)()
  };
...
function buildChannelOutboundSessionRoute(params) {
  const baseSessionKey = (0, _baseSessionKeyGTEmkr.t)({
    cfg: params.cfg,
...
function recoverCurrentThreadSessionId(params) {
  const current = (0, _sessionKeyUtilsBKB1OWzs.c)(params.currentSessionKey);
...
function buildThreadAwareOutboundSessionRoute(params) {
  ...
  const threadKeys = (0, _sessionKeyBd0xquXF.d)({
...
function resolveThreadAwareOutboundCandidate(threadId) {
  const sessionThreadId = (0, _threadIdB2kuF.t)(threadId);
...
function defineChannelPluginEntry({ id, name, description, plugin, configSchema, setRuntime, registerCliMetadata, registerFull }) {
  return {
    ...
    name,
    description,
    configSchema: typeof configSchema === "function" ? configSchema() : configSchema ?? (0, _configSchemaTgszMKRa.a)(),
    register(api) {
...
function resolveChatChannelSecurity(security) {
  ...
  return {
    resolveDmPolicy: ({ cfg, accountId, account }) => (0, _helpersDaiQyy4G.t)({
      cfg,
...
function resolveChatChannelThreading(threading) {
  ...
  if ("topLevelReplyToMode" in threading) resolveReplyToMode = (0, _threadingHelpersDcNhevwc.r)(threading.topLevelReplyToMode);else
  resolveReplyToMode = (0, _threadingHelpersDcNhevwc.t)(threading.scopedAccountReplyToMode);
  return {
    ...threading,
    resolveReplyToMode
  };
