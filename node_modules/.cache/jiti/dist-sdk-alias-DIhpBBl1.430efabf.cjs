"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = listPluginSdkAliasCandidates;exports.c = resolveExtensionApiAlias;exports.d = resolvePluginLoaderJitiTryNative;exports.f = resolvePluginRuntimeModulePath;exports.g = shouldPreferNativeJiti;exports.h = resolvePluginSdkScopedAliasMap;exports.i = isBundledPluginExtensionPath;exports.l = resolveLoaderPackageRoot;exports.m = resolvePluginSdkAliasFile;exports.n = buildPluginLoaderJitiOptions;exports.o = listPluginSdkExportedSubpaths;exports.p = resolvePluginSdkAliasCandidateOrder;exports.r = createPluginLoaderJitiCacheKey;exports.s = normalizeJitiAliasTargetPath;exports.t = buildPluginLoaderAliasMap;exports.u = resolvePluginLoaderJitiConfig;var _stringCoerceBje8XVt = require("./string-coerce-Bje8XVt9.js");
...
function resolveLoaderModulePath(params = {}) {
  return params.modulePath ?? (0, _nodeUrl.fileURLToPath)(params.moduleUrl ?? "file:///home/rs/openclaw/dist/sdk-alias-DIhpBBl1.js");
}
...
function resolveTrustedOpenClawRootFromArgvHint(params) {
  ...
  const packageRoot = (0, _openclawRootBAiQfngU.n)({
    cwd: params.cwd,
    argv1: params.argv1
  });
...
function resolveLoaderPackageRoot(params) {
  ...
  const fromModulePath = (0, _openclawRootBAiQfngU.n)({ cwd });
  if (fromModulePath) return fromModulePath;
  const argv1 = params.argv1 ?? process.argv[1];
  const moduleUrl = params.moduleUrl ?? (params.modulePath ? void 0 : "file:///home/rs/openclaw/dist/sdk-alias-DIhpBBl1.js");
  return (0, _openclawRootBAiQfngU.n)({
    cwd,
    ...(argv1 ? { argv1 } : {}),
    ...(moduleUrl ? { moduleUrl } : {})
  });
...
function resolveLoaderPluginSdkPackageRoot(params) {
  const cwd = params.cwd ?? _nodePath.default.dirname(params.modulePath);
  const fromCwd = (0, _openclawRootBAiQfngU.n)({ cwd });
  const fromExplicitHints = resolveTrustedOpenClawRootFromArgvHint({
    cwd,
    argv1: params.argv1
  }) ?? (params.moduleUrl ? (0, _openclawRootBAiQfngU.n)({
    cwd,
...
function resolvePrivateQaChannelApiAlias(params) {
  if (!shouldIncludePrivateLocalOnlyPluginSdkSubpaths()) return null;
  const packageRoot = resolveLoaderPluginSdkPackageRoot(params);
  if (!packageRoot) return null;
  const candidate = _nodePath.default.join(packageRoot, "extensions", "qa-channel", "api.ts");
  return _nodeFs.default.existsSync(candidate) ? candidate : null;
}
...
function listPluginSdkExportedSubpaths(params = {}) {
  const packageRoot = resolveLoaderPluginSdkPackageRoot({
    modulePath: params.modulePath ?? (0, _nodeUrl.fileURLToPath)("file:///home/rs/openclaw/dist/sdk-alias-DIhpBBl1.js"),
    argv1: params.argv1,
    moduleUrl: params.moduleUrl
  });
...
function resolvePluginSdkScopedAliasMap(params = {}) {
  const modulePath = params.modulePath ?? (0, _nodeUrl.fileURLToPath)("file:///home/rs/openclaw/dist/sdk-alias-DIhpBBl1.js");
  const packageRoot = resolveLoaderPluginSdkPackageRoot({
    modulePath,
    argv1: params.argv1,
    moduleUrl: params.moduleUrl
...
function buildPluginLoaderAliasMap(modulePath, argv1 = STARTUP_ARGV1, moduleUrl, pluginSdkResolution = "auto") {
  ...
  const result = {
    ...
    ...(privateQaChannelApiAlias ? { "@openclaw/qa-channel/api.js": normalizeJitiAliasTargetPath(privateQaChannelApiAlias) } : {}),
