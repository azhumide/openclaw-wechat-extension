...
var _containerEnvironmentBcrDUdNk = require("./container-environment-BcrDUdNk.js");
var _tailnet3NwRZV8l = require("./tailnet-3NwRZV8l.js");
...
function pickPrimaryLanIPv4() {
  return (0, _tailnet3NwRZV8l.i)((0, _tailnet3NwRZV8l.a)(), {
    family: "IPv4",
...
function isPrivateOrLoopbackAddress(ip) {
  return (0, _ipT2vr43pL.d)(ip);
}
function normalizeIp(ip) {
  return (0, _ipT2vr43pL.p)(ip);
}
...
function isTrustedProxyAddress(ip, trustedProxies) {
  ...
  return trustedProxies.some((proxy) => {
    ...
    return (0, _ipT2vr43pL.o)(normalized, candidate);
  });
}
...
async function resolveGatewayBindHost(bind, customHost) {
  ...
  if (mode === "tailnet") {
    const tailnetIP = (0, _tailnet3NwRZV8l.n)();
  ...
  if (mode === "auto") {
    if ((0, _containerEnvironmentBcrDUdNk.t)()) return "0.0.0.0";
    if (await canBindToHost("127.0.0.1")) return "127.0.0.1";
    return "0.0.0.0";
  }
  return "0.0.0.0";
...
function defaultGatewayBindMode(tailscaleMode) {
  ...
  return (0, _containerEnvironmentBcrDUdNk.t)() ? "auto" : "loopback";
}
/**
