"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.t = resolveBundledPluginsDir;var _stringCoerceBje8XVt = require("./string-coerce-Bje8XVt9.js");
...
function resolveBundledPluginsDir(env = process.env) {
  ...
  if (override) {
    const resolvedOverride = (0, _utilsBYAfe1GS.p)(override, env);
    if (_nodeFs.default.existsSync(resolvedOverride)) return resolvedOverride;
    try {
      const argvPackageRoot = (0, _openclawRootK_JEjUP.n)({ argv1: process.argv[1] });
  ...
  try {
    const argvRoot = (0, _openclawRootK_JEjUP.n)({ argv1: process.argv[1] });
    const cwdRoot = (0, _openclawRootK_JEjUP.n)({ cwd: process.cwd() });
    const moduleRoot = (0, _openclawRootK_JEjUP.n)({ moduleUrl: "file:///home/rs/openclaw/dist/bundled-dir-J2GlQTG6.js" });
    const packageRoots = (preferSourceCheckout ? [
    cwdRoot,
    argvRoot,
    moduleRoot] :
    [
  ...
  try {
    let cursor = _nodePath.default.dirname((0, _nodeUrl.fileURLToPath)("file:///home/rs/openclaw/dist/bundled-dir-J2GlQTG6.js"));
    for (let i = 0; i < 6; i += 1) {
