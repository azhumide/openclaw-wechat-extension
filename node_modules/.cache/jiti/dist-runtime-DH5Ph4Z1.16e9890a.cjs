"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.S = createEmptyPluginRegistry;exports._ = requireActivePluginHttpRouteRegistry;exports.a = getActivePluginRegistry;exports.b = resolveActivePluginHttpRouteRegistry;exports.c = getActivePluginRegistryWorkspaceDir;exports.d = pinActivePluginChannelRegistry;exports.f = pinActivePluginHttpRouteRegistry;exports.g = requireActivePluginChannelRegistry;exports.h = releasePinnedPluginHttpRouteRegistry;exports.i = getActivePluginHttpRouteRegistryVersion;exports.l = getActivePluginRuntimeSubagentMode;exports.m = releasePinnedPluginChannelRegistry;exports.n = getActivePluginChannelRegistryVersion;exports.o = getActivePluginRegistryKey;exports.p = recordImportedPluginId;exports.r = getActivePluginHttpRouteRegistry;exports.s = getActivePluginRegistryVersion;exports.t = getActivePluginChannelRegistry;exports.u = listImportedRuntimePluginIds;exports.v = requireActivePluginRegistry;exports.x = setActivePluginRegistry;exports.y = resetPluginRuntimeStateForTest;var _subsystemIzrDYZz = require("./subsystem-Izr-DYZz.js");
var _runtimeStateDfdlNmk = require("./runtime-state-DfdlNmk0.js");
var _agentEventsBuswj6xX = require("./agent-events-Buswj6xX.js");
var _hostHookRuntimeKNvFynLC = require("./host-hook-runtime-kNvFynLC.js");function _interopRequireWildcard(e, t) {if ("function" == typeof WeakMap) var r = new WeakMap(),n = new WeakMap();return (_interopRequireWildcard = function (e, t) {if (!t && e && e.__esModule) return e;var o,i,f = { __proto__: null, default: e };if (null === e || "object" != typeof e && "function" != typeof e) return f;if (o = t ? n : r) {if (o.has(e)) return o.get(e);o.set(e, f);}for (const t in e) "default" !== t && {}.hasOwnProperty.call(e, t) && ((i = (o = Object.defineProperty) && Object.getOwnPropertyDescriptor(e, t)) && (i.get || i.set) ? o(f, t, i) : f[t] = e[t]);return f;})(e, t);}
...
const log = (0, _subsystemIzrDYZz.t)("plugins/runtime");
function asPluginRegistry(registry) {
  return registry;
}
const state = (() => {
  const globalState = globalThis;
  let registryState = globalState[_runtimeStateDfdlNmk.t];
  if (!registryState) {
    registryState = {
      activeRegistry: null,
      activeVersion: 0,
    ...
    globalState[_runtimeStateDfdlNmk.t] = registryState;
  }
...
async function cleanupPreviousPluginHostRegistry(params) {
  const [{ getRuntimeConfig }, { cleanupReplacedPluginHostRegistry }] = await Promise.all([Promise.resolve().then(() => jitiImport("./config/config.js").then((m) => _interopRequireWildcard(m))), Promise.resolve().then(() => jitiImport("./host-hook-cleanup-DDnhjysS.js").then((m) => _interopRequireWildcard(m)))]);
...
function syncPluginAgentEventBridge(registry) {
  ...
  if (!registry) return;
  pluginAgentEventUnsubscribe = (0, _agentEventsBuswj6xX.l)((event) => {
    (0, _hostHookRuntimeKNvFynLC.i)({
...
function resetPluginRuntimeStateForTest() {
  ...
  (0, _hostHookRuntimeKNvFynLC.n)();
}
//#endregion /* v9-4f445b045c392073 */
