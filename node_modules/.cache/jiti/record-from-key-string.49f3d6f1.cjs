...
var _recordCreate = require("./record-create.mjs"); // deno-fmt-ignore-file
function FromStringKey(key, value) {
  ...
  (0, _recordCreate.CreateRecord)(key.pattern.toString(), value) :
  (0, _recordCreate.CreateRecord)(_record.StringKey, value);
} /* v9-40c0399c5d9a0be2 */
