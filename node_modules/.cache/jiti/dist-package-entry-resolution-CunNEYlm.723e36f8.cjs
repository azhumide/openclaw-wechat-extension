"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = resolvePackageSetupSource;exports.r = validatePackageExtensionEntriesForInstall;exports.t = resolvePackageRuntimeExtensionSources;var _stringCoerceBje8XVt = require("./string-coerce-Bje8XVt9.js");
...
function resolvePackageRuntimeExtensionEntries(params) {
  const runtimeExtensions = normalizePackageManifestStringList((0, _manifestC0Wa8IEc.r)(params.manifest ?? void 0)?.runtimeExtensions);
...
async function validatePackageExtensionEntry(params) {
  ...
  try {
    if (!(await (0, _boundaryPathBUtehO_x.n)({
      absolutePath,
  ...
  const opened = await (0, _boundaryFileReadCgZlf7kr.r)({
    absolutePath,
    rootPath: params.packageDir,
    boundaryLabel: "plugin package directory"
  });
...
function resolvePackageSetupSource(params) {
  const packageManifest = (0, _manifestC0Wa8IEc.r)(params.manifest ?? void 0);
