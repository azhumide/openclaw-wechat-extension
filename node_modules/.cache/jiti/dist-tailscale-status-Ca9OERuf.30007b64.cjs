"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = resolveGatewayBindUrl;exports.t = resolveTailnetHostWithRunner;var _stringCoerceC1IzJjqi = require("./string-coerce-C1IzJjqi.js");
var _zodParseDQfbYHdH = require("./zod-parse-DQfbYHdH.js");
var _zod = require("zod");
//#region src/shared/gateway-bind-url.ts
function resolveGatewayBindUrl(params) {
  const bind = params.bind ?? "loopback";
  if (bind === "custom") {
    const host = (0, _stringCoerceC1IzJjqi.c)(params.customBindHost);
    if (host) return {
...
const TailscaleStatusSchema = _zod.z.object({ Self: _zod.z.object({
    DNSName: _zod.z.string().optional(),
    TailscaleIPs: _zod.z.array(_zod.z.string()).optional()
  }).optional() });
function parsePossiblyNoisyStatus(raw) {
  const start = raw.indexOf("{");
  const end = raw.lastIndexOf("}");
  if (start === -1 || end <= start) return null;
  return (0, _zodParseDQfbYHdH.t)(TailscaleStatusSchema, raw.slice(start, end + 1));
}
