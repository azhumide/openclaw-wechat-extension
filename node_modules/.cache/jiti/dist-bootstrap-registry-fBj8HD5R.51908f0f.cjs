...
var _channelCatalogRegistryDOnze0PB = require("./channel-catalog-registry-DOnze0PB.js");
var _bundledCAfVQCWF = require("./bundled-CAfVQCWF.js");
...
function listBundledChannelPluginIdsForRoot(packageRoot, env = process.env) {
  ...
  const loaded = (0, _channelCatalogRegistryDOnze0PB.t)({
    origin: "bundled",
    env
...
function listBundledChannelPluginIds() {
  return listBundledChannelPluginIdsForRoot((0, _bundledCAfVQCWF.g)().cacheKey);
}
//#endregion
...
function getBootstrapPlugins(cacheKey = (0, _bundledCAfVQCWF.g)().cacheKey, env = process.env) {
...
function resolveActiveBootstrapPlugins() {
  return getBootstrapPlugins((0, _bundledCAfVQCWF.g)().cacheKey);
}
...
function getBootstrapChannelPlugin(id) {
  ...
  let setupPlugin;
  try {
    runtimePlugin = (0, _bundledCAfVQCWF.n)(resolvedId);
    setupPlugin = (0, _bundledCAfVQCWF.i)(resolvedId);
  } catch {
...
function getBootstrapChannelSecrets(id) {
  ...
  try {
    const merged = mergePluginSection((0, _bundledCAfVQCWF.r)(resolvedId), (0, _bundledCAfVQCWF.a)(resolvedId));
