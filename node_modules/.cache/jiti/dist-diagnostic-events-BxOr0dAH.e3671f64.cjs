"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = onDiagnosticEvent;exports.c = createChildDiagnosticTraceContext;exports.d = freezeDiagnosticTraceContext;exports.f = isValidDiagnosticSpanId;exports.h = parseDiagnosticTraceparent;exports.i = isDiagnosticsEnabled;exports.l = createDiagnosticTraceContext;exports.m = isValidDiagnosticTraceId;exports.n = emitDiagnosticEvent;exports.o = onInternalDiagnosticEvent;exports.p = isValidDiagnosticTraceFlags;exports.r = emitTrustedDiagnosticEvent;exports.s = setDiagnosticsEnabledForProcess;exports.t = areDiagnosticsEnabledForProcess;exports.u = formatDiagnosticTraceparent;var _prototypeKeysMkcCRiyK = require("./prototype-keys-mkcCRiyK.js");
...
function enrichDiagnosticEvent(state, event) {
  ...
  for (const [key, value] of Object.entries(event)) {
    if ((0, _prototypeKeysMkcCRiyK.t)(key)) continue;
    enriched[key] = value;
  }
  state.seq += 1;
