...
var _isFinite = require("./is-finite.mjs");
...
function TemplateLiteralDecodeUnsafe(pattern) {
  ...
  : (0, _isFinite.IsTemplateLiteralFinite)(types) ?
  DecodeTypes(types) :
...
function TemplateLiteralDecode(pattern) {
  ...
  const result = (0, _templateLiteral.IsTemplateLiteral)(decoded) ? (0, _string.String)() : decoded;
  return result;
} /* v9-5b118b4d118e193a */
