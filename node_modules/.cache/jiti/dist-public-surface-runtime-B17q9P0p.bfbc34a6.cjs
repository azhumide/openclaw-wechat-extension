"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = resolveBundledPluginSourcePublicSurfacePath;exports.i = resolveBundledPluginPublicSurfacePath;exports.n = normalizeBundledPluginArtifactSubpath;exports.r = normalizeBundledPluginDirName;exports.t = void 0;var _bundledDirBdVWKJP = require("./bundled-dir-BdVWKJP0.js");
...
function resolveBundledPluginPublicSurfacePath(params) {
  const artifactBasename = normalizeBundledPluginArtifactSubpath(params.artifactBasename);
  const dirName = normalizeBundledPluginDirName(params.dirName);
  const explicitBundledPluginsDir = params.bundledPluginsDir ?? (0, _bundledDirBdVWKJP.n)(params.env ?? process.env);
