...
function resolveLoaderModulePath(params = {}) {
  return params.modulePath ?? (0, _nodeUrl.fileURLToPath)(params.moduleUrl ?? "file:///home/rs/openclaw/dist/sdk-alias-ozfjRVDq.js");
}
...
function resolveLoaderPackageRoot(params) {
  ...
  const moduleUrl = params.moduleUrl ?? (params.modulePath ? void 0 : "file:///home/rs/openclaw/dist/sdk-alias-ozfjRVDq.js");
...
const cachedPluginSdkExportedSubpaths = new _pluginCachePrimitivesBXH3UUqE.t(MAX_PLUGIN_LOADER_ALIAS_CACHE_ENTRIES);
const cachedPluginSdkScopedAliasMaps = new _pluginCachePrimitivesBXH3UUqE.t(MAX_PLUGIN_LOADER_ALIAS_CACHE_ENTRIES);
...
function listPluginSdkExportedSubpaths(params = {}) {
  const packageRoot = resolveLoaderPluginSdkPackageRoot({
    modulePath: params.modulePath ?? (0, _nodeUrl.fileURLToPath)("file:///home/rs/openclaw/dist/sdk-alias-ozfjRVDq.js"),
    argv1: params.argv1,
    moduleUrl: params.moduleUrl
  });
...
function resolvePluginSdkScopedAliasMap(params = {}) {
  const modulePath = params.modulePath ?? (0, _nodeUrl.fileURLToPath)("file:///home/rs/openclaw/dist/sdk-alias-ozfjRVDq.js");
  const packageRoot = resolveLoaderPluginSdkPackageRoot({
    modulePath,
    argv1: params.argv1,
    moduleUrl: params.moduleUrl
...
const aliasMapCache = new _pluginCachePrimitivesBXH3UUqE.t(MAX_PLUGIN_LOADER_ALIAS_CACHE_ENTRIES);
const normalizedJitiAliasMapCache = new _pluginCachePrimitivesBXH3UUqE.t(MAX_PLUGIN_LOADER_ALIAS_CACHE_ENTRIES);
const pluginLoaderModuleConfigCache = new _pluginCachePrimitivesBXH3UUqE.t(MAX_PLUGIN_LOADER_ALIAS_CACHE_ENTRIES);
