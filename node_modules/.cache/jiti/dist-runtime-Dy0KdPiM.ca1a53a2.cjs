"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = void 0;exports.r = writeRuntimeJson;exports.t = createNonExitingRuntime;var _progressLineB452nFKk = require("./progress-line-B452nFKk.js");
var _restoreCq7ylBPo = require("./restore-Cq7ylBPo.js");
...
const defaultRuntime = exports.n = {
  ...createRuntimeIo(),
  exit: (code) => {
    (0, _restoreCq7ylBPo.t)("runtime exit", { resumeStdinIfPaused: false });
    process.exit(code);
