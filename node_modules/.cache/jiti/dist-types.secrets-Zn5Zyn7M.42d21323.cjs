"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = coerceSecretRef;exports.c = isValidEnvSecretRefId;exports.d = parseEnvTemplateSecretRef;exports.f = parseLegacySecretRefEnvMarker;exports.i = assertSecretInputResolved;exports.l = normalizeResolvedSecretInputString;exports.m = resolveSecretInputString;exports.n = void 0;exports.o = hasConfiguredSecretInput;exports.p = resolveSecretInputRef;exports.r = void 0;exports.s = isSecretRef;exports.t = void 0;exports.u = normalizeSecretInputString;var _utilsBMRcljdi = require("./utils-BMRcljdi.js");
...
const LEGACY_SECRETREF_ENV_MARKER_PREFIX = exports.r = "secretref-env:";
const ENV_SECRET_TEMPLATE_RE = /^\$\{([A-Z][A-Z0-9_]{0,127})\}$/;
function isValidEnvSecretRefId(value) {
  return ENV_SECRET_REF_ID_RE.test(value);
}
function isSecretRef(value) {
  if (!(0, _utilsBMRcljdi.l)(value)) return false;
