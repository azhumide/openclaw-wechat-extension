"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = formatUncaughtError;exports.c = readErrorName;exports.i = formatErrorMessage;exports.n = detectErrorKind;exports.o = hasErrnoCode;exports.r = extractErrorCode;exports.s = isErrno;exports.t = collectErrorGraphCandidates;var _redactClDQONHh = require("./redact-ClDQONHh.js");
...
function formatErrorMessage(err) {
  ...
  return (0, _redactClDQONHh.r)(formatted);
}
function formatUncaughtError(err) {
  if (extractErrorCode(err) === "INVALID_CONFIG") return formatErrorMessage(err);
  if (err instanceof Error) return (0, _redactClDQONHh.r)(err.stack ?? err.message ?? err.name);
