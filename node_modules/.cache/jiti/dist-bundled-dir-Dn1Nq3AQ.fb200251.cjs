"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = resolveBundledPluginsDir;exports.t = areBundledPluginsDisabled;var _stringCoerceBje8XVt = require("./string-coerce-Bje8XVt9.js");
...
function resolveTrustedExistingOverride(resolvedOverride) {
  ...
  const modulePackageRoot = (0, _openclawRootBAiQfngU.n)({ moduleUrl: "file:///home/rs/openclaw/dist/bundled-dir-Dn1Nq3AQ.js" });
...
function resolveBundledPluginsDir(env = process.env) {
  ...
  if (override) {
    const resolvedOverride = (0, _utilsDvkbxKCZ.p)(override, env);
  ...
  try {
    const argvRoot = (0, _openclawRootBAiQfngU.n)({ argv1: process.argv[1] });
    ...
    })) ? null : argvRoot, (0, _openclawRootBAiQfngU.n)({ moduleUrl: "file:///home/rs/openclaw/dist/bundled-dir-Dn1Nq3AQ.js" })].filter((entry, index, all) => Boolean(entry) && all.indexOf(entry) === index);
  ...
  try {
    let cursor = _nodePath.default.dirname((0, _nodeUrl.fileURLToPath)("file:///home/rs/openclaw/dist/bundled-dir-Dn1Nq3AQ.js"));
    for (let i = 0; i < 6; i += 1) {
