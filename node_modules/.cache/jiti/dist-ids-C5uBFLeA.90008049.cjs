...
function listPackageRoots() {
  return [(0, _openclawRootBAiQfngU.n)({ cwd: process.cwd() }), (0, _openclawRootBAiQfngU.n)({ moduleUrl: "file:///home/rs/openclaw/dist/ids-C5uBFLeA.js" })].filter((entry, index, all) => Boolean(entry) && all.indexOf(entry) === index);
}
function listBundledExtensionPackageJsonPaths(env = process.env) {
  const extensionsRoot = (0, _bundledDirDygrJuRr.t)(env);
