"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = buildPluginConfigSchema;exports.r = emptyPluginConfigSchema;exports.t = buildJsonPluginConfigSchema;var _schemaValidatorCwMY3Tzl = require("./schema-validator-CwMY3Tzl.js");
...
function safeParseJsonSchema(schema, cacheKey, value) {
  const result = (0, _schemaValidatorCwMY3Tzl.t)({
    schema,
    cacheKey,
    value,
    applyDefaults: true
