...
var _mimeCDoSsIec = require("./mime-CDoSsIec.js");
var _toolImagesBbbvhMCD = require("./tool-images-BbbvhMCD.js");
...
async function imageResult(params) {
  ...
  return await (0, _toolImagesBbbvhMCD.r)({
    content,
    details: {
      path: params.path,
      ...params.details,
...
async function imageResultFromFile(params) {
  ...
  const mimeType = (await (0, _mimeCDoSsIec.n)({ buffer: buf.slice(0, 256) })) ?? "image/png";
