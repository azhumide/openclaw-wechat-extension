"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = getBundledChannelSetupSecrets;exports.c = listBundledChannelLegacyStateMigrationDetectors;exports.d = listBundledChannelSetupPlugins;exports.f = setBundledChannelRuntime;exports.g = resolveBundledChannelRootScope;exports.h = normalizeChannelMeta;exports.i = getBundledChannelSetupPlugin;exports.l = listBundledChannelPluginIds;exports.m = resolveExistingPluginModulePath;exports.n = getBundledChannelPlugin;exports.o = hasBundledChannelPackageSetupFeature;exports.p = loadChannelPluginModule;exports.r = getBundledChannelSecrets;exports.s = listBundledChannelLegacySessionSurfaces;exports.t = getBundledChannelAccountInspector;exports.u = listBundledChannelPlugins;var _errorsCS5wW5eD = require("./errors-CS5wW5eD.js");
...
var _subsystemBmJ5rL4Q = require("./subsystem-bmJ5rL4Q.js");
var _boundaryFileReadBSd9MXPy = require("./boundary-file-read-BSd9MXPy.js");
var _bundledPluginMetadataDetUlFWi = require("./bundled-plugin-metadata-DetUlFWi.js");
var _jitiLoaderCacheBat69wam = require("./jiti-loader-cache-Bat69wam.js");
var _bundledRuntimeRootBcqX7qkK = require("./bundled-runtime-root-BcqX7qkK.js");
var _moduleExportDDzOnsga = require("./module-export-DDzOnsga.js");
var _nativeModuleRequireBNeBBOkS = require("./native-module-require-BNeBBOkS.js");
var _nodeUrl = require("node:url");
var _nodeFs = _interopRequireDefault(require("node:fs"));
var _nodePath = _interopRequireDefault(require("node:path"));function _interopRequireDefault(e) {return e && e.__esModule ? e : { default: e };}
//#region src/channels/plugins/bundled-root.ts
const OPENCLAW_PACKAGE_ROOT = (0, _openclawRootGhlHRwjz.n)({
  argv1: process.argv[1],
  cwd: process.cwd(),
  moduleUrl: "file:///home/rs/openclaw/dist/bundled-BYR-fSTH.js".startsWith("file:") ? "file:///home/rs/openclaw/dist/bundled-BYR-fSTH.js" : void 0
}) ?? ("file:///home/rs/openclaw/dist/bundled-BYR-fSTH.js".startsWith("file:") ? _nodePath.default.resolve((0, _nodeUrl.fileURLToPath)(new URL("../../..", "file:///home/rs/openclaw/dist/bundled-BYR-fSTH.js"))) : process.cwd());
...
function resolveBundledChannelRootScope(env = process.env) {
  const bundledPluginsDir = (0, _bundledDirU738ay4K.t)(env);
...
function listBundledChannelPluginMetadata(params) {
  return (0, _bundledPluginMetadataDetUlFWi.n)(params);
}
function resolveBundledChannelGeneratedPath(rootDir, entry, pluginDirName, scanDir) {
  return (0, _bundledPluginMetadataDetUlFWi.r)(rootDir, entry, pluginDirName, scanDir);
}
//#endregion
...
function normalizeChannelMeta(params) {
  ...
  const label = (0, _stringCoerceCjxCKZ6B.c)(next?.label) ?? (0, _stringCoerceCjxCKZ6B.c)(existing?.label) ?? (0, _stringCoerceCjxCKZ6B.c)(next?.selectionLabel) ?? (0, _stringCoerceCjxCKZ6B.c)(existing?.selectionLabel) ?? params.id;
  const selectionLabel = (0, _stringCoerceCjxCKZ6B.c)(next?.selectionLabel) ?? (0, _stringCoerceCjxCKZ6B.c)(existing?.selectionLabel) ?? label;
  const docsPath = (0, _stringCoerceCjxCKZ6B.c)(next?.docsPath) ?? (0, _stringCoerceCjxCKZ6B.c)(existing?.docsPath) ?? `/channels/${params.id}`;
  const blurb = (0, _stringCoerceCjxCKZ6B.c)(next?.blurb) ?? (0, _stringCoerceCjxCKZ6B.c)(existing?.blurb) ?? "";
  return {
...
function createModuleLoader() {
  ...
  return (modulePath) => {
    return (0, _jitiLoaderCacheBat69wam.t)({
      cache: jitiLoaders,
      modulePath,
      importerUrl: "file:///home/rs/openclaw/dist/bundled-BYR-fSTH.js",
      argvEntry: process.argv[1],
      preferBuiltDist: true,
      jitiFilename: "file:///home/rs/openclaw/dist/bundled-BYR-fSTH.js"
    });
  };
}
...
function loadChannelPluginModule(params) {
  ...
  if (params.shouldTryNativeRequire?.(safePath)) {
    const nativeModule = (0, _nativeModuleRequireBNeBBOkS.n)(safePath, { allowWindows: true });
...
const log = (0, _subsystemBmJ5rL4Q.t)("channels");
function resolveChannelPluginModuleEntry(moduleExport) {
  const resolved = (0, _moduleExportDDzOnsga.t)(moduleExport);
...
function loadGeneratedBundledChannelModule(params) {
  ...
  if (params.installRuntimeDeps !== false && (0, _bundledRuntimeRootBcqX7qkK.t)(boundaryRoot)) {
    const prepared = (0, _bundledRuntimeRootBcqX7qkK.n)({
  ...
  return loadChannelPluginModule({
    ...
    shouldTryNativeRequire: (safePath) => safePath.includes(`${_nodePath.default.sep}dist${_nodePath.default.sep}`) && (0, _nativeModuleRequireBNeBBOkS.t)(safePath)
  });
}
function loadGeneratedBundledChannelEntry(params) {
  try {
    ...
    const detail = (0, _errorsCS5wW5eD.i)(error);
