...
var _jitiLoaderCacheDLO0UJX_ = require("./jiti-loader-cache-DLO0UJX_.js");
var _bundledRuntimeRootDEMD7O_ = require("./bundled-runtime-root-DEMD7-O_.js");
var _moduleExportF8zoIwaD = require("./module-export-f8zoIwaD.js");
var _nodeUrl = require("node:url");
var _nodeFs = _interopRequireDefault(require("node:fs"));
var _nodePath = _interopRequireDefault(require("node:path"));function _interopRequireDefault(e) {return e && e.__esModule ? e : { default: e };}
//#region src/channels/plugins/bundled-root.ts
const OPENCLAW_PACKAGE_ROOT = (0, _openclawRootBAiQfngU.n)({
  argv1: process.argv[1],
  cwd: process.cwd(),
  moduleUrl: "file:///home/rs/openclaw/dist/bundled-CAfVQCWF.js".startsWith("file:") ? "file:///home/rs/openclaw/dist/bundled-CAfVQCWF.js" : void 0
}) ?? ("file:///home/rs/openclaw/dist/bundled-CAfVQCWF.js".startsWith("file:") ? _nodePath.default.resolve((0, _nodeUrl.fileURLToPath)(new URL("../../..", "file:///home/rs/openclaw/dist/bundled-CAfVQCWF.js"))) : process.cwd());
...
function resolveBundledChannelRootScope(env = process.env) {
  const bundledPluginsDir = (0, _bundledDirDygrJuRr.t)(env);
...
function listBundledChannelPluginMetadata(params) {
  return (0, _bundledPluginMetadataDs2SxpYG.n)(params);
}
function resolveBundledChannelGeneratedPath(rootDir, entry, pluginDirName, scanDir) {
  return (0, _bundledPluginMetadataDs2SxpYG.r)(rootDir, entry, pluginDirName, scanDir);
}
//#endregion
...
function createModuleLoader() {
  ...
  return (modulePath) => {
    return (0, _jitiLoaderCacheDLO0UJX_.t)({
      cache: jitiLoaders,
      modulePath,
      importerUrl: "file:///home/rs/openclaw/dist/bundled-CAfVQCWF.js",
      argvEntry: process.argv[1],
      preferBuiltDist: true,
      jitiFilename: "file:///home/rs/openclaw/dist/bundled-CAfVQCWF.js"
    });
  };
}
...
function loadChannelPluginModule(params) {
  ...
  if (params.shouldTryNativeRequire?.(safePath)) {
    const nativeModule = (0, _jitiLoaderCacheDLO0UJX_.r)(safePath, { allowWindows: true });
...
const log = (0, _subsystemRHhUC6qs.t)("channels");
function resolveChannelPluginModuleEntry(moduleExport) {
  const resolved = (0, _moduleExportF8zoIwaD.t)(moduleExport);
...
function loadGeneratedBundledChannelModule(params) {
  ...
  if (params.installRuntimeDeps !== false && (0, _bundledRuntimeRootDEMD7O_.t)(boundaryRoot)) {
    const prepared = (0, _bundledRuntimeRootDEMD7O_.n)({
  ...
  return loadChannelPluginModule({
    ...
    shouldTryNativeRequire: (safePath) => safePath.includes(`${_nodePath.default.sep}dist${_nodePath.default.sep}`) && (0, _jitiLoaderCacheDLO0UJX_.n)(safePath)
  });
}
function loadGeneratedBundledChannelEntry(params) {
  try {
    ...
    const detail = (0, _errorsCDFVCV9D.i)(error);
