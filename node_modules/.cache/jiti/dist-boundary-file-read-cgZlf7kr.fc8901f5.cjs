"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.i = openBoundaryFileSync;exports.n = matchBoundaryFileOpenFailure;exports.r = openBoundaryFile;exports.t = canUseBoundaryFileOpen;var _boundaryPathBUtehO_x = require("./boundary-path-BUtehO_x.js");
...
function openBoundaryFileSync(params) {
  ...
  const resolved = resolveBoundaryFilePathGeneric({
    ...
    resolve: (absolutePath) => (0, _boundaryPathBUtehO_x.r)({
      absolutePath,
...
async function openBoundaryFile(params) {
  ...
  const maybeResolved = resolveBoundaryFilePathGeneric({
    absolutePath: params.absolutePath,
    resolve: (absolutePath) => (0, _boundaryPathBUtehO_x.n)({
      absolutePath,
      rootPath: params.rootPath,
      rootCanonicalPath: params.rootRealPath,
      boundaryLabel: params.boundaryLabel,
