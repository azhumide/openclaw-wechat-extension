...
function resolveConfiguredBindingWorkspaceCwd(params) {
  if ((0, _stringCoerceBje8XVt.c)((0, _agentScopeYDjJfO9L._)(params.cfg, params.agentId)?.workspace)) return (0, _agentScopeYDjJfO9L.b)(params.cfg, params.agentId);
  if (params.agentId === (0, _agentScopeYDjJfO9L.x)(params.cfg)) {
    if ((0, _stringCoerceBje8XVt.c)(params.cfg.agents?.defaults?.workspace)) return (0, _agentScopeYDjJfO9L.b)(params.cfg, params.agentId);
  }
}
...
function resolveLoadedChannelPlugin(channel) {
  ...
  return (0, _registryCepMPIe.t)(normalized);
}
...
function compileConfiguredBindingRule(params) {
  const agentId = (0, _resolveRouteKEdonC_.r)(params.cfg, params.binding.agentId ?? "main");
