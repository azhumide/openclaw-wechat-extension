...
const fileTypeModuleLoader = (0, _lazyPromiseBWWZqHu.t)(() => Promise.resolve().then(() => jitiImport("file-type").then((m) => _interopRequireWildcard(m))));
