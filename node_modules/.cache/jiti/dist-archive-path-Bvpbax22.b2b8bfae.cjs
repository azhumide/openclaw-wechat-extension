"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = isWithinDir;exports.i = validateArchiveEntryPath;exports.n = resolveArchiveOutputPath;exports.r = stripArchivePath;exports.t = isWindowsDrivePath;var _boundaryPathBphsbLa = require("./boundary-path-BphsbLa5.js");
...
function isWithinDir(rootDir, targetPath) {
  return (0, _boundaryPathBphsbLa.s)(rootDir, targetPath);
}
//#endregion
