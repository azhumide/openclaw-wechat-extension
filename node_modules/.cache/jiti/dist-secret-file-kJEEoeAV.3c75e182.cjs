"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = readSecretFileSync;exports.i = loadSecretFileSync;exports.n = void 0;exports.o = tryReadSecretFileSync;exports.r = void 0;exports.s = writePrivateSecretFileAtomic;exports.t = void 0;var _utilsCCskKJVV = require("./utils-CCskKJVV.js");
...
function loadSecretFileSync(filePath, label, options = {}) {
  const resolvedPath = (0, _utilsCCskKJVV.p)(filePath.trim());
...
async function ensurePrivateDirectory(rootDir, targetDir) {
  ...
  for (const segment of _nodePath.default.relative(resolvedRoot, resolvedTarget).split(_nodePath.default.sep).filter(Boolean)) {
    ...
    try {
      ...
      await _promises.default.mkdir(current, { mode: 448 });
    }
...
async function writePrivateSecretFileAtomic(params) {
  ...
  try {
    const handle = await _promises.default.open(tempPath, "wx", 384);
    createdTemp = true;
    try {
