"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.i = resolveImageSanitizationLimits;exports.n = sanitizeImageBlocks;exports.r = sanitizeToolResultImages;exports.t = sanitizeContentBlocksImages;var _subsystemBIXRI3F = require("./subsystem-BI-xRI3F.js");
var _base64BFSEyv5d = require("./base64-BFSEyv5d.js");
var _imageOpsCRYTAqY = require("./image-ops-CR-YTAqY.js");
...
const log = (0, _subsystemBIXRI3F.t)("agents/tool-images");
...
async function resizeImageBase64IfNeeded(params) {
  ...
  const meta = await (0, _imageOpsCRYTAqY.a)(buf);
  ...
  const sideGrid = (0, _imageOpsCRYTAqY.r)(params.maxDimensionPx, sideStart);
  let smallest = null;
  for (const side of sideGrid) for (const quality of _imageOpsCRYTAqY.t) {
    const out = await (0, _imageOpsCRYTAqY.l)({
      buffer: buf,
      maxSide: side,
      quality,
