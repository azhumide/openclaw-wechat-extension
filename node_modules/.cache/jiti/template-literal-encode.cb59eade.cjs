...
var _enumToUnion = require("../enum/enum-to-union.mjs");
...
function EncodeEnum(types, right, pattern) {
  const variants = (0, _enumToUnion.EnumValuesToVariants)(types);
...
function EncodeType(type, right, pattern) {
  ...
  (0, _templateLiteral.IsTemplateLiteral)(type) ? EncodeTemplateLiteral(type.pattern, right, pattern) :
  (0, _templateLiteral.IsTemplateLiteralDeferred)(type) ? EncodeTemplateLiteralDeferred(type.parameters[0], right, pattern) :
