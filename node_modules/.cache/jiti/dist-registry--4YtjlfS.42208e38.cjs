...
var _runtimeChannelState1atD35c = require("./runtime-channel-state-1atD35c-.js");
var _channelMetaDps2gvUU = require("./channel-meta-Dps2gvUU.js");
//#region src/channels/chat-meta-shared.ts
const CHAT_CHANNEL_ID_SET = new Set(_idsBNV8Hqfu.n);
function toChatChannelMeta(params) {
  ...
  return (0, _channelMetaDps2gvUU.t)({
    id: params.id,
...
function buildChatChannelMetaById() {
  ...
  for (const entry of (0, _idsBNV8Hqfu.i)()) {
...
function listChatChannels() {
  return _idsBNV8Hqfu.n.map((id) => CHAT_CHANNEL_META[id]);
}
...
function listRegisteredChannelPluginEntries() {
  const channelRegistry = (0, _runtimeChannelState1atD35c.t)();
