"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.i = stringEnum;exports.n = channelTargetsSchema;exports.r = optionalStringEnum;exports.t = channelTargetSchema;require("./channel-target-C4B1O2W0.js");
...
function channelTargetSchema(options) {
  return _typebox.Type.String({ description: options?.description ?? "Recipient/channel: E.164 for WhatsApp/Signal, Telegram chat id/@username, Discord/Slack/Mattermost <channelId|user:ID|channel:ID>, or iMessage handle/chat_id" });
}
