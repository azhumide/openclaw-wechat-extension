"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = resolveRedactOptions;exports.i = redactToolDetail;exports.n = redactSensitiveLines;exports.r = redactSensitiveText;exports.t = getDefaultRedactPatterns;var _configRegexDGU0okmz = require("./config-regex-DGU0okmz.js");
var _nodeRequireDvwmVoHm = require("./node-require-DvwmVoHm.js");
...
const requireConfig = (0, _nodeRequireDvwmVoHm.t)("file:///home/rs/openclaw/dist/redact-DCQ2_xTT.js");
...
function parsePattern(raw) {
  ...
  if (match) {
    ...
    return (0, _configRegexDGU0okmz.t)(match[1], flags)?.regex ?? null;
  }
  return (0, _configRegexDGU0okmz.t)(raw, "gi")?.regex ?? null;
}
