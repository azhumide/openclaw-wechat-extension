...
function resolvePackageRuntimeExtensionEntries(params) {
  const runtimeExtensions = normalizePackageManifestStringList((0, _manifestGzgxnRAf.r)(params.manifest ?? void 0)?.runtimeExtensions);
...
function resolvePackageSetupSource(params) {
  const packageManifest = (0, _manifestGzgxnRAf.r)(params.manifest ?? void 0);
