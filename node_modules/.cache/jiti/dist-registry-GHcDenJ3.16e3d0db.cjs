...
var _idsC5uBFLeA = require("./ids-C5uBFLeA.js");
var _runtimeChannelStateL9dosyQh = require("./runtime-channel-state-l9dosyQh.js");
var _channelMetaDZ7d0AiI = require("./channel-meta-DZ7d0AiI.js");
//#region src/channels/chat-meta-shared.ts
const CHAT_CHANNEL_ID_SET = new Set(_idsC5uBFLeA.n);
function toChatChannelMeta(params) {
  ...
  return (0, _channelMetaDZ7d0AiI.t)({
    id: params.id,
...
function buildChatChannelMetaById() {
  ...
  for (const entry of (0, _idsC5uBFLeA.i)()) {
...
function listChatChannels() {
  return _idsC5uBFLeA.n.map((id) => CHAT_CHANNEL_META[id]);
}
...
function listRegisteredChannelPluginEntries() {
  const channelRegistry = (0, _runtimeChannelStateL9dosyQh.t)();
