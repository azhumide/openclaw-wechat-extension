...
function getLoadedChannelSetupPromotionSurface(channelKey) {
  return asPromotionSurface((0, _registryLmPqGvar.n)(channelKey)?.setup);
}
function getBundledChannelSetupPromotionSurface(channelKey) {
  if (!(0, _bundledBTWQlO.o)(channelKey, "configPromotion")) return null;
  return asPromotionSurface((0, _bundledBTWQlO.n)(channelKey)?.setup);
}
