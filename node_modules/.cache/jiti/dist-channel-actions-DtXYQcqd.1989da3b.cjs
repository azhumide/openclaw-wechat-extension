"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = listTokenSourcedAccounts;exports.i = createUnionActionGate;exports.n = createMessageToolCardSchema;exports.r = resolveReactionMessageId;exports.t = createMessageToolButtonsSchema;var _commonC4RGIxnG = require("./common-C4RGIxnG.js");
require("./sandbox-paths-BdrQ0pdY.js");
var _typeboxCjvQ7Ch = require("./typebox-CjvQ7Ch7.js");
...
function resolveReactionMessageId(params) {
  return (0, _commonC4RGIxnG.h)(params.args, "messageId") ?? params.toolContext?.currentMessageId;
}
//#endregion
...
function createMessageToolButtonsSchema() {
  return _typebox.Type.Optional(_typebox.Type.Array(_typebox.Type.Array(_typebox.Type.Object({
    ...
    style: _typebox.Type.Optional((0, _typeboxCjvQ7Ch.i)([
    "danger",
    "success",
    "primary"]
    ))
