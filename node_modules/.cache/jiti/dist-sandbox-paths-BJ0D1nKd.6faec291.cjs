"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = resolveSandboxPath;exports.i = resolveSandboxInputPath;exports.n = assertSandboxPath;exports.o = resolveSandboxedMediaSource;exports.r = resolveAllowedManagedMediaPath;exports.t = assertMediaNotDataUrl;var _utilsBMRcljdi = require("./utils-BMRcljdi.js");
var _tmpOpenclawDirCoGSA7K = require("./tmp-openclaw-dir-CoGSA-7K.js");
var _boundaryPathC2iMx2xR = require("./boundary-path-C2iMx2xR.js");
var _pathAliasGuardsBtxSmI = require("./path-alias-guards-BtxSmI00.js");
var _archivePathDGEP4p7t = require("./archive-path-DGEP4p7t.js");
var _localFileAccessNoH3bPVX = require("./local-file-access-NoH3bPVX.js");
var _mediaSourceUrlCMoQZh0z = require("./media-source-url-CMoQZh0z.js");
...
function hostPathLooksAbsolute(expanded) {
  return _nodePath.default.isAbsolute(expanded) || (0, _archivePathDGEP4p7t.t)(expanded);
}
function resolveToCwd(filePath, cwd) {
  const expanded = expandPath(filePath);
  if ((0, _archivePathDGEP4p7t.t)(expanded)) return _nodePath.default.win32.normalize(expanded);
...
function resolveSandboxPath(params) {
  ...
  if (relative.startsWith("..") || _nodePath.default.isAbsolute(relative) || (0, _archivePathDGEP4p7t.t)(relative)) throw new Error(`Path escapes sandbox root (${shortPath(rootResolved)}): ${params.filePath}`);
  return {
    resolved,
    relative
  };
...
async function assertSandboxPath(params) {
  ...
  await (0, _pathAliasGuardsBtxSmI.n)({
...
function isManagedMediaPathUnderRoot(candidate) {
  ...
  const mediaRoot = _nodePath.default.join((0, _utilsBMRcljdi.f)(), "media");
...
async function resolveAllowedManagedMediaPath(candidate) {
  ...
  await assertNoManagedMediaAliasEscape({
    filePath: resolved,
    managedMediaRoot: _nodePath.default.resolve((0, _utilsBMRcljdi.f)(), "media")
  });
  return resolved;
}
async function resolveSandboxedMediaSource(params) {
  ...
  if (!raw) return raw;
  if ((0, _mediaSourceUrlCMoQZh0z.t)(raw)) return raw;
  let candidate = raw;
  if (/^file:\/\//i.test(candidate)) {
    ...
    try {
      candidate = (0, _localFileAccessNoH3bPVX.a)(candidate);
    } catch (err) {
  ...
  (0, _localFileAccessNoH3bPVX.t)(candidate, "Sandbox media path");
...
function mapContainerWorkspaceFileUrl(params) {
  ...
  if ((0, _localFileAccessNoH3bPVX.r)(parsed.pathname)) return;
...
async function resolveAllowedTmpMediaPath(params) {
  ...
  const openClawTmpDir = _nodePath.default.resolve((0, _tmpOpenclawDirCoGSA7K.n)());
  if (!(0, _boundaryPathC2iMx2xR.s)(openClawTmpDir, resolved)) return;
