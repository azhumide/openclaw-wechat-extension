...
var _openclawExecEnvDOC4eAq = require("./openclaw-exec-env-DOC4eAq6.js");
var _globalsCX0Bl8ZU = require("./globals-CX0Bl8ZU.js");
var _windowsCommandDKwG4uVK = require("./windows-command-DKwG4uVK.js");
...
function resolveCommand(command) {
  return (0, _windowsCommandDKwG4uVK.t)({
    command,
    cmdCommands: [
    "corepack",
    "pnpm",
...
async function runExec(command, args, opts = 1e4) {
  ...
  try {
    ...
    const windowsEncoding = (0, _windowsCommandDKwG4uVK.o)();
    const decodedStdout = (0, _windowsCommandDKwG4uVK.a)({
      buffer: stdout,
      windowsEncoding
    });
    const decodedStderr = (0, _windowsCommandDKwG4uVK.a)({
      buffer: stderr,
      windowsEncoding
    });
    if ((0, _globalsCX0Bl8ZU.a)()) {
      if (decodedStdout.trim()) (0, _loggerD0xgIYk.t)(decodedStdout.trim());
      if (decodedStderr.trim()) (0, _loggerD0xgIYk.n)(decodedStderr.trim());
    }
    return {
    ...
    if (err && typeof err === "object") {
      ...
      if (Buffer.isBuffer(errorWithOutput.stdout)) errorWithOutput.stdout = (0, _windowsCommandDKwG4uVK.a)({
        buffer: errorWithOutput.stdout,
        windowsEncoding
      });
      if (Buffer.isBuffer(errorWithOutput.stderr)) errorWithOutput.stderr = (0, _windowsCommandDKwG4uVK.a)({
        buffer: errorWithOutput.stderr,
        windowsEncoding
      });
    }
    if ((0, _globalsCX0Bl8ZU.a)()) (0, _loggerD0xgIYk.n)((0, _globalsCX0Bl8ZU.t)(`Command failed: ${command} ${args.join(" ")}`));
    throw err;
  }
}
...
function resolveCommandEnv(params) {
  ...
  return (0, _openclawExecEnvDOC4eAq.n)(resolvedEnv);
}
async function runCommandWithTimeout(argv, optionsOrTimeout) {
  ...
  const stdio = (0, _windowsCommandDKwG4uVK.n)({
    hasInput,
    preferInherit: true
  });
  ...
  return await new Promise((resolve, reject) => {
    ...
    const resolveFromClose = (code, signal) => {
      ...
      resolve({
        ...
        stdout: (0, _windowsCommandDKwG4uVK.a)({
          buffer: Buffer.concat(stdoutChunks),
          windowsEncoding
        }),
        stderr: (0, _windowsCommandDKwG4uVK.a)({
