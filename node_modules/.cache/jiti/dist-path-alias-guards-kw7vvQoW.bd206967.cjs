"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = assertNoPathAliasEscape;exports.t = void 0;var _boundaryPathBphsbLa = require("./boundary-path-BphsbLa5.js");
...
async function assertNoHardlinkedFinalPath(params) {
  ...
  try {
    ...
    if ((0, _boundaryPathBphsbLa.o)(err)) return;
    throw err;
  }
...
const PATH_ALIAS_POLICIES = exports.t = _boundaryPathBphsbLa.t;
async function assertNoPathAliasEscape(params) {
  const resolved = await (0, _boundaryPathBphsbLa.n)({
