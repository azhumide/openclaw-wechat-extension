"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.i = resolveImageSanitizationLimits;exports.n = sanitizeImageBlocks;exports.r = sanitizeToolResultImages;exports.t = sanitizeContentBlocksImages;var _subsystemBhqMcUP = require("./subsystem-Bhq-McUP.js");
var _base64BLFHFQO = require("./base64-BLFHF-qO.js");
var _imageOpsBG4oRyrk = require("./image-ops-BG4oRyrk.js");
...
const log = (0, _subsystemBhqMcUP.t)("agents/tool-images");
...
async function resizeImageBase64IfNeeded(params) {
  ...
  const meta = await (0, _imageOpsBG4oRyrk.a)(buf);
  ...
  const sideGrid = (0, _imageOpsBG4oRyrk.r)(params.maxDimensionPx, sideStart);
  let smallest = null;
  for (const side of sideGrid) for (const quality of _imageOpsBG4oRyrk.t) {
    const out = await (0, _imageOpsBG4oRyrk.l)({
      buffer: buf,
      maxSide: side,
      quality,
...
async function sanitizeContentBlocksImages(blocks, label, opts = {}) {
  ...
  for (const block of blocks) {
    ...
    const canonicalData = (0, _base64BLFHFQO.t)(data);
    if (!canonicalData) {
      out.push({
        type: "text",
