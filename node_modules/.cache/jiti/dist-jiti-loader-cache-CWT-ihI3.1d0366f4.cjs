"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.i = toSafeImportPath;exports.n = isJavaScriptModulePath;exports.r = tryNativeRequireJavaScriptModule;exports.t = getCachedPluginJitiLoader;var _sdkAliasZeYYdq5k = require("./sdk-alias-zeYYdq5k.js");
var _nodeModule = require("node:module");
var _nodeUrl = require("node:url");
var _nodePath = _interopRequireDefault(require("node:path"));
var _jiti = require("jiti");function _interopRequireDefault(e) {return e && e.__esModule ? e : { default: e };}
...
const nodeRequire = (0, _nodeModule.createRequire)("file:///home/rs/openclaw/dist/jiti-loader-cache-CWT-ihI3.js");
...
function getCachedPluginJitiLoader(params) {
  ...
  const defaultConfig = hasAliasOverride || hasTryNativeOverride ? (0, _sdkAliasZeYYdq5k.u)({
  ...
  const cacheKey = resolved.cacheKey ?? (0, _sdkAliasZeYYdq5k.r)({
    tryNative,
    aliasMap
  });
  ...
  const cached = params.cache.get(scopedCacheKey);
  if (cached) return cached;
  const jitiLoader = (params.createLoader ?? _jiti.createJiti)(jitiFilename, {
    ...(0, _sdkAliasZeYYdq5k.n)(aliasMap),
    tryNative
  });
